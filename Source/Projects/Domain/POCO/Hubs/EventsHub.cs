...
namespace DSS5_SupplyChainFinancialsOptimisation.Hubs
{
    public class EventsHub : Hub, IApplicationHub
    {
        ...
        {
            var hub = GlobalHost.ConnectionManager.GetHubContext<DSS5_SupplyChainFinancialsOptimisation.Hubs.EventsHub>();
        ...
        public static void RaiseDebugMessage(string type, string data)
        {
            ...
            (_k, _v, _r) => { });
            Microsoft.AspNet.SignalR.IHubContext hub = Microsoft.AspNet.SignalR.GlobalHost.ConnectionManager.GetHubContext<DSS5_SupplyChainFinancialsOptimisation.Hubs.EventsHub>();
