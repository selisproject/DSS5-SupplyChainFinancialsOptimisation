...
{
    /// <summary>
    /// The MeanOfTransport class
    ///
    /// </summary>
    [Serializable]
    [DataContract]
    public class MeanOfTransport : IDomainModelClass
    {
        #region MeanOfTransport's Fields
        ...
        #endregion
        #region MeanOfTransport's Properties
/// <summary>
/// The Id property
///
/// </summary>
...
/// <summary>
/// The TrainId property
///
/// </summary>
///
        public virtual string TrainId
        {
            get
            {
                return trainId;
...
///
        ...
        #region Constructors
/// <summary>
/// Public constructors of the MeanOfTransport class
/// </summary>
/// <returns>New MeanOfTransport object</returns>
/// <remarks></remarks>
        ...
        public virtual List<string> _Validate(bool throwException = true)
        {
            ...
            if (LicensePlate != null && LicensePlate.Length > 100)
            {
                __errors.Add("Length of property 'LicensePlate' cannot be greater than 100.");
            }
            if (ContainerId != null && ContainerId.Length > 100)
            {
                __errors.Add("Length of property 'ContainerId' cannot be greater than 100.");
            }
            if (ShipId != null && ShipId.Length > 100)
            {
                __errors.Add("Length of property 'ShipId' cannot be greater than 100.");
            }
            if (TrainId != null && TrainId.Length > 100)
            {
                __errors.Add("Length of property 'TrainId' cannot be greater than 100.");
            }
            if (throwException && __errors.Any())
            {
                throw new zAppDev.DotNet.Framework.Exceptions.BusinessException("An instance of TypeClass 'MeanOfTransport' has validation errors:\r\n\r\n" + string.Join("\r\n", __errors));
            }
            return __errors;
        }
...
/// <returns>A copy of the object</returns>
        ...
        {
            var compareTo = obj as MeanOfTransport;
...
// Maintain equality operator semantics for entities.
        public static bool operator ==(MeanOfTransport x, MeanOfTransport y)
        {
