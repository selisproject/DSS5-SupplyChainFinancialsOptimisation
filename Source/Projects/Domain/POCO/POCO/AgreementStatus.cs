...
namespace DSS5_SupplyChainFinancialsOptimisation.BO
{
    ...
    public class AgreementStatus : IDomainModelClass
    {
        ...
        [DataMember(Name="DateOccured")]
        protected DateTime? dateOccured;
...
/// <summary>
/// The DateOccured property
///
/// </summary>
///
        public virtual DateTime? DateOccured
        {
            get
            {
                return dateOccured;
...
/// <remarks></remarks>
        ...
        public virtual List<string> _Validate(bool throwException = true)
        {
            ...
            if (ProvidedBy != null && ProvidedBy.Length > 100)
            {
                __errors.Add("Length of property 'ProvidedBy' cannot be greater than 100.");
            }
...
/// <returns>A copy of the object</returns>
        public virtual AgreementStatus Copy(bool deep=false, Hashtable copiedObjects=null, bool asNew=false, bool reuseNestedObjects = false, AgreementStatus copy = null)
        {
            ...
            copy.DateOccured = this.DateOccured;
            copy.ProvidedBy = this.ProvidedBy;
