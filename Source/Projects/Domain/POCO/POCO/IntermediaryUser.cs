...
namespace DSS5_SupplyChainFinancialsOptimisation.BO
{
    ...
    public class IntermediaryUser : ApplicationUser, IDomainModelClass
    {
        #region IntermediaryUser's Fields
        #endregion
        #region IntermediaryUser's Participant Properties
        [DataMember(Name="Intermediary")]
        protected Intermediary intermediary;
        public virtual Intermediary Intermediary
        {
            get
            {
                return intermediary;
            ...
            set
            {
                if(Equals(intermediary, value)) return;
                var __oldValue = intermediary;
                if (value != null)
                {
                    intermediary = value;
                }
        ...
        #region Constructors
/// <summary>
/// Public constructors of the IntermediaryUser class
/// </summary>
/// <returns>New IntermediaryUser object</returns>
/// <remarks></remarks>
        public IntermediaryUser(): base() {}
        #endregion
        #region Methods
        ...
        public override List<string> _Validate(bool throwException = true)
        {
            ...
            {
                throw new zAppDev.DotNet.Framework.Exceptions.BusinessException("An instance of TypeClass 'IntermediaryUser' has validation errors:\r\n\r\n" + string.Join("\r\n", __errors));
            }
            return __errors;
        }
...
/// <returns>A copy of the object</returns>
        ...
        {
            var compareTo = obj as IntermediaryUser;
...
// Maintain equality operator semantics for entities.
        public static bool operator ==(IntermediaryUser x, IntermediaryUser y)
        {
