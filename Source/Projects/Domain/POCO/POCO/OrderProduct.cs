...
namespace DSS5_SupplyChainFinancialsOptimisation.BO
{
    ...
    [Serializable]
    [DataContract]
    public class OrderProduct : IDomainModelClass
    {
        #region OrderProduct's Fields
        ...
        #endregion
        #region OrderProduct's Properties
/// <summary>
/// The Id property
///
/// </summary>
...
///
        ...
        #endregion
        #region OrderProduct's Participant Properties
        ...
        public virtual Order Order
        {
            ...
            set
            {
                ...
                order?.InternalRemoveOrderProducts(this);
                order = value;
                if (value != null)
                {
                    order.InternalAddOrderProducts(this);
                }
            }
        }
        ...
        #region Constructors
/// <summary>
/// Public constructors of the OrderProduct class
/// </summary>
/// <returns>New OrderProduct object</returns>
/// <remarks></remarks>
        public OrderProduct() {}
        #endregion
        #region Methods
        ...
        public virtual List<string> _Validate(bool throwException = true)
        {
            ...
            {
                throw new zAppDev.DotNet.Framework.Exceptions.BusinessException("An instance of TypeClass 'OrderProduct' has validation errors:\r\n\r\n" + string.Join("\r\n", __errors));
            }
            return __errors;
        }
...
/// <returns>A copy of the object</returns>
        ...
        {
            var compareTo = obj as OrderProduct;
...
// Maintain equality operator semantics for entities.
        public static bool operator ==(OrderProduct x, OrderProduct y)
        {
