...
///
        ...
        public virtual void AddOrders(Order __item)
        {
            ...
            if (!__item.ProofOfDeliveries.Contains(this))
                __item.AddProofOfDeliveries(this);
        }
        ...
        public virtual void RemoveOrders(Order __item)
        {
            if (__item != null)
            {
                ...
                if(__item.ProofOfDeliveries.Contains(this))
                    __item.RemoveProofOfDeliveries(this);
            }
        }
        public virtual void SetOrdersAt(Order __item, int __index)
        {
            if (__item == null)
            {
                orders[__index].RemoveProofOfDeliveries(this);
            }
            else
            {
        ...
        public virtual Transaction Transaction
        {
            ...
            set
            {
                ...
                transaction?.InternalRemoveProofOfDeliveries(this);
                transaction = value;
                if (value != null)
                {
                    transaction.InternalAddProofOfDeliveries(this);
                }
            }
        }
        #endregion
