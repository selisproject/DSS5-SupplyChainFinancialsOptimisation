...
namespace DSS5_SupplyChainFinancialsOptimisation.BO
{
	...
	{
        public static System.Collections.Generic.List<string> GetDomainFocusOptions(DSS5_SupplyChainFinancialsOptimisation.BO.Investor inv){using (new zAppDev.DotNet.Framework.Profiling.Profiler("Investor", zAppDev.DotNet.Framework.Profiling.AppDevSymbolType.ClassOperation, "GetDomainFocusOptions")) {
