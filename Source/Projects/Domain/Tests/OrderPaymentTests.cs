...
namespace DSS5_SupplyChainFinancialsOptimisation.BoTesting.Tests
{
    ...
    internal class OrderPaymentTests : NHibernateFixture
    {
        ...
        public void OrderPayment_filtering_test()
        {
            ...
            List<DSS5_SupplyChainFinancialsOptimisation.BO.OrderPayment> results = null;
            Assert.DoesNotThrow(() =>
            {
                results = repo.GetAsQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.OrderPayment>(
                              a => true
