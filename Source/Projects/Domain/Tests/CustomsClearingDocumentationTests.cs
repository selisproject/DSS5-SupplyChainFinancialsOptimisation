...
namespace DSS5_SupplyChainFinancialsOptimisation.BoTesting.Tests
{
    ...
    internal class CustomsClearingDocumentationTests : NHibernateFixture
    {
        ...
        public void CustomsClearingDocumentation_filtering_test()
        {
            ...
            List<DSS5_SupplyChainFinancialsOptimisation.BO.CustomsClearingDocumentation> results = null;
            Assert.DoesNotThrow(() =>
            {
                results = repo.GetAsQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.CustomsClearingDocumentation>(
                              a => true
