    ...
    internal class TransactionTests : NHibernateFixture
    {
        ...
        public void Transaction_persistence_test()
        {
            ...
            var _transaction_supplier_transactions = new DSS5_SupplyChainFinancialsOptimisation.BO.Supplier
            {
                ...
                UserName = "a8f85caf-667d-4030-8871-6c5801f45a91Supplier_UserName",
        ...
        public void Transaction_filtering_test()
        {
            ...
            List<DSS5_SupplyChainFinancialsOptimisation.BO.Transaction> results = null;
            Assert.DoesNotThrow(() =>
            {
                results = repo.GetAsQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.Transaction>(
                              a => true
