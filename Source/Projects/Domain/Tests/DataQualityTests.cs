...
namespace DSS5_SupplyChainFinancialsOptimisation.BoTesting.Tests
{
    ...
    internal class DataQualityTests : NHibernateFixture
    {
        ...
        public void DataQuality_persistence_test()
        {
            ...
            new PersistenceSpecification<DSS5_SupplyChainFinancialsOptimisation.BO.DataQuality>(Session)
        ...
        public void DataQuality_filtering_test()
        {
            ...
            List<DSS5_SupplyChainFinancialsOptimisation.BO.DataQuality> results = null;
            Assert.DoesNotThrow(() =>
            {
                results = repo.GetAsQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.DataQuality>(
                              a => true
                              && !a.Orders
                              && !a.DeliveryNotes
                              && !a.CustomsDocuments
