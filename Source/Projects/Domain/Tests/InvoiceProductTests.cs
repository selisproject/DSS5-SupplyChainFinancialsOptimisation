...
namespace DSS5_SupplyChainFinancialsOptimisation.BoTesting.Tests
{
    ...
    internal class InvoiceProductTests : NHibernateFixture
    {
        ...
        public void InvoiceProduct_persistence_test()
        {
            ...
            var _invoice_invoice_invoiceproducts = new DSS5_SupplyChainFinancialsOptimisation.BO.Invoice
            {
            ...
            var _invoiceproduct_supplierproduct_invoiceproduct = new DSS5_SupplyChainFinancialsOptimisation.BO.SupplierProduct
            {
            ...
            new PersistenceSpecification<DSS5_SupplyChainFinancialsOptimisation.BO.InvoiceProduct>(Session)
        ...
        public void InvoiceProduct_filtering_test()
        {
            ...
            List<DSS5_SupplyChainFinancialsOptimisation.BO.InvoiceProduct> results = null;
            Assert.DoesNotThrow(() =>
            {
                results = repo.GetAsQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.InvoiceProduct>(
                              a => true
