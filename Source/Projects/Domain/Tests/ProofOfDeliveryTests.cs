...
namespace DSS5_SupplyChainFinancialsOptimisation.BoTesting.Tests
{
    ...
    internal class ProofOfDeliveryTests : NHibernateFixture
    {
        ...
        public void ProofOfDelivery_filtering_test()
        {
            ...
            List<DSS5_SupplyChainFinancialsOptimisation.BO.ProofOfDelivery> results = null;
            Assert.DoesNotThrow(() =>
            {
                results = repo.GetAsQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.ProofOfDelivery>(
                              a => true
