...
namespace DSS5_SupplyChainFinancialsOptimisation.BoTesting.Tests
{
    ...
    internal class DocumentAgreementTests : NHibernateFixture
    {
        ...
        public void DocumentAgreement_filtering_test()
        {
            ...
            List<DSS5_SupplyChainFinancialsOptimisation.BO.DocumentAgreement> results = null;
            Assert.DoesNotThrow(() =>
            {
                results = repo.GetAsQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.DocumentAgreement>(
                              a => true
