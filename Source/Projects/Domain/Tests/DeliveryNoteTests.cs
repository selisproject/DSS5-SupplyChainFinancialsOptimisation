...
namespace DSS5_SupplyChainFinancialsOptimisation.BoTesting.Tests
{
    ...
    internal class DeliveryNoteTests : NHibernateFixture
    {
        ...
        public void DeliveryNote_filtering_test()
        {
            ...
            List<DSS5_SupplyChainFinancialsOptimisation.BO.DeliveryNote> results = null;
            Assert.DoesNotThrow(() =>
            {
                results = repo.GetAsQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.DeliveryNote>(
                              a => true
