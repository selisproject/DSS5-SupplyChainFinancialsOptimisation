    ...
    internal class CommercialAgreementTests : NHibernateFixture
    {
        ...
        public void CommercialAgreement_persistence_test()
        {
            ...
            var _agreement_supplier_commercialagreements = new DSS5_SupplyChainFinancialsOptimisation.BO.Supplier
            {
                ...
                UserName = "ec7926dd-7b65-4307-b61c-61d563b9167aSupplier_UserName",
            ...
            var _agreement_buyer_commercialagreements = new DSS5_SupplyChainFinancialsOptimisation.BO.Buyer
            {
                ...
                Prefix = "Buyer_Prefix",
                Temp = "Buyer_Temp",
                UserName = "1c6311f8-ceea-4456-b815-947aec53436aBuyer_UserName",
        ...
        public void CommercialAgreement_filtering_test()
        {
            ...
            List<DSS5_SupplyChainFinancialsOptimisation.BO.CommercialAgreement> results = null;
            Assert.DoesNotThrow(() =>
            {
                results = repo.GetAsQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.CommercialAgreement>(
                              a => true
