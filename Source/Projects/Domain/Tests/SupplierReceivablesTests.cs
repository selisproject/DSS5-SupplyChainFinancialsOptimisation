...
namespace DSS5_SupplyChainFinancialsOptimisation.BoTesting.Tests
{
    ...
    internal class SupplierReceivablesTests : NHibernateFixture
    {
        ...
        public void SupplierReceivables_persistence_test()
        {
            ...
            new PersistenceSpecification<DSS5_SupplyChainFinancialsOptimisation.BO.SupplierReceivables>(Session)
        ...
        public void SupplierReceivables_filtering_test()
        {
            ...
            List<DSS5_SupplyChainFinancialsOptimisation.BO.SupplierReceivables> results = null;
            Assert.DoesNotThrow(() =>
            {
                results = repo.GetAsQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.SupplierReceivables>(
                              a => true
