...
namespace DSS5_SupplyChainFinancialsOptimisation.BoTesting.Tests
{
    ...
    internal class TransactionStatusTests : NHibernateFixture
    {
        ...
        public void TransactionStatus_persistence_test()
        {
            ...
            new PersistenceSpecification<DSS5_SupplyChainFinancialsOptimisation.BO.TransactionStatus>(Session)
        ...
        public void TransactionStatus_filtering_test()
        {
            ...
            List<DSS5_SupplyChainFinancialsOptimisation.BO.TransactionStatus> results = null;
            Assert.DoesNotThrow(() =>
            {
                results = repo.GetAsQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.TransactionStatus>(
                              a => true
