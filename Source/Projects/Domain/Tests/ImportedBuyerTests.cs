...
namespace DSS5_SupplyChainFinancialsOptimisation.BoTesting.Tests
{
    ...
    internal class ImportedBuyerTests : NHibernateFixture
    {
        ...
        public void ImportedBuyer_filtering_test()
        {
            ...
            List<DSS5_SupplyChainFinancialsOptimisation.BO.ImportedBuyer> results = null;
            Assert.DoesNotThrow(() =>
            {
                results = repo.GetAsQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.ImportedBuyer>(
                              a => true
