...
namespace DSS5_SupplyChainFinancialsOptimisation.BoTesting.Tests
{
    ...
    internal class PartialProofOfDeliveryTests : NHibernateFixture
    {
        ...
        public void PartialProofOfDelivery_filtering_test()
        {
            ...
            List<DSS5_SupplyChainFinancialsOptimisation.BO.PartialProofOfDelivery> results = null;
            Assert.DoesNotThrow(() =>
            {
                results = repo.GetAsQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.PartialProofOfDelivery>(
                              a => true
