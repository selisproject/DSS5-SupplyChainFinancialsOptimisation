...
namespace DSS5_SupplyChainFinancialsOptimisation.BoTesting.Tests
{
    ...
    internal class ContactTests : NHibernateFixture
    {
        ...
        public void Contact_persistence_test()
        {
            ...
            new PersistenceSpecification<DSS5_SupplyChainFinancialsOptimisation.BO.Contact>(Session)
        ...
        public void Contact_filtering_test()
        {
            ...
            List<DSS5_SupplyChainFinancialsOptimisation.BO.Contact> results = null;
            Assert.DoesNotThrow(() =>
            {
                results = repo.GetAsQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.Contact>(
                              a => true
