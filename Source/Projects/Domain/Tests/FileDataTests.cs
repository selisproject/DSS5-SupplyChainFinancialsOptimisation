...
namespace DSS5_SupplyChainFinancialsOptimisation.BoTesting.Tests
{
    ...
    internal class FileDataTests : NHibernateFixture
    {
        ...
        public void FileData_persistence_test()
        {
            ...
            new PersistenceSpecification<DSS5_SupplyChainFinancialsOptimisation.BO.FileData>(Session)
            .CheckProperty(p => p.FileName, "FileData_FileName")
            .CheckProperty(p => p.FolderPath, "FileData_FolderPath")
            .CheckProperty(p => p.MaxFileSize, 236)
        ...
        public void FileData_filtering_test()
        {
            ...
            List<DSS5_SupplyChainFinancialsOptimisation.BO.FileData> results = null;
            Assert.DoesNotThrow(() =>
            {
                results = repo.GetAsQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.FileData>(
                              a => true
                              ...
                              && a.Blob != null
                              && a.StorageMedium == DSS5_SupplyChainFinancialsOptimisation.BO.StorageMedium.FileSystem
