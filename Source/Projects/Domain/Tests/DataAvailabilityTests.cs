...
namespace DSS5_SupplyChainFinancialsOptimisation.BoTesting.Tests
{
    ...
    internal class DataAvailabilityTests : NHibernateFixture
    {
        ...
        public void DataAvailability_persistence_test()
        {
            ...
            var _supplier_supplier_dataavailability = new DSS5_SupplyChainFinancialsOptimisation.BO.Supplier
            {
                SupplierId = 1314,
                ...
                UserName = "e228ff7f-ec7a-422c-a182-3c7360e16364Supplier_UserName",
                ...
                AccessFailedCount = 7662,
                Name = "Supplier_Name",
                Email = "Supplier_Email",
                PhoneNumber = "Supplier_PhoneNumber",
                LockoutEndDate = now,
            };
            new PersistenceSpecification<DSS5_SupplyChainFinancialsOptimisation.BO.DataAvailability>(Session)
        ...
        public void DataAvailability_filtering_test()
        {
            ...
            List<DSS5_SupplyChainFinancialsOptimisation.BO.DataAvailability> results = null;
            Assert.DoesNotThrow(() =>
            {
                results = repo.GetAsQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.DataAvailability>(
                              a => true
                              && !a.Orders
                              && !a.DeliveryNotes
                              && !a.CustomsDocuments
