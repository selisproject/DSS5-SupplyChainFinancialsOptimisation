...
namespace DSS5_SupplyChainFinancialsOptimisation.BoTesting.Tests
{
    ...
    internal class CreditNoteTests : NHibernateFixture
    {
        ...
        public void CreditNote_filtering_test()
        {
            ...
            List<DSS5_SupplyChainFinancialsOptimisation.BO.CreditNote> results = null;
            Assert.DoesNotThrow(() =>
            {
                results = repo.GetAsQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.CreditNote>(
                              a => true
