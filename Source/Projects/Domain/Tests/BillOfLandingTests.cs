...
namespace DSS5_SupplyChainFinancialsOptimisation.BoTesting.Tests
{
    ...
    internal class BillOfLandingTests : NHibernateFixture
    {
        ...
        public void BillOfLanding_filtering_test()
        {
            ...
            List<DSS5_SupplyChainFinancialsOptimisation.BO.BillOfLanding> results = null;
            Assert.DoesNotThrow(() =>
            {
                results = repo.GetAsQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.BillOfLanding>(
                              a => true
