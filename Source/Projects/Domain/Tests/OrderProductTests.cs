...
namespace DSS5_SupplyChainFinancialsOptimisation.BoTesting.Tests
{
    ...
    internal class OrderProductTests : NHibernateFixture
    {
        ...
        public void OrderProduct_filtering_test()
        {
            ...
            List<DSS5_SupplyChainFinancialsOptimisation.BO.OrderProduct> results = null;
            Assert.DoesNotThrow(() =>
            {
                results = repo.GetAsQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.OrderProduct>(
                              a => true
