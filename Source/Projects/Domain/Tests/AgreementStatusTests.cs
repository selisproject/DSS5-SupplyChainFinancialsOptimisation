...
namespace DSS5_SupplyChainFinancialsOptimisation.BoTesting.Tests
{
    ...
    internal class AgreementStatusTests : NHibernateFixture
    {
        ...
        public void AgreementStatus_persistence_test()
        {
            ...
            new PersistenceSpecification<DSS5_SupplyChainFinancialsOptimisation.BO.AgreementStatus>(Session)
        ...
        public void AgreementStatus_filtering_test()
        {
            ...
            List<DSS5_SupplyChainFinancialsOptimisation.BO.AgreementStatus> results = null;
            Assert.DoesNotThrow(() =>
            {
                results = repo.GetAsQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.AgreementStatus>(
                              a => true
