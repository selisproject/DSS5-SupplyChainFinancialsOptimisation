...
namespace DSS5_SupplyChainFinancialsOptimisation.BoTesting.Tests
{
    ...
    internal class SupplierTurnoverTests : NHibernateFixture
    {
        ...
        public void SupplierTurnover_persistence_test()
        {
            ...
            new PersistenceSpecification<DSS5_SupplyChainFinancialsOptimisation.BO.SupplierTurnover>(Session)
        ...
        public void SupplierTurnover_filtering_test()
        {
            ...
            List<DSS5_SupplyChainFinancialsOptimisation.BO.SupplierTurnover> results = null;
            Assert.DoesNotThrow(() =>
            {
                results = repo.GetAsQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.SupplierTurnover>(
                              a => true
