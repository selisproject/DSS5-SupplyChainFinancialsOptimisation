...
namespace DSS5_SupplyChainFinancialsOptimisation.BoTesting.Tests
{
    ...
    internal class TransactionOverviewTests : NHibernateFixture
    {
        ...
        public void TransactionOverview_persistence_test()
        {
            ...
            new PersistenceSpecification<DSS5_SupplyChainFinancialsOptimisation.BO.TransactionOverview>(Session)
            .CheckProperty(p => p.DeliveryDate, now)
            .CheckProperty(p => p.OrderQuantity, 2222222222.22222M)
            .CheckProperty(p => p.OrderDate, now)
            .CheckProperty(p => p.InvoiceId, 2997)
            ...
            .CheckProperty(p => p.PaymentId, 7959)
        ...
        public void TransactionOverview_filtering_test()
        {
            ...
            List<DSS5_SupplyChainFinancialsOptimisation.BO.TransactionOverview> results = null;
            Assert.DoesNotThrow(() =>
            {
                results = repo.GetAsQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.TransactionOverview>(
                              a => true
