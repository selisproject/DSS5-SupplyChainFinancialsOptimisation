    ...
    internal class BuyerStatisticTests : NHibernateFixture
    {
        ...
        public void BuyerStatistic_persistence_test()
        {
            ...
            var _dashboard_buyer_buyerstatistics = new DSS5_SupplyChainFinancialsOptimisation.BO.Buyer
            {
                ...
                Prefix = "Buyer_Prefix",
                Temp = "Buyer_Temp",
                UserName = "95383443-b880-444e-a04d-bea403786a0cBuyer_UserName",
        ...
        public void BuyerStatistic_filtering_test()
        {
            ...
            List<DSS5_SupplyChainFinancialsOptimisation.BO.BuyerStatistic> results = null;
            Assert.DoesNotThrow(() =>
            {
                results = repo.GetAsQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.BuyerStatistic>(
                              a => true
                              && a.Buyer != null
                              ,
                              cacheQuery: true)
