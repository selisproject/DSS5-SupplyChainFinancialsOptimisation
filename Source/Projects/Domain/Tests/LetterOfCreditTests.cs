...
namespace DSS5_SupplyChainFinancialsOptimisation.BoTesting.Tests
{
    ...
    internal class LetterOfCreditTests : NHibernateFixture
    {
        ...
        public void LetterOfCredit_filtering_test()
        {
            ...
            List<DSS5_SupplyChainFinancialsOptimisation.BO.LetterOfCredit> results = null;
            Assert.DoesNotThrow(() =>
            {
                results = repo.GetAsQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.LetterOfCredit>(
                              a => true
                              && (a.ValueOfLoC + 123 > 0)
