...
namespace DSS5_SupplyChainFinancialsOptimisation.ExternalStructs.GoogleGeocode
{
    [XmlRoot("Root")]
    public class Root
    {
        ...
        public DSS5_SupplyChainFinancialsOptimisation.ExternalStructs.GoogleGeocode.result[] results
        {
            get;
            set;
        }
    ...
    public class result
    {
        ...
        public DSS5_SupplyChainFinancialsOptimisation.ExternalStructs.GoogleGeocode.address_component[] address_components
        {
            get;
            set;
        }
        ...
        public DSS5_SupplyChainFinancialsOptimisation.ExternalStructs.GoogleGeocode.geometry geometry
        {
            get;
            set;
        }
    ...
    public class geometry
    {
        ...
        public DSS5_SupplyChainFinancialsOptimisation.ExternalStructs.GoogleGeocode.location location
        {
            get;
            set;
        }
        ...
        public DSS5_SupplyChainFinancialsOptimisation.ExternalStructs.GoogleGeocode.viewport viewport
        {
            get;
            set;
        }
        ...
        public DSS5_SupplyChainFinancialsOptimisation.ExternalStructs.GoogleGeocode.viewport bounds
        {
            get;
            set;
        }
    ...
    public class viewport
    {
        ...
        public DSS5_SupplyChainFinancialsOptimisation.ExternalStructs.GoogleGeocode.location northeast
        {
            get;
            set;
        }
        ...
        public DSS5_SupplyChainFinancialsOptimisation.ExternalStructs.GoogleGeocode.location southwest
        {
            get;
            set;
        }
