...
using DSS5_SupplyChainFinancialsOptimisation.Hubs;
...
namespace DSS5_SupplyChainFinancialsOptimisation.Web
{
    ...
    public class Global : HttpApplication
    {
        public void Application_Start(object sender, EventArgs e)
        {
            ...
            {
                Server.MapPath("bin\\DSS5_SupplyChainFinancialsOptimisation.Backend.dll"),
                               Server.MapPath("bin\\DSS5_SupplyChainFinancialsOptimisation.Web.dll"),
