...
using DSS5_SupplyChainFinancialsOptimisation.Security.Owin;
using DSS5_SupplyChainFinancialsOptimisation.Web.Code;
...
namespace DSS5_SupplyChainFinancialsOptimisation.Web
{
    public class Startup
    {
        public void ConfigureServices(IAppBuilder app, System.Web.Http.HttpConfiguration config)
        {
            ...
            .SingleInstance();
            builder
            .Register(c => new DSS5_SupplyChainFinancialsOptimisation.Hubs.EventsHub())
        ...
        public void Configuration(IAppBuilder app)
        {
            ...
            DSS5_SupplyChainFinancialsOptimisation.DatabaseSeeder databaseSeeder = new DSS5_SupplyChainFinancialsOptimisation.DatabaseSeeder();
            ...
            .Init(typeof(DSS5_SupplyChainFinancialsOptimisation.DAL.Repository).Assembly);
            DSS5_SupplyChainFinancialsOptimisation.Hubs.EventsHub.RaiseApplicationStart();
