...
interface Window { scope_MasterPageSignIn: DSS5_SupplyChainFinancialsOptimisation.Controllers.IMasterPageSignInScope; }
...
model:
    DSS5_SupplyChainFinancialsOptimisation.ViewModels.MasterPageSignIn.MasterPageSignInViewModel;
...
class MasterPageSignInController {
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        //
        DSS5_SupplyChainFinancialsOptimisation.ViewModels.MasterPageSignIn.MasterPageSignInViewModel._lightCast(window.scope_MasterPageSignIn.model);
    ...
    constructor(private $scope: IMasterPageSignInScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS5_SupplyChainFinancialsOptimisation.ViewModels.MasterPageSignIn.MasterPageSignInViewModel._initializeFrom($scope.model, context);
