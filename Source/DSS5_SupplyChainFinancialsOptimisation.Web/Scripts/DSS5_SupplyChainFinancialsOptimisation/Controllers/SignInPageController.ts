...
interface Window { scope_SignInPage: DSS5_SupplyChainFinancialsOptimisation.Controllers.ISignInPageScope; }
...
model:
    DSS5_SupplyChainFinancialsOptimisation.ViewModels.SignInPage.SignInPageViewModel;
...
private timeoutDelayLockButton1Clicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        //window.scope_MasterPage.model = window.scope_SignInPage.model;
        DSS5_SupplyChainFinancialsOptimisation.ViewModels.SignInPage.SignInPageViewModel._lightCast(window.scope_SignInPage.model);
    ...
    constructor(private $scope: ISignInPageScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS5_SupplyChainFinancialsOptimisation.ViewModels.SignInPage.SignInPageViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: ISignInPageScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DSS5_SupplyChainFinancialsOptimisation.ViewModels.SignInPage.SignInPageViewModel._initializeFrom(window.viewDTO.Model);
...
SendConfirmationMail:
            async (_cb, _modalOptions, _e) => {
                ...
                window._context.isDirty = false;
                Joove.Core.executeControllerActionNew({
verb: 'POST', controller: 'SignInPage', action: 'SendConfirmationMail',
queryData: [], postData: {'model': $scope.model},
cb: _cb, modalOptions: _modalOptions, event: _e
                });
            },
