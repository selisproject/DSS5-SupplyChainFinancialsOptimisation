...
(function (DSS5_SupplyChainFinancialsOptimisation) {
    ...
    (function (Controllers) {
        var ManageOperationConditionalFormattings = [];
        var ManageOperationDataValidations = [];
        var ManageOperationCalculatedExpressions = [];
        ...
        var ManageOperationController = (function () {
            function ManageOperationController($scope, $timeout) {
                this.$scope = $scope;
                this.controllerActionFinished = function (resetDirty) {
                    ...
                    DSS5_SupplyChainFinancialsOptimisation.ViewModels.ManageOperation.ManageOperationViewModel._lightCast(window.scope_ManageOperation.model);
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS5_SupplyChainFinancialsOptimisation.ViewModels.ManageOperation.ManageOperationViewModel._initializeFrom($scope.model, context);
                };
            ...
            ManageOperationController.prototype.init = function ($scope, $timeout) {
                var _this = this;
                $scope.model = DSS5_SupplyChainFinancialsOptimisation.ViewModels.ManageOperation.ManageOperationViewModel._initializeFrom(window.viewDTO.Model);
                ...
                // Controller actions
                $scope.actions = {
                    EditOperation: function (Id, _cb, _modalOptions, _e) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    SaveOperation: function (_cb, _modalOptions, _e) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            Joove.Common.autocompleteFix();
                            window._context.isDirty = false;
                    ...
                    Button2OnChange: function (e, DataItem, _parents) {
                        ...
                        _this.timeoutDelayLockButton2OnChange = $timeout(function () {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                var p_FormControls_ManageOperation_FormControlsDefinition_Button2_PickListControl_SelectedItems_ApplicationPermissionViewModel = Joove.Common.nullSafe(function () { return Joove.DatasourceManager.getSelectedItems($("[jb-id='Button2']"), e); }, null);
                                if (eval("DSS5_SupplyChainFinancialsOptimisation.ViewModels.ManageOperation.FormControls_ManageOperation_FormControlsDefinition_Button2_PickListControl_SelectedItems_ApplicationPermissionViewModel") != null && eval("DSS5_SupplyChainFinancialsOptimisation.ViewModels.ManageOperation.FormControls_ManageOperation_FormControlsDefinition_Button2_PickListControl_SelectedItems_ApplicationPermissionViewModel._initializeFrom") != null) {
                                    var _initial = p_FormControls_ManageOperation_FormControlsDefinition_Button2_PickListControl_SelectedItems_ApplicationPermissionViewModel;
                                    p_FormControls_ManageOperation_FormControlsDefinition_Button2_PickListControl_SelectedItems_ApplicationPermissionViewModel = [];
                                    for (var _i = 0; _i < _initial.length; _i++) {
                                        var _temp = eval("DSS5_SupplyChainFinancialsOptimisation.ViewModels.ManageOperation.FormControls_ManageOperation_FormControlsDefinition_Button2_PickListControl_SelectedItems_ApplicationPermissionViewModel._initializeFrom(_initial[_i])");
                                        p_FormControls_ManageOperation_FormControlsDefinition_Button2_PickListControl_SelectedItems_ApplicationPermissionViewModel.push(_temp);
                                    }
                                }
                                $scope.actions.Button2Changed(p_FormControls_ManageOperation_FormControlsDefinition_Button2_PickListControl_SelectedItems_ApplicationPermissionViewModel, true, null, null, e);
            ...
            return ManageOperationController;
        }());
        angular.module("Application").controller("ManageOperationController", ["$scope", "$timeout", ManageOperationController]);
