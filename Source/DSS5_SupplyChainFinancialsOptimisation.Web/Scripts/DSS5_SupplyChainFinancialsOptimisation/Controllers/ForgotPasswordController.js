                ...
                condition: function (_parents) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, Joove.Common.nullSafe(function () { return CLMS.Framework.String.IsNullOrEmpty(Joove.Common.nullSafe(function () {
                                return Joove.Common.nullSafe(function () { return window["scope_ForgotPassword"].model.txtEmail; }, "").trim();
                            }, "")); }, false)];
                    });
                }); },
        ...
        var ForgotPasswordController = (function () {
            function ForgotPasswordController($scope, $timeout) {
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS5_SupplyChainFinancialsOptimisation.ViewModels.ForgotPassword.ForgotPasswordViewModel._initializeFrom($scope.model, context);
                };
            ...
            ForgotPasswordController.prototype.init = function ($scope, $timeout) {
                ...
                $scope.actions = {
                    ...
                    ResetPassword: function (_cb, _modalOptions, _e) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            Joove.Common.autocompleteFix();
                            window._context.isDirty = false;
