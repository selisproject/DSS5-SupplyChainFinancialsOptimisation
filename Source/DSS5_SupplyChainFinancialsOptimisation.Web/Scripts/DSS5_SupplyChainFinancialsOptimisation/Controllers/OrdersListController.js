...
(function (DSS5_SupplyChainFinancialsOptimisation) {
    ...
    (function (Controllers) {
        var OrdersListConditionalFormattings = [];
        var OrdersListDataValidations = [];
        var OrdersListCalculatedExpressions = [];
        ...
        var OrdersListController = (function () {
            function OrdersListController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS5_SupplyChainFinancialsOptimisation.ViewModels.OrdersList.OrdersListViewModel._initializeFrom($scope.model, context);
                };
            ...
            OrdersListController.prototype.init = function ($scope, $timeout) {
                var _this = this;
                ...
                $scope.eventCallbacks = {
                    AddNewClicked: function (e, DataItem, _parents) {
                        ...
                        _this.timeoutDelayLockAddNewClicked = $timeout(function () {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                ...
                                Joove.Core.executeRedirectControllerAction("OrderForm", "AddOrder", "GET", [], null, null, openInNewWindow);
                    ...
                    MIDeleteClicked: function (e, DataItem, _parents) {
                        window._recorder.addState(e);
                        if (e != null) {
                            e.stopPropagation();
                            e.preventDefault();
                        }
                        if (_this.timeoutDelayLockMIDeleteClicked != null) {
                            $timeout.cancel(_this.timeoutDelayLockMIDeleteClicked);
                        }
                        _this.timeoutDelayLockMIDeleteClicked = $timeout(function () {
                            Joove.Common.setControlKeyPressed(e, 0);
                            Joove.Common.setLastClickedElement(e);
                            window._popUpManager.question(window._resourcesManager.getGlobalResource("RES_WEBFORM_GenericConfirmationQuestion"), window._resourcesManager.getEventConfirmation("MIDelete", false), function (isConfirm) {
                                if (!isConfirm)
                                    return;
                                setTimeout(function () {
                                    Joove.Validation.Manager.validateFormAndExecute(function () {
        ...
        angular.module("Application").controller("OrdersListController", ["$scope", "$timeout", OrdersListController]);
