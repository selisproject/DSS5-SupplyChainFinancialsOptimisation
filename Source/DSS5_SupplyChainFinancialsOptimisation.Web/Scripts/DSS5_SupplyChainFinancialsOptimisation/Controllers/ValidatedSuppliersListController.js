...
(function (DSS5_SupplyChainFinancialsOptimisation) {
    ...
    (function (Controllers) {
        var ValidatedSuppliersListConditionalFormattings = [];
        var ValidatedSuppliersListDataValidations = [];
        var ValidatedSuppliersListCalculatedExpressions = [];
        ...
        var ValidatedSuppliersListController = (function () {
            function ValidatedSuppliersListController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS5_SupplyChainFinancialsOptimisation.ViewModels.ValidatedSuppliersList.ValidatedSuppliersListViewModel._initializeFrom($scope.model, context);
                };
            ...
            ValidatedSuppliersListController.prototype.init = function ($scope, $timeout) {
                var _this = this;
            ...
            return ValidatedSuppliersListController;
        }());
        angular.module("Application").controller("ValidatedSuppliersListController", ["$scope", "$timeout", ValidatedSuppliersListController]);
