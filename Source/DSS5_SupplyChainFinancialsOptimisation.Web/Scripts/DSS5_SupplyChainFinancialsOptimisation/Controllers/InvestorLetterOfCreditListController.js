...
(function (DSS5_SupplyChainFinancialsOptimisation) {
    ...
    (function (Controllers) {
        var InvestorLetterOfCreditListConditionalFormattings = [];
        var InvestorLetterOfCreditListDataValidations = [];
        var InvestorLetterOfCreditListCalculatedExpressions = [];
        ...
        var InvestorLetterOfCreditListController = (function () {
            function InvestorLetterOfCreditListController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS5_SupplyChainFinancialsOptimisation.ViewModels.InvestorLetterOfCreditList.InvestorLetterOfCreditListViewModel._initializeFrom($scope.model, context);
                };
            ...
            InvestorLetterOfCreditListController.prototype.init = function ($scope, $timeout) {
                var _this = this;
            ...
            return InvestorLetterOfCreditListController;
        }());
        angular.module("Application").controller("InvestorLetterOfCreditListController", ["$scope", "$timeout", InvestorLetterOfCreditListController]);
