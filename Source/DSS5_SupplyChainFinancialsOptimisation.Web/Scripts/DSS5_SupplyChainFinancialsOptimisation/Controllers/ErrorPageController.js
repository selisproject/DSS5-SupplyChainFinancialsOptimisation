...
(function (DSS5_SupplyChainFinancialsOptimisation) {
    ...
    (function (Controllers) {
        var ErrorPageConditionalFormattings = [];
        var ErrorPageDataValidations = [];
        var ErrorPageCalculatedExpressions = [];
        var ErrorPageController = (function () {
            function ErrorPageController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS5_SupplyChainFinancialsOptimisation.ViewModels.ErrorPage.ErrorPageViewModel._initializeFrom($scope.model, context);
                };
            ...
            ErrorPageController.prototype.init = function ($scope, $timeout) {
                var _this = this;
                ...
                $scope.actions = {
                    ...
                    SendErrorToAdministrator: function (_cb, _modalOptions, _e) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            Joove.Common.autocompleteFix();
                            window._context.isDirty = false;
        ...
        angular.module("Application").controller("ErrorPageController", ["$scope", "$timeout", ErrorPageController]);
