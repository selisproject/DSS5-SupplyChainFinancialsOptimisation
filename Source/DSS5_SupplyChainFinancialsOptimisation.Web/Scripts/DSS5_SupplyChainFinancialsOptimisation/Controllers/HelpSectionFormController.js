...
(function (DSS5_SupplyChainFinancialsOptimisation) {
    ...
    (function (Controllers) {
        var HelpSectionFormConditionalFormattings = [];
        var HelpSectionFormDataValidations = [];
        var HelpSectionFormCalculatedExpressions = [];
        var HelpSectionFormController = (function () {
            function HelpSectionFormController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS5_SupplyChainFinancialsOptimisation.ViewModels.HelpSectionForm.HelpSectionFormViewModel._initializeFrom($scope.model, context);
                };
            ...
            HelpSectionFormController.prototype.init = function ($scope, $timeout) {
                var _this = this;
                    ...
                    ButtonClicked: function (e, DataItem, _parents) {
                        ...
                        _this.timeoutDelayLockButtonClicked = $timeout(function () {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                ...
                                Joove.Core.executeRedirectControllerAction("HelpGuestSupplier", "Render", "GET", [], {}, { mode: 'PopUp', width: '50%', height: '50%', onClose: function () { $scope.actions.CloseModal(); } });
                    ...
                    Button1Clicked: function (e, DataItem, _parents) {
                        ...
                        _this.timeoutDelayLockButton1Clicked = $timeout(function () {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                ...
                                if (openInNewWindow)
                                    $(e.target).data("openInNewWindow", undefined);
                                Joove.Core.executeRedirectControllerAction("HelpRegisteredSupplier", "Render", "GET", [], {}, { mode: 'PopUp', width: '50%', height: '50%', onClose: function () { $scope.actions.CloseModal(); } });
                            }, { groups: [], withDataValidationsCheck: false, withRequiredFieldsCheck: false });
                        }, 0);
                    },
                    Button2Clicked: function (e, DataItem, _parents) {
                        ...
                        _this.timeoutDelayLockButton2Clicked = $timeout(function () {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                ...
                                if (openInNewWindow)
                                    $(e.target).data("openInNewWindow", undefined);
                                Joove.Core.executeRedirectControllerAction("HelpValidatedSupplier", "Render", "GET", [], {}, { mode: 'PopUp', width: '50%', height: '50%', onClose: function () { $scope.actions.CloseModal(); } });
                            }, { groups: [], withDataValidationsCheck: false, withRequiredFieldsCheck: false });
                        }, 0);
                    }
                };
            ...
            return HelpSectionFormController;
        }());
        angular.module("Application").controller("HelpSectionFormController", ["$scope", "$timeout", HelpSectionFormController]);
