        ...
        var SignInPageController = (function () {
            function SignInPageController($scope, $timeout) {
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS5_SupplyChainFinancialsOptimisation.ViewModels.SignInPage.SignInPageViewModel._initializeFrom($scope.model, context);
                };
            ...
            SignInPageController.prototype.init = function ($scope, $timeout) {
                ...
                $scope.actions = {
                    ...
                    SendConfirmationMail: function (_cb, _modalOptions, _e) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    Joove.Common.autocompleteFix();
