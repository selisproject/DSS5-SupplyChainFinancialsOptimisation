...
interface Window { scope_MasterPageForSlide: DSS5_SupplyChainFinancialsOptimisation.Controllers.IMasterPageForSlideScope; }
...
class MasterPageForSlideController {
    ...
    constructor(private $scope: IMasterPageForSlideScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS5_SupplyChainFinancialsOptimisation.ViewModels.MasterPageForSlide.MasterPageForSlideViewModel._initializeFrom($scope.model, context);
