        ...
        var ManageRoleController = (function () {
            function ManageRoleController($scope, $timeout) {
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS5_SupplyChainFinancialsOptimisation.ViewModels.ManageRole.ManageRoleViewModel._initializeFrom($scope.model, context);
                };
            ...
            ManageRoleController.prototype.init = function ($scope, $timeout) {
                ...
                $scope.actions = {
                    ...
                    AddPermissionChanged: function (DataItems, byUser, _cb, _modalOptions, _e) { return __awaiter(_this, void 0, void 0, function () {
                        var _this = this;
                ...
                $scope.eventCallbacks = {
                    AddPermissionOnChange: function (e, DataItem, _parents) {
                        window._recorder.addState(e);
                        if (_this.timeoutDelayLockAddPermissionOnChange != null) {
                            $timeout.cancel(_this.timeoutDelayLockAddPermissionOnChange);
                        }
                        _this.timeoutDelayLockAddPermissionOnChange = $timeout(function () {
                            if (e.target) {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                var p_FormControls_ManageRole_FormControlsDefinition_AddPermission_PickListControl_SelectedItems_ApplicationPermissionViewModel = Joove.Common.nullSafe(function () { return Joove.DatasourceManager.getSelectedItems($("[jb-id='AddPermission']"), e); }, null);
