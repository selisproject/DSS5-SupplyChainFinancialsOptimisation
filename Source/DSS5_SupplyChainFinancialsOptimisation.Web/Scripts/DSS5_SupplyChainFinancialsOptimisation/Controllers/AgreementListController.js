...
(function (DSS5_SupplyChainFinancialsOptimisation) {
    ...
    (function (Controllers) {
        var AgreementListConditionalFormattings = [];
        var AgreementListDataValidations = [];
        var AgreementListCalculatedExpressions = [];
        ...
        var AgreementListController = (function () {
            function AgreementListController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS5_SupplyChainFinancialsOptimisation.ViewModels.AgreementList.AgreementListViewModel._initializeFrom($scope.model, context);
                };
            ...
            AgreementListController.prototype.init = function ($scope, $timeout) {
                var _this = this;
                    ...
                    ModifyClicked: function (e, DataItem, _parents) {
                        ...
                        _this.timeoutDelayLockModifyClicked = $timeout(function () {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                ...
                                Joove.Core.executeRedirectControllerAction("AgreementForm", "EditAgreement", "GET", [Joove.Common.nullSafe(function () { return Joove.DatasourceManager.getSelectedItem($("[jb-id='AgreementListNoDT']"), e).Id; }, 0)], null, null, openInNewWindow);
            ...
            return AgreementListController;
        }());
        angular.module("Application").controller("AgreementListController", ["$scope", "$timeout", AgreementListController]);
