...
(function (DSS5_SupplyChainFinancialsOptimisation) {
    ...
    (function (Controllers) {
        var FinishedTransactionsListConditionalFormattings = [];
        var FinishedTransactionsListDataValidations = [];
        var FinishedTransactionsListCalculatedExpressions = [];
        ...
        var FinishedTransactionsListController = (function () {
            function FinishedTransactionsListController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS5_SupplyChainFinancialsOptimisation.ViewModels.FinishedTransactionsList.FinishedTransactionsListViewModel._initializeFrom($scope.model, context);
                };
            ...
            FinishedTransactionsListController.prototype.init = function ($scope, $timeout) {
                var _this = this;
                ...
                $scope.eventCallbacks = {
                    MIViewTransactionClicked: function (e, DataItem, _parents) {
                        window._recorder.addState(e);
                        if (e != null) {
                            e.stopPropagation();
                            e.preventDefault();
                        }
                        if (_this.timeoutDelayLockMIViewTransactionClicked != null) {
                            $timeout.cancel(_this.timeoutDelayLockMIViewTransactionClicked);
                        }
                        _this.timeoutDelayLockMIViewTransactionClicked = $timeout(function () {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                ...
                                Joove.Core.executeRedirectControllerAction("TransactionForm", "EditTransaction", "GET", [Joove.Common.nullSafe(function () { return Joove.DatasourceManager.getSelectedItem($("[jb-id='TransactionListNoDT']"), e).Id; }, 0)], null, null, openInNewWindow);
            ...
            return FinishedTransactionsListController;
        }());
        angular.module("Application").controller("FinishedTransactionsListController", ["$scope", "$timeout", FinishedTransactionsListController]);
