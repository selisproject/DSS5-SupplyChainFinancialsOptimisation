...
(function (DSS5_SupplyChainFinancialsOptimisation) {
    ...
    (function (Controllers) {
        var AdminProofOfDeliveryListConditionalFormattings = [];
        var AdminProofOfDeliveryListDataValidations = [];
        var AdminProofOfDeliveryListCalculatedExpressions = [];
        ...
        var AdminProofOfDeliveryListController = (function () {
            function AdminProofOfDeliveryListController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS5_SupplyChainFinancialsOptimisation.ViewModels.AdminProofOfDeliveryList.AdminProofOfDeliveryListViewModel._initializeFrom($scope.model, context);
                };
            ...
            AdminProofOfDeliveryListController.prototype.init = function ($scope, $timeout) {
                var _this = this;
            ...
            return AdminProofOfDeliveryListController;
        }());
        angular.module("Application").controller("AdminProofOfDeliveryListController", ["$scope", "$timeout", AdminProofOfDeliveryListController]);
