...
(function (DSS5_SupplyChainFinancialsOptimisation) {
    ...
    (function (Controllers) {
        var ApplicationSettingsListConditionalFormattings = [];
        var ApplicationSettingsListDataValidations = [];
        var ApplicationSettingsListCalculatedExpressions = [];
        // Datasets Column Info
        Controllers.List1DataSet_ColumnInfo = [new Joove.ColumnInfo("Key", "string", null, false),
            new Joove.ColumnInfo("Value", "string", null, false),
            new Joove.ColumnInfo("IsCustom", "bool", null, false)];
        window["List1DataSet_ColumnInfo"] = Controllers.List1DataSet_ColumnInfo;
        // Datasets Projection Shemas
        window["Table_ProjectionScema"] = {};
        var ApplicationSettingsListController = (function () {
            function ApplicationSettingsListController($scope, $timeout) {
                this.$scope = $scope;
                this.controllerActionFinished = function (resetDirty) {
                    ...
                    DSS5_SupplyChainFinancialsOptimisation.ViewModels.ApplicationSettingsList.ApplicationSettingsListViewModel._lightCast(window.scope_ApplicationSettingsList.model);
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS5_SupplyChainFinancialsOptimisation.ViewModels.ApplicationSettingsList.ApplicationSettingsListViewModel._initializeFrom($scope.model, context);
                };
            ...
            ApplicationSettingsListController.prototype.init = function ($scope, $timeout) {
                var _this = this;
                $scope.model = DSS5_SupplyChainFinancialsOptimisation.ViewModels.ApplicationSettingsList.ApplicationSettingsListViewModel._initializeFrom(window.viewDTO.Model);
                    ...
                    Button2Clicked: function (e, DataItem, _parents) {
                        ...
                        _this.timeoutDelayLockButton2Clicked = $timeout(function () {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                ...
                                Joove.Core.executeRedirectControllerAction("ApplicationSettingForm", "AddApplicationSetting", "GET", [], {}, { mode: 'Slide', width: '50%', height: '50%', onClose: function () { $scope.actions.Refresh(); } });
                    ...
                    ButtonClicked: function (e, DataItem, _parents) {
                        ...
                        _this.timeoutDelayLockButtonClicked = $timeout(function () {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                ...
                                if (openInNewWindow)
                                    $(e.target).data("openInNewWindow", undefined);
                                Joove.Core.executeRedirectControllerAction("ApplicationSettingForm", "EditApplicationSetting", "GET", [Joove.Common.nullSafe(function () { return _parents[0].Id; }, 0)], {}, { mode: 'Slide', width: '50%', height: '50%', onClose: function () { $scope.actions.Refresh(); } });
                            }, { groups: [], withDataValidationsCheck: false, withRequiredFieldsCheck: false });
                        }, 0);
                    }
                };
            ...
            return ApplicationSettingsListController;
        }());
        angular.module("Application").controller("ApplicationSettingsListController", ["$scope", "$timeout", ApplicationSettingsListController]);
