...
interface Window { scope_AdminOrdersList: DSS5_SupplyChainFinancialsOptimisation.Controllers.IAdminOrdersListScope; }
namespace DSS5_SupplyChainFinancialsOptimisation.Controllers {
const AdminOrdersListConditionalFormattings = [
        ];
const AdminOrdersListDataValidations = [
                                       ];
const AdminOrdersListCalculatedExpressions = [
        ];
...
export interface IAdminOrdersListScope extends Joove.IWebPageScope {
model:
    DSS5_SupplyChainFinancialsOptimisation.ViewModels.AdminOrdersList.AdminOrdersListViewModel;
...
private timeoutDelayLockModifyClicked:
    ...
    constructor(private $scope: IAdminOrdersListScope, $timeout: ng.ITimeoutService) {
        window.scope_AdminOrdersList = $scope;
        $scope.$onControlChanged = function (event, newValue, dontMakeDirty) {
            Joove.Core.onChange(event.target, newValue, dontMakeDirty)
        }

        $scope.dehydrate = (context = null) => DSS5_SupplyChainFinancialsOptimisation.ViewModels.AdminOrdersList.AdminOrdersListViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IAdminOrdersListScope, $timeout: ng.ITimeoutService) {
...
angular.module("Application").controller("AdminOrdersListController", ["$scope", "$timeout", AdminOrdersListController] as Array<string>);
}
