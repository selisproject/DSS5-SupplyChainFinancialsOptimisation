...
(function (DSS5_SupplyChainFinancialsOptimisation) {
    ...
    (function (Controllers) {
        ...
        var MasterPageForSlideConditionalFormattings = [];
        var MasterPageForSlideDataValidations = [];
        var MasterPageForSlideCalculatedExpressions = [];
        var MasterPageForSlideController = (function () {
            function MasterPageForSlideController($scope, $timeout) {
                var _this = this;
                this.$scope = $scope;
                this.controllerActionFinished = function (resetDirty) {
                    ...
                    //
                    DSS5_SupplyChainFinancialsOptimisation.ViewModels.MasterPageForSlide.MasterPageForSlideViewModel._lightCast(window.scope_MasterPageForSlide.model);
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS5_SupplyChainFinancialsOptimisation.ViewModels.MasterPageForSlide.MasterPageForSlideViewModel._initializeFrom($scope.model, context);
                };
            ...
            MasterPageForSlideController.prototype.init = function ($scope, $timeout) {
                var _this = this;
            ...
            return MasterPageForSlideController;
        }());
        angular.module("Application").controller("MasterPageForSlideController", ["$scope", "$timeout", MasterPageForSlideController]);
