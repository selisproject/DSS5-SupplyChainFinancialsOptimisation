...
(function (DSS5_SupplyChainFinancialsOptimisation) {
    ...
    (function (Controllers) {
        var InvoiceListConditionalFormattings = [];
        Controllers.InvoiceList_InvoiceListNoDT_ConditionalFormattings = {
        ...
        var InvoiceListDataValidations = [];
        var InvoiceListCalculatedExpressions = [];
        ...
        var InvoiceListController = (function () {
            function InvoiceListController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS5_SupplyChainFinancialsOptimisation.ViewModels.InvoiceList.InvoiceListViewModel._initializeFrom($scope.model, context);
                };
            ...
            InvoiceListController.prototype.init = function ($scope, $timeout) {
                var _this = this;
                    ...
                    ModifyClicked: function (e, DataItem, _parents) {
                        ...
                        _this.timeoutDelayLockModifyClicked = $timeout(function () {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                ...
                                Joove.Core.executeRedirectControllerAction("InvoiceForm", "EditInvoice", "GET", [Joove.Common.nullSafe(function () { return Joove.DatasourceManager.getSelectedItem($("[jb-id='InvoiceListNoDT']"), e).Id; }, 0)], null, null, openInNewWindow);
        ...
        angular.module("Application").controller("InvoiceListController", ["$scope", "$timeout", InvoiceListController]);
