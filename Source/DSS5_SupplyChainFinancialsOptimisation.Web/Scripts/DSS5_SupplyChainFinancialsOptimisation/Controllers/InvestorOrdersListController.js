...
(function (DSS5_SupplyChainFinancialsOptimisation) {
    ...
    (function (Controllers) {
        var InvestorOrdersListConditionalFormattings = [];
        var InvestorOrdersListDataValidations = [];
        var InvestorOrdersListCalculatedExpressions = [];
        ...
        var InvestorOrdersListController = (function () {
            function InvestorOrdersListController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS5_SupplyChainFinancialsOptimisation.ViewModels.InvestorOrdersList.InvestorOrdersListViewModel._initializeFrom($scope.model, context);
                };
            ...
            InvestorOrdersListController.prototype.init = function ($scope, $timeout) {
                var _this = this;
                ...
                $scope.actions = {
                    ...
                    FindAgreement: function (_cb, _modalOptions, _e) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    Joove.Common.autocompleteFix();
                    ...
                    ViewClicked: function (e, DataItem, _parents) {
                        ...
                        _this.timeoutDelayLockViewClicked = $timeout(function () {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                ...
                                Joove.Core.executeRedirectControllerAction("OrderForm", "EditOrder", "GET", [Joove.Common.nullSafe(function () { return Joove.DatasourceManager.getSelectedItem($("[jb-id='ListNoDT']"), e).Id; }, 0)], null, null, openInNewWindow);
            ...
            return InvestorOrdersListController;
        }());
        angular.module("Application").controller("InvestorOrdersListController", ["$scope", "$timeout", InvestorOrdersListController]);
