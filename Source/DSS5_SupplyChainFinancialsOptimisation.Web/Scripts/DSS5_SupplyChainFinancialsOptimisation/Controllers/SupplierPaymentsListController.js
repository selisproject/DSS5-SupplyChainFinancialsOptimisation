...
(function (DSS5_SupplyChainFinancialsOptimisation) {
    ...
    (function (Controllers) {
        var SupplierPaymentsListConditionalFormattings = [];
        var SupplierPaymentsListDataValidations = [];
        var SupplierPaymentsListCalculatedExpressions = [];
        ...
        var SupplierPaymentsListController = (function () {
            function SupplierPaymentsListController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS5_SupplyChainFinancialsOptimisation.ViewModels.SupplierPaymentsList.SupplierPaymentsListViewModel._initializeFrom($scope.model, context);
                };
            ...
            SupplierPaymentsListController.prototype.init = function ($scope, $timeout) {
                var _this = this;
            ...
            return SupplierPaymentsListController;
        }());
        angular.module("Application").controller("SupplierPaymentsListController", ["$scope", "$timeout", SupplierPaymentsListController]);
