...
(function (DSS5_SupplyChainFinancialsOptimisation) {
    ...
    (function (Controllers) {
        var InvestorPODsListConditionalFormattings = [];
        var InvestorPODsListDataValidations = [];
        var InvestorPODsListCalculatedExpressions = [];
        ...
        var InvestorPODsListController = (function () {
            function InvestorPODsListController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS5_SupplyChainFinancialsOptimisation.ViewModels.InvestorPODsList.InvestorPODsListViewModel._initializeFrom($scope.model, context);
                };
            ...
            InvestorPODsListController.prototype.init = function ($scope, $timeout) {
                var _this = this;
            ...
            return InvestorPODsListController;
        }());
        angular.module("Application").controller("InvestorPODsListController", ["$scope", "$timeout", InvestorPODsListController]);
