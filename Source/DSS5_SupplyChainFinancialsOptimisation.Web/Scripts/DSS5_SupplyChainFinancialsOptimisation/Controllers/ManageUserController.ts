...
interface Window { scope_ManageUser: DSS5_SupplyChainFinancialsOptimisation.Controllers.IManageUserScope; }
...
model:
    DSS5_SupplyChainFinancialsOptimisation.ViewModels.ManageUser.ManageUserViewModel;
...
private timeoutDelayLockExitBtnClicked:
    ...
    constructor(private $scope: IManageUserScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS5_SupplyChainFinancialsOptimisation.ViewModels.ManageUser.ManageUserViewModel._initializeFrom($scope.model, context);
