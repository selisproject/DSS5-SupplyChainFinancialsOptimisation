...
(function (DSS5_SupplyChainFinancialsOptimisation) {
    ...
    (function (Controllers) {
        var HelpRegisteredSupplierConditionalFormattings = [];
        var HelpRegisteredSupplierDataValidations = [];
        var HelpRegisteredSupplierCalculatedExpressions = [];
        var HelpRegisteredSupplierController = (function () {
            function HelpRegisteredSupplierController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS5_SupplyChainFinancialsOptimisation.ViewModels.HelpRegisteredSupplier.HelpRegisteredSupplierViewModel._initializeFrom($scope.model, context);
                };
            ...
            HelpRegisteredSupplierController.prototype.init = function ($scope, $timeout) {
                var _this = this;
            ...
            return HelpRegisteredSupplierController;
        }());
        angular.module("Application").controller("HelpRegisteredSupplierController", ["$scope", "$timeout", HelpRegisteredSupplierController]);
