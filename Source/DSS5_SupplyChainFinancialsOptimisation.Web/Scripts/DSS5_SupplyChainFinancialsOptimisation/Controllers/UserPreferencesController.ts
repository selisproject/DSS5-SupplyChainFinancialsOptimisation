...
interface Window { scope_UserPreferences: DSS5_SupplyChainFinancialsOptimisation.Controllers.IUserPreferencesScope; }
...
model:
    DSS5_SupplyChainFinancialsOptimisation.ViewModels.UserPreferences.UserPreferencesViewModel;
...
private timeoutDelayLockCancelBtnClicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DSS5_SupplyChainFinancialsOptimisation.ViewModels.UserPreferences.UserPreferencesViewModel._lightCast(window.scope_UserPreferences.model);
    ...
    constructor(private $scope: IUserPreferencesScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS5_SupplyChainFinancialsOptimisation.ViewModels.UserPreferences.UserPreferencesViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IUserPreferencesScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DSS5_SupplyChainFinancialsOptimisation.ViewModels.UserPreferences.UserPreferencesViewModel._initializeFrom(window.viewDTO.Model);
