...
interface Window { scope_ApplicationSettingsList: DSS5_SupplyChainFinancialsOptimisation.Controllers.IApplicationSettingsListScope; }
...
export var List1DataSet_ColumnInfo = [new Joove.ColumnInfo("Key", "string", null, false),
...
model:
    DSS5_SupplyChainFinancialsOptimisation.ViewModels.ApplicationSettingsList.ApplicationSettingsListViewModel;
...
private timeoutDelayLockName1Clicked:
    any;
private timeoutDelayLockCustomClicked:
    any;
private timeoutDelayLockButtonClicked:
    ...
    constructor(private $scope: IApplicationSettingsListScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS5_SupplyChainFinancialsOptimisation.ViewModels.ApplicationSettingsList.ApplicationSettingsListViewModel._initializeFrom($scope.model, context);
            ...
            (e, DataItem, _parents) => {
                ...
                this.timeoutDelayLockButtonClicked = $timeout(() => {
                    ...
                    Joove.Validation.Manager.validateFormAndExecute(() => {
                        ...
                        //and occurs when the middle mouse button click is triggered
                        var openInNewWindow = $(e.target).data("openInNewWindow") === true || undefined;
if (openInNewWindow) $(e.target).data("openInNewWindow", undefined); Joove.Core.executeRedirectControllerAction("ApplicationSettingForm", "EditApplicationSetting", "GET", [Joove.Common.nullSafe<any>(() => _parents[0].Id, 0)], {}, { mode: 'Slide', width: '50%', height: '50%', onClose: () => { $scope.actions.Refresh(); }});
}, { groups: [], withDataValidationsCheck: false, withRequiredFieldsCheck: false });
                }, 0);
            },
