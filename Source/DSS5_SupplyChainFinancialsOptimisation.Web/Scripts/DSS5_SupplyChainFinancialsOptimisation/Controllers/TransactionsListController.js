...
(function (DSS5_SupplyChainFinancialsOptimisation) {
    ...
    (function (Controllers) {
        var TransactionsListConditionalFormattings = [];
        var TransactionsListDataValidations = [];
        var TransactionsListCalculatedExpressions = [];
        ...
        var TransactionsListController = (function () {
            function TransactionsListController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS5_SupplyChainFinancialsOptimisation.ViewModels.TransactionsList.TransactionsListViewModel._initializeFrom($scope.model, context);
                };
            ...
            TransactionsListController.prototype.init = function ($scope, $timeout) {
                var _this = this;
                    ...
                    AddNewClicked: function (e, DataItem, _parents) {
                        ...
                        _this.timeoutDelayLockAddNewClicked = $timeout(function () {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                ...
                                Joove.Core.executeRedirectControllerAction("TransactionForm", "AddTransaction", "GET", [], null, null, openInNewWindow);
        ...
        angular.module("Application").controller("TransactionsListController", ["$scope", "$timeout", TransactionsListController]);
