...
interface Window { scope_MasterPageForLists: DSS5_SupplyChainFinancialsOptimisation.Controllers.IMasterPageForListsScope; }
namespace DSS5_SupplyChainFinancialsOptimisation.Controllers {
var _treeNodesConfiguration = { };
const MasterPageForListsConditionalFormattings = [
new Joove.JbRule({
...
condition: async (_parents) => {
        return Joove.Common.nullSafe<any>(() => CLMS.Framework.String.IsNullOrEmpty(Joove.Common.nullSafe(function () {
            return Joove.Common.nullSafe<any>(() => window["scope_MasterPageForLists"].model.Title, "").trim();
        }, "")), false);
...
const MasterPageForListsDataValidations = [
        ];
const MasterPageForListsCalculatedExpressions = [
new Joove.JbRule({
...
export interface IMasterPageForListsScope extends Joove.IWebPageScope {
model:
...
class MasterPageForListsController {
...
private timeoutDelayLockMPSupplierPaymentsMenuItemPressed:
    any;
private timeoutDelayLockMPLAdminPaymentsMenuItemPressed:
    any;
    ...
    constructor(private $scope: IMasterPageForListsScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS5_SupplyChainFinancialsOptimisation.ViewModels.MasterPageForLists.MasterPageForListsViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IMasterPageForListsScope, $timeout: ng.ITimeoutService) {
...
MPLAdminPaymentsMenuItemPressed:
            (e, DataItem, _parents) => {
                window._recorder.addState(e);
                ...
                if (this.timeoutDelayLockMPLAdminPaymentsMenuItemPressed != null) {
                    $timeout.cancel(this.timeoutDelayLockMPLAdminPaymentsMenuItemPressed);
                }

                this.timeoutDelayLockMPLAdminPaymentsMenuItemPressed = $timeout(() => {
                    Joove.Common.setControlKeyPressed(e, 0); Joove.Common.setLastClickedElement(e);
...
angular.module("Application").controller("MasterPageForListsController", ["$scope", "$timeout", MasterPageForListsController] as Array<string>);
}
