...
interface Window { scope_ManageRole: DSS5_SupplyChainFinancialsOptimisation.Controllers.IManageRoleScope; }
...
model:
    DSS5_SupplyChainFinancialsOptimisation.ViewModels.ManageRole.ManageRoleViewModel;
...
private timeoutDelayLockAddPermissionOnChange:
    any;
...
private timeoutDelayLockButton3Clicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DSS5_SupplyChainFinancialsOptimisation.ViewModels.ManageRole.ManageRoleViewModel._lightCast(window.scope_ManageRole.model);
    ...
    constructor(private $scope: IManageRoleScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS5_SupplyChainFinancialsOptimisation.ViewModels.ManageRole.ManageRoleViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IManageRoleScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DSS5_SupplyChainFinancialsOptimisation.ViewModels.ManageRole.ManageRoleViewModel._initializeFrom(window.viewDTO.Model);
...
AddPermissionOnChange:
            (e, DataItem, _parents) => {
                window._recorder.addState(e);


                if (this.timeoutDelayLockAddPermissionOnChange != null) {
                    $timeout.cancel(this.timeoutDelayLockAddPermissionOnChange);
                }

                this.timeoutDelayLockAddPermissionOnChange = $timeout(() => {
                    ...
                    Joove.Validation.Manager.validateFormAndExecute(() => {
                        ...
                        var p_FormControls_ManageRole_FormControlsDefinition_AddPermission_PickListControl_SelectedItems_ApplicationPermissionViewModel = Joove.Common.nullSafe<any>(() => Joove.DatasourceManager.getSelectedItems($("[jb-id='AddPermission']"), e), null);
                        if( eval(`DSS5_SupplyChainFinancialsOptimisation.ViewModels.ManageRole.FormControls_ManageRole_FormControlsDefinition_AddPermission_PickListControl_SelectedItems_ApplicationPermissionViewModel`) != null && eval(`DSS5_SupplyChainFinancialsOptimisation.ViewModels.ManageRole.FormControls_ManageRole_FormControlsDefinition_AddPermission_PickListControl_SelectedItems_ApplicationPermissionViewModel._initializeFrom`) != null ) {
                            var _initial = p_FormControls_ManageRole_FormControlsDefinition_AddPermission_PickListControl_SelectedItems_ApplicationPermissionViewModel;
                            p_FormControls_ManageRole_FormControlsDefinition_AddPermission_PickListControl_SelectedItems_ApplicationPermissionViewModel = [];
                            for(var _i = 0; _i < _initial.length; _i++) {
                                var _temp = eval(`DSS5_SupplyChainFinancialsOptimisation.ViewModels.ManageRole.FormControls_ManageRole_FormControlsDefinition_AddPermission_PickListControl_SelectedItems_ApplicationPermissionViewModel._initializeFrom(_initial[_i])`);
                                p_FormControls_ManageRole_FormControlsDefinition_AddPermission_PickListControl_SelectedItems_ApplicationPermissionViewModel.push(_temp);

                            }
                        }
                        $scope.actions.AddPermissionChanged(p_FormControls_ManageRole_FormControlsDefinition_AddPermission_PickListControl_SelectedItems_ApplicationPermissionViewModel, true, null, null, e);
