...
(function (DSS5_SupplyChainFinancialsOptimisation) {
    ...
    (function (Controllers) {
        var AdministrationConditionalFormattings = [];
        var AdministrationDataValidations = [];
        var AdministrationCalculatedExpressions = [];
        var AdministrationController = (function () {
            function AdministrationController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS5_SupplyChainFinancialsOptimisation.ViewModels.Administration.AdministrationViewModel._initializeFrom($scope.model, context);
                };
            ...
            AdministrationController.prototype.init = function ($scope, $timeout) {
                var _this = this;
                ...
                $scope.actions = {
                    ...
                    UpdateStats: function (_cb, _modalOptions, _e) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    Joove.Common.autocompleteFix();
        ...
        angular.module("Application").controller("AdministrationController", ["$scope", "$timeout", AdministrationController]);
