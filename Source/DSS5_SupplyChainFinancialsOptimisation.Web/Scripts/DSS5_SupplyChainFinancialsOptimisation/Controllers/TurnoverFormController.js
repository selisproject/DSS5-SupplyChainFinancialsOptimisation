...
(function (DSS5_SupplyChainFinancialsOptimisation) {
    ...
    (function (Controllers) {
        var TurnoverFormConditionalFormattings = [];
        var TurnoverFormDataValidations = [];
        var TurnoverFormCalculatedExpressions = [];
        // Datasets Column Info
        Controllers.TurnoverStatisticDataSet_ColumnInfo = [new Joove.ColumnInfo("Year", "int", null, false),
        ...
        var TurnoverFormController = (function () {
            function TurnoverFormController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS5_SupplyChainFinancialsOptimisation.ViewModels.TurnoverForm.TurnoverFormViewModel._initializeFrom($scope.model, context);
                };
            ...
            TurnoverFormController.prototype.init = function ($scope, $timeout) {
                var _this = this;
                ...
                $scope.actions = {
                    ...
                    RenderSupplier: function (username, _cb, _modalOptions, _e) { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            Joove.Common.autocompleteFix();
                ...
                $scope.eventCallbacks = {
                    ChartClicked: function (e, DataItem, _parents) {
                        window._recorder.addState(e);
                        if (e != null) {
                            e.stopPropagation();
                            e.preventDefault();
                        }
                        if (_this.timeoutDelayLockChartClicked != null) {
                            $timeout.cancel(_this.timeoutDelayLockChartClicked);
                        }
                        _this.timeoutDelayLockChartClicked = $timeout(function () {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                ...
                                Joove.Core.executeRedirectControllerAction("TurnoverPerMonthForm", "Render", "GET", [Joove.Common.nullSafe(function () { return window["scope_TurnoverForm"].model.Supplier.UserName; }, ""), Joove.Common.nullSafe(function () { return Joove.DatasourceManager.getSelectedItem($("[jb-id='Chart']"), e).Year; }, 0)], null, null, openInNewWindow);
            ...
            return TurnoverFormController;
        }());
        angular.module("Application").controller("TurnoverFormController", ["$scope", "$timeout", TurnoverFormController]);
