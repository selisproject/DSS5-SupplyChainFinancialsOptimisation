...
interface Window { scope_NotFoundPage: DSS5_SupplyChainFinancialsOptimisation.Controllers.INotFoundPageScope; }
...
model:
    DSS5_SupplyChainFinancialsOptimisation.ViewModels.NotFoundPage.NotFoundPageViewModel;
...
class NotFoundPageController {
    ...
    constructor(private $scope: INotFoundPageScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS5_SupplyChainFinancialsOptimisation.ViewModels.NotFoundPage.NotFoundPageViewModel._initializeFrom($scope.model, context);
