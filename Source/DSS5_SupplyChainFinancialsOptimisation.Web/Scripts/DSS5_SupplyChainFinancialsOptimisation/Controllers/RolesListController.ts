...
interface Window { scope_RolesList: DSS5_SupplyChainFinancialsOptimisation.Controllers.IRolesListScope; }
...
model:
    DSS5_SupplyChainFinancialsOptimisation.ViewModels.RolesList.RolesListViewModel;
...
private timeoutDelayLockButtonClicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DSS5_SupplyChainFinancialsOptimisation.ViewModels.RolesList.RolesListViewModel._lightCast(window.scope_RolesList.model);
    ...
    constructor(private $scope: IRolesListScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS5_SupplyChainFinancialsOptimisation.ViewModels.RolesList.RolesListViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IRolesListScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DSS5_SupplyChainFinancialsOptimisation.ViewModels.RolesList.RolesListViewModel._initializeFrom(window.viewDTO.Model);
            ...
            (e, DataItem, _parents) => {
                ...
                this.timeoutDelayLockButtonClicked = $timeout(() => {
                    ...
                    Joove.Validation.Manager.validateFormAndExecute(() => {
                        ...
                        //and occurs when the middle mouse button click is triggered
                        var openInNewWindow = $(e.target).data("openInNewWindow") === true || undefined;
if (openInNewWindow) $(e.target).data("openInNewWindow", undefined); Joove.Core.executeRedirectControllerAction("ManageRole", "EditRole", "GET", [Joove.Common.nullSafe<any>(() => _parents[0].Id, 0)], {}, { mode: 'Slide', width: '50%', height: '50%', onClose: () => { $scope.actions.Refresh(); }});
}, { groups: [], withDataValidationsCheck: false, withRequiredFieldsCheck: false });
                }, 0);
            },
