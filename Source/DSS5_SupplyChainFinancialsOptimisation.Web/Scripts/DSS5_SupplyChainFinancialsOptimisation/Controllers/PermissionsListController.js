...
(function (DSS5_SupplyChainFinancialsOptimisation) {
    ...
    (function (Controllers) {
        ...
        var PermissionsListController = (function () {
            function PermissionsListController($scope, $timeout) {
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS5_SupplyChainFinancialsOptimisation.ViewModels.PermissionsList.PermissionsListViewModel._initializeFrom($scope.model, context);
                };
