...
(function (DSS5_SupplyChainFinancialsOptimisation) {
    ...
    (function (Controllers) {
        var ProofOfDeliveryListConditionalFormattings = [];
        var ProofOfDeliveryListDataValidations = [];
        var ProofOfDeliveryListCalculatedExpressions = [];
        ...
        var ProofOfDeliveryListController = (function () {
            function ProofOfDeliveryListController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS5_SupplyChainFinancialsOptimisation.ViewModels.ProofOfDeliveryList.ProofOfDeliveryListViewModel._initializeFrom($scope.model, context);
                };
            ...
            ProofOfDeliveryListController.prototype.init = function ($scope, $timeout) {
                var _this = this;
                    ...
                    ModifyClicked: function (e, DataItem, _parents) {
                        ...
                        _this.timeoutDelayLockModifyClicked = $timeout(function () {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                ...
                                Joove.Core.executeRedirectControllerAction("ProofOfDeliveryForm", "EditProofOfDelivery", "GET", [Joove.Common.nullSafe(function () { return Joove.DatasourceManager.getSelectedItem($("[jb-id='ProofOfDeliveryListNoDT']"), e).Id; }, 0)], null, null, openInNewWindow);
            ...
            return ProofOfDeliveryListController;
        }());
        angular.module("Application").controller("ProofOfDeliveryListController", ["$scope", "$timeout", ProofOfDeliveryListController]);
