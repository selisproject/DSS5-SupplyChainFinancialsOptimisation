...
interface Window { scope_ManageOperation: DSS5_SupplyChainFinancialsOptimisation.Controllers.IManageOperationScope; }
...
model:
    DSS5_SupplyChainFinancialsOptimisation.ViewModels.ManageOperation.ManageOperationViewModel;
...
private timeoutDelayLockButton4Clicked:
    ...
    constructor(private $scope: IManageOperationScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS5_SupplyChainFinancialsOptimisation.ViewModels.ManageOperation.ManageOperationViewModel._initializeFrom($scope.model, context);
            ...
            (e, DataItem, _parents) => {
                ...
                this.timeoutDelayLockButton2OnChange = $timeout(() => {
                    ...
                    Joove.Validation.Manager.validateFormAndExecute(() => {
                        ...
                        var p_FormControls_ManageOperation_FormControlsDefinition_Button2_PickListControl_SelectedItems_ApplicationPermissionViewModel = Joove.Common.nullSafe<any>(() => Joove.DatasourceManager.getSelectedItems($("[jb-id='Button2']"), e), null);
