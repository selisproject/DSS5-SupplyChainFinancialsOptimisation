...
interface Window { scope_ForgotPassword: DSS5_SupplyChainFinancialsOptimisation.Controllers.IForgotPasswordScope; }
...
condition: async (_parents) => {
        return Joove.Common.nullSafe<any>(() => CLMS.Framework.String.IsNullOrEmpty(Joove.Common.nullSafe(function () {
            return Joove.Common.nullSafe<any>(() => window["scope_ForgotPassword"].model.txtEmail, "").trim();
        }, "")), false);
...
model:
    DSS5_SupplyChainFinancialsOptimisation.ViewModels.ForgotPassword.ForgotPasswordViewModel;
...
private timeoutDelayLockButton11Clicked:
    ...
    private controllerActionFinished = (resetDirty: boolean) => {
        ...
        DSS5_SupplyChainFinancialsOptimisation.ViewModels.ForgotPassword.ForgotPasswordViewModel._lightCast(window.scope_ForgotPassword.model);
    ...
    constructor(private $scope: IForgotPasswordScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS5_SupplyChainFinancialsOptimisation.ViewModels.ForgotPassword.ForgotPasswordViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IForgotPasswordScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.model = DSS5_SupplyChainFinancialsOptimisation.ViewModels.ForgotPassword.ForgotPasswordViewModel._initializeFrom(window.viewDTO.Model);
...
verb: 'POST', controller: 'ForgotPassword', action: 'ResetPassword',
            ...
            (e, DataItem, _parents) => {
                ...
                this.timeoutDelayLockbtnChangePasswordClicked = $timeout(() => {
                    ...
                    Joove.Validation.Manager.validateFormAndExecute(() => {
                        $scope.actions.ResetPassword(null, null, e);
