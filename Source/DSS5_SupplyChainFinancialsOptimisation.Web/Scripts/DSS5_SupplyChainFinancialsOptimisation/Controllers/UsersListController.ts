...
interface Window { scope_UsersList: DSS5_SupplyChainFinancialsOptimisation.Controllers.IUsersListScope; }
...
model:
    DSS5_SupplyChainFinancialsOptimisation.ViewModels.UsersList.UsersListViewModel;
...
private timeoutDelayLockButtonClicked:
    ...
    constructor(private $scope: IUsersListScope, $timeout: ng.ITimeoutService) {
        ...
        $scope.dehydrate = (context = null) => DSS5_SupplyChainFinancialsOptimisation.ViewModels.UsersList.UsersListViewModel._initializeFrom($scope.model, context);
