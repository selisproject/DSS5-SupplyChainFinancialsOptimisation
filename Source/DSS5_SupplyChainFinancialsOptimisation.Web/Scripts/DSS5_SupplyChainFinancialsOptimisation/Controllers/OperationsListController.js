...
(function (DSS5_SupplyChainFinancialsOptimisation) {
    ...
    (function (Controllers) {
        var OperationsListConditionalFormattings = [];
        var OperationsListDataValidations = [];
        var OperationsListCalculatedExpressions = [];
        // Datasets Column Info
        Controllers.List1DataSet_ColumnInfo = [new Joove.ColumnInfo("ParentControllerName", "string", null, false),
        ...
        var OperationsListController = (function () {
            function OperationsListController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS5_SupplyChainFinancialsOptimisation.ViewModels.OperationsList.OperationsListViewModel._initializeFrom($scope.model, context);
                };
            ...
            OperationsListController.prototype.init = function ($scope, $timeout) {
                var _this = this;
                    ...
                    ButtonClicked: function (e, DataItem, _parents) {
                        ...
                        _this.timeoutDelayLockButtonClicked = $timeout(function () {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                ...
                                Joove.Core.executeRedirectControllerAction("ManageOperation", "EditOperation", "GET", [Joove.Common.nullSafe(function () { return _parents[0].Id; }, 0)], {}, { mode: 'Slide', width: '50%', height: '50%', onClose: function () { $scope.actions.Refresh(); } });
            ...
            return OperationsListController;
        }());
        angular.module("Application").controller("OperationsListController", ["$scope", "$timeout", OperationsListController]);
