...
(function (DSS5_SupplyChainFinancialsOptimisation) {
    ...
    (function (Controllers) {
        var InvestorInvoicesListConditionalFormattings = [];
        var InvestorInvoicesListDataValidations = [];
        var InvestorInvoicesListCalculatedExpressions = [];
        ...
        var InvestorInvoicesListController = (function () {
            function InvestorInvoicesListController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS5_SupplyChainFinancialsOptimisation.ViewModels.InvestorInvoicesList.InvestorInvoicesListViewModel._initializeFrom($scope.model, context);
                };
            ...
            InvestorInvoicesListController.prototype.init = function ($scope, $timeout) {
                var _this = this;
                ...
                $scope.eventCallbacks = {
                    ViewInvoiceInvClicked: function (e, DataItem, _parents) {
                        window._recorder.addState(e);
                        if (e != null) {
                            e.stopPropagation();
                            e.preventDefault();
                        }
                        if (_this.timeoutDelayLockViewInvoiceInvClicked != null) {
                            $timeout.cancel(_this.timeoutDelayLockViewInvoiceInvClicked);
                        }
                        _this.timeoutDelayLockViewInvoiceInvClicked = $timeout(function () {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                ...
                                Joove.Core.executeRedirectControllerAction("InvoiceForm", "EditInvoice", "GET", [Joove.Common.nullSafe(function () { return Joove.DatasourceManager.getSelectedItem($("[jb-id='ListNoDT']"), e).Id; }, 0)], null, null, openInNewWindow);
            ...
            return InvestorInvoicesListController;
        }());
        angular.module("Application").controller("InvestorInvoicesListController", ["$scope", "$timeout", InvestorInvoicesListController]);
