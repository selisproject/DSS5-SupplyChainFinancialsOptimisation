...
interface Window { scope_InvestorCommercialAgreementsList: DSS5_SupplyChainFinancialsOptimisation.Controllers.IInvestorCommercialAgreementsListScope; }
namespace DSS5_SupplyChainFinancialsOptimisation.Controllers {
const InvestorCommercialAgreementsListConditionalFormattings = [
        ];
const InvestorCommercialAgreementsListDataValidations = [
        ];
const InvestorCommercialAgreementsListCalculatedExpressions = [
        ];
...
export interface IInvestorCommercialAgreementsListScope extends Joove.IWebPageScope {
model:
    DSS5_SupplyChainFinancialsOptimisation.ViewModels.InvestorCommercialAgreementsList.InvestorCommercialAgreementsListViewModel;
...
class InvestorCommercialAgreementsListController {
private timeoutDelayLockModifyClicked:
    ...
    constructor(private $scope: IInvestorCommercialAgreementsListScope, $timeout: ng.ITimeoutService) {
        window.scope_InvestorCommercialAgreementsList = $scope;
        $scope.$onControlChanged = function (event, newValue, dontMakeDirty) {
            Joove.Core.onChange(event.target, newValue, dontMakeDirty)
        }

        $scope.dehydrate = (context = null) => DSS5_SupplyChainFinancialsOptimisation.ViewModels.InvestorCommercialAgreementsList.InvestorCommercialAgreementsListViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IInvestorCommercialAgreementsListScope, $timeout: ng.ITimeoutService) {
            ...
            (e, DataItem, _parents) => {
                ...
                this.timeoutDelayLockModifyClicked = $timeout(() => {
                    ...
                    Joove.Validation.Manager.validateFormAndExecute(() => {
                        ...
                        if (openInNewWindow) $(e.target).data("openInNewWindow", undefined); Joove.Core.executeRedirectControllerAction("CommercialAgreementForm", "EditCommercialAgreementInvestor", "GET", [Joove.Common.nullSafe<any>(() => Joove.DatasourceManager.getSelectedItem($("[jb-id='CommercialAgreementListNoDT']"), e).Id, 0)], null, null, openInNewWindow);
...
angular.module("Application").controller("InvestorCommercialAgreementsListController", ["$scope", "$timeout", InvestorCommercialAgreementsListController] as Array<string>);
}
