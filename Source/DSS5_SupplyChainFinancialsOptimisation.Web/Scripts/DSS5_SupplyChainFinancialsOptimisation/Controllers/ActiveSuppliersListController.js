...
(function (DSS5_SupplyChainFinancialsOptimisation) {
    ...
    (function (Controllers) {
        var ActiveSuppliersListConditionalFormattings = [];
        var ActiveSuppliersListDataValidations = [];
        var ActiveSuppliersListCalculatedExpressions = [];
        ...
        var ActiveSuppliersListController = (function () {
            function ActiveSuppliersListController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS5_SupplyChainFinancialsOptimisation.ViewModels.ActiveSuppliersList.ActiveSuppliersListViewModel._initializeFrom($scope.model, context);
                };
            ...
            ActiveSuppliersListController.prototype.init = function ($scope, $timeout) {
                var _this = this;
            ...
            return ActiveSuppliersListController;
        }());
        angular.module("Application").controller("ActiveSuppliersListController", ["$scope", "$timeout", ActiveSuppliersListController]);
