...
interface Window { scope_AdminProofOfDeliveryList: DSS5_SupplyChainFinancialsOptimisation.Controllers.IAdminProofOfDeliveryListScope; }
namespace DSS5_SupplyChainFinancialsOptimisation.Controllers {
const AdminProofOfDeliveryListConditionalFormattings = [
        ];
const AdminProofOfDeliveryListDataValidations = [
        ];
const AdminProofOfDeliveryListCalculatedExpressions = [
        ];
...
export interface IAdminProofOfDeliveryListScope extends Joove.IWebPageScope {
model:
    DSS5_SupplyChainFinancialsOptimisation.ViewModels.AdminProofOfDeliveryList.AdminProofOfDeliveryListViewModel;
...
class AdminProofOfDeliveryListController {
private timeoutDelayLockModifyClicked:
    any;


    private controllerActionFinished = (resetDirty: boolean) => {
        //window.scope_AdminProofOfDeliveryList.model = window.scope_AdminProofOfDeliveryList.dehydrate();
        //window.scope_MasterPageForLists.model = window.scope_AdminProofOfDeliveryList.model;
        DSS5_SupplyChainFinancialsOptimisation.ViewModels.AdminProofOfDeliveryList.AdminProofOfDeliveryListViewModel._lightCast(window.scope_AdminProofOfDeliveryList.model);
        // Joove.Common.applyScope(window.scope_AdminProofOfDeliveryList);
        if (resetDirty) {
    ...
    constructor(private $scope: IAdminProofOfDeliveryListScope, $timeout: ng.ITimeoutService) {
        window.scope_AdminProofOfDeliveryList = $scope;
        $scope.$onControlChanged = function (event, newValue, dontMakeDirty) {
            Joove.Core.onChange(event.target, newValue, dontMakeDirty)
        }

        $scope.dehydrate = (context = null) => DSS5_SupplyChainFinancialsOptimisation.ViewModels.AdminProofOfDeliveryList.AdminProofOfDeliveryListViewModel._initializeFrom($scope.model, context);
    ...
    init($scope: IAdminProofOfDeliveryListScope, $timeout: ng.ITimeoutService) {


        $scope.model = DSS5_SupplyChainFinancialsOptimisation.ViewModels.AdminProofOfDeliveryList.AdminProofOfDeliveryListViewModel._initializeFrom(window.viewDTO.Model);
...
Retrieve:
            async (_cb, _modalOptions, _e) => {
                ...
                Joove.Core.executeRedirectControllerAction("AdminProofOfDeliveryList", "Retrieve", "GET", [], {}, _modalOptions);
            },
DeleteSeclected:
            async (_cb, _modalOptions, _e) => {
                Joove.Common.autocompleteFix();
...
verb: 'POST', controller: 'AdminProofOfDeliveryList', action: 'DeleteSeclected',
...
// Rules
        window._ruleEngine.addDataValidations(AdminProofOfDeliveryListDataValidations);
        window._ruleEngine.addConditionalFormattings(AdminProofOfDeliveryListConditionalFormattings);
        window._ruleEngine.addCalculatedExpressions(AdminProofOfDeliveryListCalculatedExpressions);
...
angular.module("Application").controller("AdminProofOfDeliveryListController", ["$scope", "$timeout", AdminProofOfDeliveryListController] as Array<string>);
}
