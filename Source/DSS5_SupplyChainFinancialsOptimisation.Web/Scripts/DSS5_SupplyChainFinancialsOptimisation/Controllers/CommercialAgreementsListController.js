...
(function (DSS5_SupplyChainFinancialsOptimisation) {
    ...
    (function (Controllers) {
        var CommercialAgreementsListConditionalFormattings = [];
        var CommercialAgreementsListDataValidations = [];
        var CommercialAgreementsListCalculatedExpressions = [];
        ...
        var CommercialAgreementsListController = (function () {
            function CommercialAgreementsListController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS5_SupplyChainFinancialsOptimisation.ViewModels.CommercialAgreementsList.CommercialAgreementsListViewModel._initializeFrom($scope.model, context);
                };
            ...
            CommercialAgreementsListController.prototype.init = function ($scope, $timeout) {
                var _this = this;
                    ...
                    AddNewClicked: function (e, DataItem, _parents) {
                        ...
                        _this.timeoutDelayLockAddNewClicked = $timeout(function () {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                ...
                                Joove.Core.executeRedirectControllerAction("CommercialAgreementForm", "AddCommercialAgreement", "GET", [], null, null, openInNewWindow);
                    ...
                    ModifyClicked: function (e, DataItem, _parents) {
                        ...
                        _this.timeoutDelayLockModifyClicked = $timeout(function () {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                ...
                                if (openInNewWindow)
                                    $(e.target).data("openInNewWindow", undefined);
                                Joove.Core.executeRedirectControllerAction("CommercialAgreementForm", "EditCommercialAgreement", "GET", [Joove.Common.nullSafe(function () { return Joove.DatasourceManager.getSelectedItem($("[jb-id='CommercialAgreementListNoDT']"), e).Id; }, 0)], null, null, openInNewWindow);
                            }, { groups: [], withDataValidationsCheck: false, withRequiredFieldsCheck: false });
                        }, 0);
                    },
            ...
            return CommercialAgreementsListController;
        }());
        angular.module("Application").controller("CommercialAgreementsListController", ["$scope", "$timeout", CommercialAgreementsListController]);
