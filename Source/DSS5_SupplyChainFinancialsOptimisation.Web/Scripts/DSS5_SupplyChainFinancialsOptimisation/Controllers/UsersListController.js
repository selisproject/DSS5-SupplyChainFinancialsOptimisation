...
(function (DSS5_SupplyChainFinancialsOptimisation) {
    ...
    (function (Controllers) {
        ...
        Controllers.List1DataSet_ColumnInfo = [new Joove.ColumnInfo("UserName", "string", null, false),
        ...
        var UsersListController = (function () {
            function UsersListController($scope, $timeout) {
                ...
                this.controllerActionFinished = function (resetDirty) {
                    ...
                    DSS5_SupplyChainFinancialsOptimisation.ViewModels.UsersList.UsersListViewModel._lightCast(window.scope_UsersList.model);
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS5_SupplyChainFinancialsOptimisation.ViewModels.UsersList.UsersListViewModel._initializeFrom($scope.model, context);
                };
            ...
            UsersListController.prototype.init = function ($scope, $timeout) {
                var _this = this;
                $scope.model = DSS5_SupplyChainFinancialsOptimisation.ViewModels.UsersList.UsersListViewModel._initializeFrom(window.viewDTO.Model);
                    ...
                    ButtonClicked: function (e, DataItem, _parents) {
                        ...
                        _this.timeoutDelayLockButtonClicked = $timeout(function () {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                ...
                                if (openInNewWindow)
                                    $(e.target).data("openInNewWindow", undefined);
                                Joove.Core.executeRedirectControllerAction("ManageUser", "EditUser", "GET", [Joove.Common.nullSafe(function () { return _parents[0].UserName; }, "")], {}, { mode: 'Slide', width: '50%', height: '50%', onClose: function () { $scope.actions.Refresh(); } });
                            }, { groups: [], withDataValidationsCheck: false, withRequiredFieldsCheck: false });
                        }, 0);
                    }
                };
