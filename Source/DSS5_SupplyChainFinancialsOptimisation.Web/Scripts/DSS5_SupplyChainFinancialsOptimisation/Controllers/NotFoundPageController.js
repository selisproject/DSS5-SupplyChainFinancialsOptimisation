...
(function (DSS5_SupplyChainFinancialsOptimisation) {
    ...
    (function (Controllers) {
        var NotFoundPageConditionalFormattings = [];
        var NotFoundPageDataValidations = [];
        var NotFoundPageCalculatedExpressions = [];
        var NotFoundPageController = (function () {
            function NotFoundPageController($scope, $timeout) {
                this.$scope = $scope;
                this.controllerActionFinished = function (resetDirty) {
                    //window.scope_NotFoundPage.model = window.scope_NotFoundPage.dehydrate();
                    //window.scope_MasterPage.model = window.scope_NotFoundPage.model;
                    DSS5_SupplyChainFinancialsOptimisation.ViewModels.NotFoundPage.NotFoundPageViewModel._lightCast(window.scope_NotFoundPage.model);
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS5_SupplyChainFinancialsOptimisation.ViewModels.NotFoundPage.NotFoundPageViewModel._initializeFrom($scope.model, context);
                };
            ...
            NotFoundPageController.prototype.init = function ($scope, $timeout) {
                var _this = this;
                $scope.model = DSS5_SupplyChainFinancialsOptimisation.ViewModels.NotFoundPage.NotFoundPageViewModel._initializeFrom(window.viewDTO.Model);
        ...
        angular.module("Application").controller("NotFoundPageController", ["$scope", "$timeout", NotFoundPageController]);
