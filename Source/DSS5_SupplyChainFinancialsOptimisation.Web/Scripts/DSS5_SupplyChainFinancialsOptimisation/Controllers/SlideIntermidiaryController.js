...
(function (DSS5_SupplyChainFinancialsOptimisation) {
    ...
    (function (Controllers) {
        var _this = this;
        var SlideIntermidiaryConditionalFormattings = [
            new Joove.JbRule({
                ...
                condition: function (_parents) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, Joove.Common.nullSafe(function () { return window["scope_SlideIntermidiary"].model.ChosenIntermediaryType; }, "") == "Other"];
                    });
                }); },
        ...
        var SlideIntermidiaryDataValidations = [];
        var SlideIntermidiaryCalculatedExpressions = [];
        ...
        Controllers.IntermediaryTypes_ColumnInfo = [new Joove.ColumnInfo("Value", "string", null, true)];
        window["IntermediaryTypes_ColumnInfo"] = Controllers.IntermediaryTypes_ColumnInfo;
        var SlideIntermidiaryController = (function () {
            function SlideIntermidiaryController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS5_SupplyChainFinancialsOptimisation.ViewModels.SlideIntermidiary.SlideIntermidiaryViewModel._initializeFrom($scope.model, context);
                };
            ...
            SlideIntermidiaryController.prototype.init = function ($scope, $timeout) {
                var _this = this;
            ...
            return SlideIntermidiaryController;
        }());
        angular.module("Application").controller("SlideIntermidiaryController", ["$scope", "$timeout", SlideIntermidiaryController]);
