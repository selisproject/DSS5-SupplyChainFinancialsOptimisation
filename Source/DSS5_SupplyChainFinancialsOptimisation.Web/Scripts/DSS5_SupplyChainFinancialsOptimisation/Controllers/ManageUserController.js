        ...
        var ManageUserController = (function () {
            function ManageUserController($scope, $timeout) {
                ...
                this.controllerActionFinished = function (resetDirty) {
                    ...
                    DSS5_SupplyChainFinancialsOptimisation.ViewModels.ManageUser.ManageUserViewModel._lightCast(window.scope_ManageUser.model);
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS5_SupplyChainFinancialsOptimisation.ViewModels.ManageUser.ManageUserViewModel._initializeFrom($scope.model, context);
                };
            ...
            ManageUserController.prototype.init = function ($scope, $timeout) {
                var _this = this;
                $scope.model = DSS5_SupplyChainFinancialsOptimisation.ViewModels.ManageUser.ManageUserViewModel._initializeFrom(window.viewDTO.Model);
                ...
                $scope.actions = {
                    ...
                    Button1Changed: function (DataItems, byUser, _cb, _modalOptions, _e) { return __awaiter(_this, void 0, void 0, function () {
                        var _this = this;
                    ...
                    Button2Changed: function (DataItems, byUser, _cb, _modalOptions, _e) { return __awaiter(_this, void 0, void 0, function () {
                        var _this = this;
                        var implementation, spamHelper;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                ...
                $scope.eventCallbacks = {
                    Button1OnChange: function (e, DataItem, _parents) {
                        window._recorder.addState(e);
                        if (_this.timeoutDelayLockButton1OnChange != null) {
                            $timeout.cancel(_this.timeoutDelayLockButton1OnChange);
                        }
                        _this.timeoutDelayLockButton1OnChange = $timeout(function () {
                            if (e.target) {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                var p_FormControls_ManageUser_FormControlsDefinition_Button1_PickListControl_SelectedItems_ApplicationPermissionViewModel = Joove.Common.nullSafe(function () { return Joove.DatasourceManager.getSelectedItems($("[jb-id='Button1']"), e); }, null);
                                if (eval("DSS5_SupplyChainFinancialsOptimisation.ViewModels.ManageUser.FormControls_ManageUser_FormControlsDefinition_Button1_PickListControl_SelectedItems_ApplicationPermissionViewModel") != null && eval("DSS5_SupplyChainFinancialsOptimisation.ViewModels.ManageUser.FormControls_ManageUser_FormControlsDefinition_Button1_PickListControl_SelectedItems_ApplicationPermissionViewModel._initializeFrom") != null) {
                                    ...
                                    for (var _i = 0; _i < _initial.length; _i++) {
                                        var _temp = eval("DSS5_SupplyChainFinancialsOptimisation.ViewModels.ManageUser.FormControls_ManageUser_FormControlsDefinition_Button1_PickListControl_SelectedItems_ApplicationPermissionViewModel._initializeFrom(_initial[_i])");
                    ...
                    Button2OnChange: function (e, DataItem, _parents) {
                        window._recorder.addState(e);
                        if (_this.timeoutDelayLockButton2OnChange != null) {
                            $timeout.cancel(_this.timeoutDelayLockButton2OnChange);
                        }
                        _this.timeoutDelayLockButton2OnChange = $timeout(function () {
                            if (e.target) {
                                Joove.Core.onChange(e.target, null, false);
                            }
                            else {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                var p_FormControls_ManageUser_FormControlsDefinition_Button2_PickListControl_SelectedItems_ApplicationRoleViewModel = Joove.Common.nullSafe(function () { return Joove.DatasourceManager.getSelectedItems($("[jb-id='Button2']"), e); }, null);
                                if (eval("DSS5_SupplyChainFinancialsOptimisation.ViewModels.ManageUser.FormControls_ManageUser_FormControlsDefinition_Button2_PickListControl_SelectedItems_ApplicationRoleViewModel") != null && eval("DSS5_SupplyChainFinancialsOptimisation.ViewModels.ManageUser.FormControls_ManageUser_FormControlsDefinition_Button2_PickListControl_SelectedItems_ApplicationRoleViewModel._initializeFrom") != null) {
                                    ...
                                    for (var _i = 0; _i < _initial.length; _i++) {
                                        var _temp = eval("DSS5_SupplyChainFinancialsOptimisation.ViewModels.ManageUser.FormControls_ManageUser_FormControlsDefinition_Button2_PickListControl_SelectedItems_ApplicationRoleViewModel._initializeFrom(_initial[_i])");
                    ...
                    SaveBtnClicked: function (e, DataItem, _parents) {
                        ...
                        _this.timeoutDelayLockSaveBtnClicked = $timeout(function () {
                            ...
                            window._popUpManager.question(window._resourcesManager.getGlobalResource("RES_WEBFORM_GenericConfirmationQuestion"), window._resourcesManager.getEventConfirmation("SaveBtn", false), function (isConfirm) {
                                if (!isConfirm)
                                    return;
                                setTimeout(function () {
                                    Joove.Validation.Manager.validateFormAndExecute(function () {
