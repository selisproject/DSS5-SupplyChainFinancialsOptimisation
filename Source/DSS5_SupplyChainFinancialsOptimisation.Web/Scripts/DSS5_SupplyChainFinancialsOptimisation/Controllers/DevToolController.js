...
(function (DSS5_SupplyChainFinancialsOptimisation) {
    ...
    (function (Controllers) {
        var DevToolConditionalFormattings = [];
        var DevToolDataValidations = [];
        var DevToolCalculatedExpressions = [];
        // Datasets Column Info
        // Datasets Projection Shemas
        window["FileAttachment_ProjectionScema"] = { rayPath: {}
        };
        var DevToolController = (function () {
            function DevToolController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS5_SupplyChainFinancialsOptimisation.ViewModels.DevTool.DevToolViewModel._initializeFrom($scope.model, context);
                };
            ...
            DevToolController.prototype.init = function ($scope, $timeout) {
                var _this = this;
                ...
                // Controller actions
                $scope.actions = {
                    ImportRAYMETRICSCSV: function (_cb, _modalOptions, _e) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return DevToolController;
        }());
        angular.module("Application").controller("DevToolController", ["$scope", "$timeout", DevToolController]);
