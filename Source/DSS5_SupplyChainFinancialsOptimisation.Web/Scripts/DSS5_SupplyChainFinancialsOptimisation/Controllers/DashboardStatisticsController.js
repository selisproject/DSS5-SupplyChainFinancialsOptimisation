...
(function (DSS5_SupplyChainFinancialsOptimisation) {
    ...
    (function (Controllers) {
        var DashboardStatisticsConditionalFormattings = [];
        var DashboardStatisticsDataValidations = [];
        var DashboardStatisticsCalculatedExpressions = [];
        // Datasets Column Info
        Controllers.SupplierStatisticDataSet_ColumnInfo = [new Joove.ColumnInfo("Supplier.Company", "string", null, false),
            new Joove.ColumnInfo("DataAvailability", "int", null, false),
            new Joove.ColumnInfo("Supplier.UserName", "string", null, false)];
        window["SupplierStatisticDataSet_ColumnInfo"] = Controllers.SupplierStatisticDataSet_ColumnInfo;
        Controllers.SupplierStatisticDataSetOnTime_ColumnInfo = [new Joove.ColumnInfo("Supplier.Company", "string", null, false),
        ...
        window["SupplierStatisticDataSetOnTime_ColumnInfo"] = Controllers.SupplierStatisticDataSetOnTime_ColumnInfo;
        ...
        var DashboardStatisticsController = (function () {
            function DashboardStatisticsController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS5_SupplyChainFinancialsOptimisation.ViewModels.DashboardStatistics.DashboardStatisticsViewModel._initializeFrom($scope.model, context);
                };
            ...
            DashboardStatisticsController.prototype.init = function ($scope, $timeout) {
                var _this = this;
                ...
                $scope.events = {};
                $scope.expressions = {
                    ChartDataAvailability1XScaleMin: function () { return 0; },
                    ChartDataAvailability1XScaleMax: function () { return 7; },
                    ChartDataAvailability1YScaleMin: function () { return 0; },
                    ChartDataAvailability1YScaleMax: function () { return 7; },
                    ChartDataAvailabilityXScaleMin: function () { return 0; },
                    ChartDataAvailabilityXScaleMax: function () { return 7; },
                    ChartDataAvailabilityYScaleMin: function () { return 0; },
                    ChartDataAvailabilityYScaleMax: function () { return 7; },
                    ChartYScaleMin: function () { return 0; },
                    ChartYScaleMax: function () { return 10; },
                    ChartYScaleStepSize: function () { return 1; }
                };
                // Dataset Handler
                $scope.datasets = {};
                // Controller actions
                ...
                $scope.eventCallbacks = {
                    ButtonClicked: function (e, DataItem, _parents) {
                        ...
                        _this.timeoutDelayLockButtonClicked = $timeout(function () {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                ...
                                Joove.Core.executeRedirectControllerAction("PopUpChart", "Render", "GET", [], {}, { mode: 'PopUp', width: '50%', height: '50%', onClose: function () { $scope.actions.CloseModal(); } });
                            }, { groups: [], withDataValidationsCheck: false, withRequiredFieldsCheck: false });
                        }, 0);
                    },
                    ChartDataAvailability1Clicked: function (e, DataItem, _parents) {
                        window._recorder.addState(e);
                        if (e != null) {
                            e.stopPropagation();
                            e.preventDefault();
                        }
                        if (_this.timeoutDelayLockChartDataAvailability1Clicked != null) {
                            $timeout.cancel(_this.timeoutDelayLockChartDataAvailability1Clicked);
                        }
                        _this.timeoutDelayLockChartDataAvailability1Clicked = $timeout(function () {
                            Joove.Common.setControlKeyPressed(e, 0);
                            Joove.Common.setLastClickedElement(e);
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                //This is true only when the menu item is clicked programmatically
                                ...
                                if (openInNewWindow)
                                    $(e.target).data("openInNewWindow", undefined);
                                Joove.Core.executeRedirectControllerAction("SupplierForm", "EditSupplier_", "GET", [Joove.Common.nullSafe(function () { return Joove.DatasourceManager.getSelectedItem($("[jb-id='ChartDataAvailability']"), e).Supplier.UserName; }, "")], null, null, openInNewWindow);
                            }, { groups: [], withDataValidationsCheck: false, withRequiredFieldsCheck: false });
                        }, 0);
                    },
                    Button1Clicked: function (e, DataItem, _parents) {
                        ...
                        _this.timeoutDelayLockButton1Clicked = $timeout(function () {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                ...
                                if (openInNewWindow)
                                    $(e.target).data("openInNewWindow", undefined);
                                Joove.Core.executeRedirectControllerAction("PopUpDataAvailability", "Render", "GET", [], {}, { mode: 'PopUp', width: '50%', height: '50%', onClose: function () { $scope.actions.CloseModal(); } });
                            }, { groups: [], withDataValidationsCheck: false, withRequiredFieldsCheck: false });
                        }, 0);
                    },
                    ChartDataAvailabilityClicked: function (e, DataItem, _parents) {
                        window._recorder.addState(e);
                        if (e != null) {
                            e.stopPropagation();
                            e.preventDefault();
                        }
                        if (_this.timeoutDelayLockChartDataAvailabilityClicked != null) {
                            $timeout.cancel(_this.timeoutDelayLockChartDataAvailabilityClicked);
                        }
                        _this.timeoutDelayLockChartDataAvailabilityClicked = $timeout(function () {
                            Joove.Common.setControlKeyPressed(e, 0);
                            Joove.Common.setLastClickedElement(e);
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                //This is true only when the menu item is clicked programmatically
                    ...
                    ChartTurnoverClicked: function (e, DataItem, _parents) {
                        window._recorder.addState(e);
                        if (e != null) {
                            e.stopPropagation();
                            e.preventDefault();
                        }
                        if (_this.timeoutDelayLockChartTurnoverClicked != null) {
                            $timeout.cancel(_this.timeoutDelayLockChartTurnoverClicked);
                        }
                        _this.timeoutDelayLockChartTurnoverClicked = $timeout(function () {
                            Joove.Common.setControlKeyPressed(e, 0);
                            Joove.Common.setLastClickedElement(e);
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                //This is true only when the menu item is clicked programmatically
                                ...
                                if (openInNewWindow)
                                    $(e.target).data("openInNewWindow", undefined);
                                Joove.Core.executeRedirectControllerAction("TurnoverForm", "RenderSupplier", "GET", [Joove.Common.nullSafe(function () { return Joove.DatasourceManager.getSelectedItem($("[jb-id='ChartTurnover']"), e).Supplier.UserName; }, "")], null, null, openInNewWindow);
                            }, { groups: [], withDataValidationsCheck: false, withRequiredFieldsCheck: false });
                        }, 0);
                    }
                };
            ...
            return DashboardStatisticsController;
        }());
        angular.module("Application").controller("DashboardStatisticsController", ["$scope", "$timeout", DashboardStatisticsController]);
