...
(function (DSS5_SupplyChainFinancialsOptimisation) {
    ...
    (function (Controllers) {
        var _this = this;
        var TestingFormConditionalFormattings = [
            new Joove.JbRule({
                ...
                condition: function (_parents) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, Joove.Common.nullSafe(function () { return window["scope_TestingForm"].model.Step1To2; }, false)];
                    });
                }); },
            ...
            new Joove.JbRule({
                ...
                condition: function (_parents) { return __awaiter(_this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, Joove.Common.nullSafe(function () { return window["scope_TestingForm"].model.Step1; }, false)];
                    });
                }); },
                evaluationTimes: [Joove.EvaluationTimes.OnLoad, Joove.EvaluationTimes.OnSubmit, Joove.EvaluationTimes.OnChange],
                isRelatedToDataValidation: false
        ...
        var TestingFormDataValidations = [];
        var TestingFormCalculatedExpressions = [];
        // Datasets Column Info
        Controllers.AgreementDataSet_ColumnInfo = [new Joove.ColumnInfo("CurrentAgreementStatus", "string", null, false),
        ...
        window["AgreementDataSet_ColumnInfo"] = Controllers.AgreementDataSet_ColumnInfo;
        // Datasets Projection Shemas
        window["Calendar_ProjectionScema"] = {};
        window["Chart_ProjectionScema"] = {};
        window["Chart1_ProjectionScema"] = {};
        var TestingFormController = (function () {
            function TestingFormController($scope, $timeout) {
                this.$scope = $scope;
                ...
                $scope.dehydrate = function (context) {
                    ...
                    return DSS5_SupplyChainFinancialsOptimisation.ViewModels.TestingForm.TestingFormViewModel._initializeFrom($scope.model, context);
                };
            ...
            TestingFormController.prototype.init = function ($scope, $timeout) {
                var _this = this;
                ...
                $scope.actions = {
                    ...
                    testing: function (_cb, _modalOptions, _e) { return __awaiter(_this, void 0, void 0, function () {
                        var _this = this;
                ...
                $scope.eventCallbacks = {
                    CalendarClicked: function (e, DataItem, _parents) {
                        window._recorder.addState(e);
                        if (e != null) {
                            e.stopPropagation();
                            e.preventDefault();
                        }
                        if (_this.timeoutDelayLockCalendarClicked != null) {
                            $timeout.cancel(_this.timeoutDelayLockCalendarClicked);
                        }
                        _this.timeoutDelayLockCalendarClicked = $timeout(function () {
                            ...
                            Joove.Validation.Manager.validateFormAndExecute(function () {
                                ...
                                Joove.Core.executeRedirectControllerAction("AgreementForm", "EditAgreement", "GET", [Joove.Common.nullSafe(function () { return Joove.DatasourceManager.getSelectedItem($("[jb-id='Calendar']"), e).Id; }, 0)], null, null, openInNewWindow);
            ...
            return TestingFormController;
        }());
        angular.module("Application").controller("TestingFormController", ["$scope", "$timeout", TestingFormController]);
