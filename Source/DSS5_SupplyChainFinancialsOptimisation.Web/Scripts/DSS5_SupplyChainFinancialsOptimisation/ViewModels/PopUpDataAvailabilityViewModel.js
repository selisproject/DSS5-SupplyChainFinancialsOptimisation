...
(function (DSS5_SupplyChainFinancialsOptimisation) {
    var ViewModels;
    (function (ViewModels) {
        var PopUpDataAvailability;
        (function (PopUpDataAvailability) {
            var PopUpDataAvailabilityViewModel = (function (_super) {
                __extends(PopUpDataAvailabilityViewModel, _super);
                function PopUpDataAvailabilityViewModel() {
                ...
                PopUpDataAvailabilityViewModel._lightCast = function (instance) {
                    if (instance == null)
                        return;
                    return instance;
                };
                PopUpDataAvailabilityViewModel._initializeFrom = function (original, ignoreReadOnlyProperties, context) {
                    ...
                    // }
                    var result = new PopUpDataAvailabilityViewModel();
                ...
                PopUpDataAvailabilityViewModel.prototype._hydratePopUpDataAvailabilityViewModel = function (original, ignoreReadOnlyProperties, context) {
                    if (context === void 0) { context = new Joove.DTOHelper(); }
                    if (original == null)
                        return;
                ...
                PopUpDataAvailabilityViewModel.prototype._reduceData = function (ignoreReadOnlyProperties) {
                    var reduced = PopUpDataAvailabilityViewModel._initializeFrom(this, ignoreReadOnlyProperties);
                    PopUpDataAvailabilityViewModel._deleteDropDownInitialValues(reduced);
                    return reduced;
                };
                PopUpDataAvailabilityViewModel._deleteDropDownInitialValues = function (reduced) {
                    if (reduced == null)
                        return;
                ...
                PopUpDataAvailabilityViewModel.prototype.hasMember = function (propertyName) {
                ...
                return PopUpDataAvailabilityViewModel;
            }(DSS5_SupplyChainFinancialsOptimisation.ViewModels.MasterPageForSlide.MasterPageForSlideViewModel));
            PopUpDataAvailability.PopUpDataAvailabilityViewModel = PopUpDataAvailabilityViewModel;
        })(PopUpDataAvailability = ViewModels.PopUpDataAvailability || (ViewModels.PopUpDataAvailability = {}));
