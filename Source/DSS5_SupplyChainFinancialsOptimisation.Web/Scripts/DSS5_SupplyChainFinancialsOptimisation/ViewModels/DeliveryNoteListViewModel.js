...
(function (DSS5_SupplyChainFinancialsOptimisation) {
    ...
    (function (ViewModels) {
        ...
        (function (DeliveryNoteList) {
            var DeliveryNoteListViewModel = (function (_super) {
                __extends(DeliveryNoteListViewModel, _super);
                function DeliveryNoteListViewModel() {
                ...
                DeliveryNoteListViewModel._lightCast = function (instance) {
                    if (instance == null)
                        return;
                    return instance;
                };
                DeliveryNoteListViewModel._initializeFrom = function (original, ignoreReadOnlyProperties, context) {
                    ...
                    // }
                    var result = new DeliveryNoteListViewModel();
                    if (context != null && context.fillDb == true) {
                        context.addToDb(original);
                    }
                    result._hydrateDeliveryNoteListViewModel(original, ignoreReadOnlyProperties, context);
                    // context.Add(original, result);
                    return result;
                };
                DeliveryNoteListViewModel.prototype._hydrateDeliveryNoteListViewModel = function (original, ignoreReadOnlyProperties, context) {
                    if (context === void 0) { context = new Joove.DTOHelper(); }
                    if (original == null)
                        return;
                    ...
                    this._reduceData = function (ignoreReadOnlyProperties) {
                        var reduced = DeliveryNoteListViewModel._initializeFrom(this, ignoreReadOnlyProperties);
                        DeliveryNoteListViewModel._deleteDropDownInitialValues(reduced);
                        return reduced;
                    };
                }; /* end _initializeFrom() */
                DeliveryNoteListViewModel.prototype._reduceData = function (ignoreReadOnlyProperties) {
                    var reduced = DeliveryNoteListViewModel._initializeFrom(this, ignoreReadOnlyProperties);
                    DeliveryNoteListViewModel._deleteDropDownInitialValues(reduced);
                    return reduced;
                };
                DeliveryNoteListViewModel._deleteDropDownInitialValues = function (reduced) {
                    if (reduced == null)
                        return;
                ...
                DeliveryNoteListViewModel.prototype.hasMember = function (propertyName) {
                ...
                return DeliveryNoteListViewModel;
            }(DSS5_SupplyChainFinancialsOptimisation.ViewModels.MasterPageForLists.MasterPageForListsViewModel));
            DeliveryNoteList.DeliveryNoteListViewModel = DeliveryNoteListViewModel;
        })(DeliveryNoteList = ViewModels.DeliveryNoteList || (ViewModels.DeliveryNoteList = {}));
