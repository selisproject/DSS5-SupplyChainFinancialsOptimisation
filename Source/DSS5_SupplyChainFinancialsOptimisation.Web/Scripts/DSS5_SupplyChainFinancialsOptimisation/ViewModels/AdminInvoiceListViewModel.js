...
(function (DSS5_SupplyChainFinancialsOptimisation) {
    var ViewModels;
    (function (ViewModels) {
        var AdminInvoiceList;
        (function (AdminInvoiceList) {
            var AdminInvoiceListViewModel = (function (_super) {
                __extends(AdminInvoiceListViewModel, _super);
                function AdminInvoiceListViewModel() {
                ...
                AdminInvoiceListViewModel._lightCast = function (instance) {
                    if (instance == null)
                        return;
                    return instance;
                };
                AdminInvoiceListViewModel._initializeFrom = function (original, ignoreReadOnlyProperties, context) {
                    ...
                    // }
                    var result = new AdminInvoiceListViewModel();
                ...
                AdminInvoiceListViewModel.prototype._hydrateAdminInvoiceListViewModel = function (original, ignoreReadOnlyProperties, context) {
                    if (context === void 0) { context = new Joove.DTOHelper(); }
                    if (original == null)
                        return;
                ...
                AdminInvoiceListViewModel.prototype._reduceData = function (ignoreReadOnlyProperties) {
                    var reduced = AdminInvoiceListViewModel._initializeFrom(this, ignoreReadOnlyProperties);
                    AdminInvoiceListViewModel._deleteDropDownInitialValues(reduced);
                    return reduced;
                };
                AdminInvoiceListViewModel._deleteDropDownInitialValues = function (reduced) {
                    if (reduced == null)
                        return;
                ...
                AdminInvoiceListViewModel.prototype.hasMember = function (propertyName) {
                ...
                return AdminInvoiceListViewModel;
            }(DSS5_SupplyChainFinancialsOptimisation.ViewModels.MasterPageForLists.MasterPageForListsViewModel));
            AdminInvoiceList.AdminInvoiceListViewModel = AdminInvoiceListViewModel;
        })(AdminInvoiceList = ViewModels.AdminInvoiceList || (ViewModels.AdminInvoiceList = {}));
