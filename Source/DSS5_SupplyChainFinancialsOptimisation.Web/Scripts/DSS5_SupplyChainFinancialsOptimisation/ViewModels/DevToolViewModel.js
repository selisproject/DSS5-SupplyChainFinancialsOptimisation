...
(function (DSS5_SupplyChainFinancialsOptimisation) {
    ...
    (function (ViewModels) {
        var DevTool;
        (function (DevTool) {
            var DevToolViewModel = (function (_super) {
                __extends(DevToolViewModel, _super);
                function DevToolViewModel() {
                    ...
                    if (_this._members == null) {
                        ...
                        _this._members["rayPath"] = true;
                    }
                    return _this;
                }
                DevToolViewModel._lightCast = function (instance) {
                    if (instance == null)
                        return;
                    return instance;
                };
                DevToolViewModel._initializeFrom = function (original, ignoreReadOnlyProperties, context) {
                    ...
                    // }
                    var result = new DevToolViewModel();
                ...
                DevToolViewModel.prototype._hydrateDevToolViewModel = function (original, ignoreReadOnlyProperties, context) {
                    if (context === void 0) { context = new Joove.DTOHelper(); }
                    if (original == null)
                        return;
                    ...
                    if (original.rayPath !== undefined)
                        this.rayPath = original.rayPath;
                ...
                DevToolViewModel.prototype._reduceData = function (ignoreReadOnlyProperties) {
                    var reduced = DevToolViewModel._initializeFrom(this, ignoreReadOnlyProperties);
                    DevToolViewModel._deleteDropDownInitialValues(reduced);
                    return reduced;
                };
                DevToolViewModel._deleteDropDownInitialValues = function (reduced) {
                    if (reduced == null)
                        return;
                    DSS5_SupplyChainFinancialsOptimisation.ViewModels.MasterPage.MasterPageViewModel._deleteDropDownInitialValues(reduced);
                };
                DevToolViewModel.prototype.hasMember = function (propertyName) {
                ...
                return DevToolViewModel;
            }(DSS5_SupplyChainFinancialsOptimisation.ViewModels.MasterPage.MasterPageViewModel));
            DevTool.DevToolViewModel = DevToolViewModel;
        })(DevTool = ViewModels.DevTool || (ViewModels.DevTool = {}));
