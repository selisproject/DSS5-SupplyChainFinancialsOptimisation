...
namespace DSS5_SupplyChainFinancialsOptimisation.ViewModels.Dashboard {
export class DashboardViewModel extends DSS5_SupplyChainFinancialsOptimisation.ViewModels.MasterPage.MasterPageViewModel {
    public constructor() {
        super();
