...
namespace DSS5_SupplyChainFinancialsOptimisation.ViewModels.ManagePermission {
export class ManagePermissionViewModel extends DSS5_SupplyChainFinancialsOptimisation.ViewModels.MasterPageForSlide.MasterPageForSlideViewModel {
    public constructor() {
        super();
