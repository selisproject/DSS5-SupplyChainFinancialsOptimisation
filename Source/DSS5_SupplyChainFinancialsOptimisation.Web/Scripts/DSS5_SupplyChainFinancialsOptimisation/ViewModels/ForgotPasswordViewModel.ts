...
namespace DSS5_SupplyChainFinancialsOptimisation.ViewModels.ForgotPassword {
export class ForgotPasswordViewModel extends DSS5_SupplyChainFinancialsOptimisation.ViewModels.MasterPage.MasterPageViewModel {
    public constructor() {
        super();
...
var result:
    ...
    public _hydrateForgotPasswordViewModel(original: ForgotPasswordViewModel, ignoreReadOnlyProperties: boolean, context = new Joove.DTOHelper()): void {
        ...
        if(original.txtEmail !== undefined) this.txtEmail = original.txtEmail;
