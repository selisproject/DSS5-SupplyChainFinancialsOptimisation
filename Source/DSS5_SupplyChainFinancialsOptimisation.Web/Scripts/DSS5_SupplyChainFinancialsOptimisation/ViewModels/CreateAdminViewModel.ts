...
namespace DSS5_SupplyChainFinancialsOptimisation.ViewModels.CreateAdmin {
export class CreateAdminViewModel extends DSS5_SupplyChainFinancialsOptimisation.ViewModels.MasterPageSignIn.MasterPageSignInViewModel {
    public constructor() {
        super();
...
var result:
    ...
    public static _deleteDropDownInitialValues(reduced: CreateAdminViewModel) {
        ...
        DSS5_SupplyChainFinancialsOptimisation.ViewModels.MasterPageSignIn.MasterPageSignInViewModel._deleteDropDownInitialValues(reduced);
    }
