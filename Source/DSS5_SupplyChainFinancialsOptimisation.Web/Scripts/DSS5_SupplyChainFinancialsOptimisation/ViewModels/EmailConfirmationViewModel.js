...
(function (DSS5_SupplyChainFinancialsOptimisation) {
    ...
    (function (ViewModels) {
        ...
        (function (EmailConfirmation) {
            var EmailConfirmationViewModel = (function (_super) {
                __extends(EmailConfirmationViewModel, _super);
                function EmailConfirmationViewModel() {
                ...
                EmailConfirmationViewModel._lightCast = function (instance) {
                    if (instance == null)
                        return;
                    return instance;
                };
                EmailConfirmationViewModel._initializeFrom = function (original, ignoreReadOnlyProperties, context) {
                    ...
                    // }
                    var result = new EmailConfirmationViewModel();
                ...
                EmailConfirmationViewModel.prototype._hydrateEmailConfirmationViewModel = function (original, ignoreReadOnlyProperties, context) {
                    if (context === void 0) { context = new Joove.DTOHelper(); }
                    if (original == null)
                        return;
                ...
                EmailConfirmationViewModel.prototype._reduceData = function (ignoreReadOnlyProperties) {
                    var reduced = EmailConfirmationViewModel._initializeFrom(this, ignoreReadOnlyProperties);
                    EmailConfirmationViewModel._deleteDropDownInitialValues(reduced);
                    return reduced;
                };
                EmailConfirmationViewModel._deleteDropDownInitialValues = function (reduced) {
                    if (reduced == null)
                        return;
                    DSS5_SupplyChainFinancialsOptimisation.ViewModels.MasterPage.MasterPageViewModel._deleteDropDownInitialValues(reduced);
                };
                EmailConfirmationViewModel.prototype.hasMember = function (propertyName) {
            ...
            EmailConfirmation.EmailConfirmationViewModel = EmailConfirmationViewModel;
        })(EmailConfirmation = ViewModels.EmailConfirmation || (ViewModels.EmailConfirmation = {}));
