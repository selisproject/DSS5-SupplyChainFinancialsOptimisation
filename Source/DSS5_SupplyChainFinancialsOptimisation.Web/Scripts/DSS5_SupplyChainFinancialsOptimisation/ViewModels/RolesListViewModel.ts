...
namespace DSS5_SupplyChainFinancialsOptimisation.ViewModels.RolesList {
export class RolesListViewModel extends DSS5_SupplyChainFinancialsOptimisation.ViewModels.MasterPage.MasterPageViewModel {
    public constructor() {
        super();
