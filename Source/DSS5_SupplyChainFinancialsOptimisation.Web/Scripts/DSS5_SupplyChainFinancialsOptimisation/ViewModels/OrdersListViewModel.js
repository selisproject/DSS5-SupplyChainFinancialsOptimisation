...
(function (DSS5_SupplyChainFinancialsOptimisation) {
    ...
    (function (ViewModels) {
        var OrdersList;
        (function (OrdersList) {
            var OrdersListViewModel = (function (_super) {
                __extends(OrdersListViewModel, _super);
                ...
                OrdersListViewModel._lightCast = function (instance) {
                    if (instance == null)
                        return;
                    return instance;
                };
                OrdersListViewModel._initializeFrom = function (original, ignoreReadOnlyProperties, context) {
                    ...
                    // }
                    var result = new OrdersListViewModel();
                ...
                OrdersListViewModel.prototype._hydrateOrdersListViewModel = function (original, ignoreReadOnlyProperties, context) {
                    if (context === void 0) { context = new Joove.DTOHelper(); }
                    if (original == null)
                        return;
                ...
                OrdersListViewModel.prototype._reduceData = function (ignoreReadOnlyProperties) {
                    var reduced = OrdersListViewModel._initializeFrom(this, ignoreReadOnlyProperties);
                    OrdersListViewModel._deleteDropDownInitialValues(reduced);
                    return reduced;
                };
                OrdersListViewModel._deleteDropDownInitialValues = function (reduced) {
                    if (reduced == null)
                        return;
                ...
                OrdersListViewModel.prototype.hasMember = function (propertyName) {
            ...
            OrdersList.OrdersListViewModel = OrdersListViewModel;
        })(OrdersList = ViewModels.OrdersList || (ViewModels.OrdersList = {}));
