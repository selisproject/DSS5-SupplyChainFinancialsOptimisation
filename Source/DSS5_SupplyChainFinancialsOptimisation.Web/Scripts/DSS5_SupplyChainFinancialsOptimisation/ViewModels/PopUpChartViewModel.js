...
(function (DSS5_SupplyChainFinancialsOptimisation) {
    ...
    (function (ViewModels) {
        var PopUpChart;
        (function (PopUpChart) {
            var PopUpChartViewModel = (function (_super) {
                __extends(PopUpChartViewModel, _super);
                function PopUpChartViewModel() {
                ...
                PopUpChartViewModel._lightCast = function (instance) {
                    if (instance == null)
                        return;
                    return instance;
                };
                PopUpChartViewModel._initializeFrom = function (original, ignoreReadOnlyProperties, context) {
                    ...
                    // }
                    var result = new PopUpChartViewModel();
                ...
                PopUpChartViewModel.prototype._hydratePopUpChartViewModel = function (original, ignoreReadOnlyProperties, context) {
                    if (context === void 0) { context = new Joove.DTOHelper(); }
                    if (original == null)
                        return;
                ...
                PopUpChartViewModel.prototype._reduceData = function (ignoreReadOnlyProperties) {
                    var reduced = PopUpChartViewModel._initializeFrom(this, ignoreReadOnlyProperties);
                    PopUpChartViewModel._deleteDropDownInitialValues(reduced);
                    return reduced;
                };
                PopUpChartViewModel._deleteDropDownInitialValues = function (reduced) {
                    if (reduced == null)
                        return;
                ...
                PopUpChartViewModel.prototype.hasMember = function (propertyName) {
                ...
                return PopUpChartViewModel;
            }(DSS5_SupplyChainFinancialsOptimisation.ViewModels.MasterPageForSlide.MasterPageForSlideViewModel));
            PopUpChart.PopUpChartViewModel = PopUpChartViewModel;
        })(PopUpChart = ViewModels.PopUpChart || (ViewModels.PopUpChart = {}));
