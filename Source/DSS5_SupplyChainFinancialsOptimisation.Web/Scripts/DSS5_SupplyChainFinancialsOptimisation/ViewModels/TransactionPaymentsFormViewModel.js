...
(function (DSS5_SupplyChainFinancialsOptimisation) {
    var ViewModels;
    (function (ViewModels) {
        var TransactionPaymentsForm;
        (function (TransactionPaymentsForm) {
            var TransactionPaymentsFormViewModel = (function (_super) {
                __extends(TransactionPaymentsFormViewModel, _super);
                function TransactionPaymentsFormViewModel() {
                    var _this = _super.call(this) || this;
                    _this._clientPostedProps = null;
                    if (_this._members == null) {
                        _this._members = {
                            Agreement: true, Transactions: true, PaymentAmount: true, PaymentDate: true, FundedPaidTransactions: true, Searched: true
                        };
                    }
                    else {
                        ...
                        _this._members["FundedPaidTransactions"] = true;
                        _this._members["Searched"] = true;
                    }
                    _this.Transactions = new Array();
                    _this.FundedPaidTransactions = new Array();
                    return _this;
                }
                TransactionPaymentsFormViewModel._lightCast = function (instance) {
                    if (instance == null)
                        return;
                    ...
                    if (instance.FundedPaidTransactions != null) {
                        for (var i = 0; i < instance.FundedPaidTransactions.length; i++) {
                ...
                TransactionPaymentsFormViewModel._initializeFrom = function (original, ignoreReadOnlyProperties, context) {
                    ...
                    // }
                    var result = new TransactionPaymentsFormViewModel();
                ...
                TransactionPaymentsFormViewModel.prototype._hydrateTransactionPaymentsFormViewModel = function (original, ignoreReadOnlyProperties, context) {
                    if (context === void 0) { context = new Joove.DTOHelper(); }
                    if (original == null)
                        return;
                    ...
                    if (original.FundedPaidTransactions != null) {
                        for (var i = 0; i < original.FundedPaidTransactions.length; i++) {
                ...
                TransactionPaymentsFormViewModel.prototype._reduceData = function (ignoreReadOnlyProperties) {
                    var reduced = TransactionPaymentsFormViewModel._initializeFrom(this, ignoreReadOnlyProperties);
                    TransactionPaymentsFormViewModel._deleteDropDownInitialValues(reduced);
                    return reduced;
                };
                TransactionPaymentsFormViewModel._deleteDropDownInitialValues = function (reduced) {
                    if (reduced == null)
                        return;
                    DSS5_SupplyChainFinancialsOptimisation.ViewModels.MasterPage.MasterPageViewModel._deleteDropDownInitialValues(reduced);
                };
                TransactionPaymentsFormViewModel.prototype.hasMember = function (propertyName) {
                ...
                return TransactionPaymentsFormViewModel;
            }(DSS5_SupplyChainFinancialsOptimisation.ViewModels.MasterPage.MasterPageViewModel));
            TransactionPaymentsForm.TransactionPaymentsFormViewModel = TransactionPaymentsFormViewModel;
            ...
            TransactionPaymentsForm.Agreement_AgreementViewModel = Agreement_AgreementViewModel;
            ...
            TransactionPaymentsForm.Agreement_Agreement_Supplier_SupplierViewModel = Agreement_Agreement_Supplier_SupplierViewModel;
            ...
            TransactionPaymentsForm.Agreement_Agreement_CommercialAgreements_CommercialAgreementViewModel = Agreement_Agreement_CommercialAgreements_CommercialAgreementViewModel;
            var Agreement_Agreement_CommercialAgreements_CommercialAgreement_Transactions_TransactionViewModel = (function (_super) {
                ...
                function Agreement_Agreement_CommercialAgreements_CommercialAgreement_Transactions_TransactionViewModel() {
                    ...
                    if (_this._members == null) {
                        _this._members = {
                            Id: true, PaymentStatus: true, TransactionValue: true
                        };
                    }
                    else {
                        _this._members["Id"] = true;
            ...
            TransactionPaymentsForm.Agreement_Agreement_CommercialAgreements_CommercialAgreement_Transactions_TransactionViewModel = Agreement_Agreement_CommercialAgreements_CommercialAgreement_Transactions_TransactionViewModel;
            var Transactions_TransactionViewModel = (function (_super) {
                ...
                function Transactions_TransactionViewModel() {
                    ...
                    if (_this._members == null) {
                        _this._members = {
                            FundedAmount: true, Id: true, InvoicedDate: true, PaymentDate: true, PaymentStatus: true, RestPaymentAmount: true, ToBePaidAmount: true, TransactionValue: true, CommercialAgreement: true, Invoices: true, TransactionStatus: true, ImportedBuyer: true
                        };
                    }
                    else {
                ...
                Transactions_TransactionViewModel.prototype._hydrateTransactions_TransactionViewModel = function (original, ignoreReadOnlyProperties, context) {
                    ...
                    if (original.CommercialAgreement !== undefined)
                        this.CommercialAgreement = Transactions_Transaction_CommercialAgreement_CommercialAgreementViewModel._initializeFrom(original.CommercialAgreement, ignoreReadOnlyProperties, context);
            ...
            TransactionPaymentsForm.Transactions_TransactionViewModel = Transactions_TransactionViewModel;
            var Transactions_Transaction_CommercialAgreement_CommercialAgreementViewModel = (function (_super) {
                __extends(Transactions_Transaction_CommercialAgreement_CommercialAgreementViewModel, _super);
                function Transactions_Transaction_CommercialAgreement_CommercialAgreementViewModel() {
                    var _this = _super.call(this) || this;
                    _this._clientPostedProps = null;
                    if (_this._members == null) {
                        _this._members = {
                ...
                Transactions_Transaction_CommercialAgreement_CommercialAgreementViewModel._lightCast = function (instance) {
                    if (instance == null)
                        return;
                    return instance;
                };
                Transactions_Transaction_CommercialAgreement_CommercialAgreementViewModel._initializeFrom = function (original, ignoreReadOnlyProperties, context) {
                    if (ignoreReadOnlyProperties === void 0) { ignoreReadOnlyProperties = false; }
                    if (context === void 0) { context = new Joove.DTOHelper(); }
                    if (original == null)
                        return null;
                    ...
                    //    return context.Get(original);
                    // }
                    var result = new Transactions_Transaction_CommercialAgreement_CommercialAgreementViewModel();
                    if (context != null && context.fillDb == true) {
                        context.addToDb(original);
                    }
                ...
                Transactions_Transaction_CommercialAgreement_CommercialAgreementViewModel.prototype._hydrateTransactions_Transaction_CommercialAgreement_CommercialAgreementViewModel = function (original, ignoreReadOnlyProperties, context) {
                    if (context === void 0) { context = new Joove.DTOHelper(); }
                    if (original == null)
                        return;
                    if (original._key !== undefined)
                ...
                Transactions_Transaction_CommercialAgreement_CommercialAgreementViewModel.prototype._reduceData = function (ignoreReadOnlyProperties) {
                    var reduced = Transactions_Transaction_CommercialAgreement_CommercialAgreementViewModel._initializeFrom(this, ignoreReadOnlyProperties);
                    return reduced;
                };
                Transactions_Transaction_CommercialAgreement_CommercialAgreementViewModel.prototype.hasMember = function (propertyName) {
                    var result = this._members[propertyName];
                    if (result == null) {
                        return false;
                    }
                ...
                return Transactions_Transaction_CommercialAgreement_CommercialAgreementViewModel;
            }(BaseClass.ViewModel));
            TransactionPaymentsForm.Transactions_Transaction_CommercialAgreement_CommercialAgreementViewModel = Transactions_Transaction_CommercialAgreement_CommercialAgreementViewModel;
            ...
            TransactionPaymentsForm.Transactions_Transaction_Invoices_InvoiceViewModel = Transactions_Transaction_Invoices_InvoiceViewModel;
            ...
            TransactionPaymentsForm.Transactions_Transaction_TransactionStatus_TransactionStatusViewModel = Transactions_Transaction_TransactionStatus_TransactionStatusViewModel;
            ...
            TransactionPaymentsForm.Transactions_Transaction_ImportedBuyer_ImportedBuyerViewModel = Transactions_Transaction_ImportedBuyer_ImportedBuyerViewModel;
            var FundedPaidTransactions_TransactionViewModel = (function (_super) {
                __extends(FundedPaidTransactions_TransactionViewModel, _super);
                function FundedPaidTransactions_TransactionViewModel() {
                    var _this = _super.call(this) || this;
                    _this._clientPostedProps = null;
                    if (_this._members == null) {
                        _this._members = {
                            FundedAmount: true, Id: true, PaidByBuyer: true, PaymentDate: true, PaymentStatus: true, RestPaymentAmount: true, TransactionValue: true, CommercialAgreement: true, Invoices: true, ImportedBuyer: true
                        };
                    }
                    else {
                        _this._members["FundedAmount"] = true;
                ...
                FundedPaidTransactions_TransactionViewModel._lightCast = function (instance) {
                    if (instance == null)
                        return;
                    if (instance.PaymentDate != null)
                        instance.PaymentDate = new Date(instance.PaymentDate);
                ...
                FundedPaidTransactions_TransactionViewModel._initializeFrom = function (original, ignoreReadOnlyProperties, context) {
                    if (ignoreReadOnlyProperties === void 0) { ignoreReadOnlyProperties = false; }
                    if (context === void 0) { context = new Joove.DTOHelper(); }
                    if (original == null)
                        return null;
                    ...
                    //    return context.Get(original);
                    // }
                    var result = new FundedPaidTransactions_TransactionViewModel();
                    if (context != null && context.fillDb == true) {
                        context.addToDb(original);
                    }
                ...
                FundedPaidTransactions_TransactionViewModel.prototype._hydrateFundedPaidTransactions_TransactionViewModel = function (original, ignoreReadOnlyProperties, context) {
                    if (context === void 0) { context = new Joove.DTOHelper(); }
                    if (original == null)
                        return;
                    if (original._key !== undefined)
                    ...
                    if (original.TransactionValue !== undefined)
                        this.TransactionValue = original.TransactionValue;
                    if (original.CommercialAgreement !== undefined)
                        this.CommercialAgreement = FundedPaidTransactions_Transaction_CommercialAgreement_CommercialAgreementViewModel._initializeFrom(original.CommercialAgreement, ignoreReadOnlyProperties, context);
                    if (original.Invoices != null) {
                        for (var i = 0; i < original.Invoices.length; i++) {
                    ...
                    if (original.ImportedBuyer !== undefined)
                        this.ImportedBuyer = FundedPaidTransactions_Transaction_ImportedBuyer_ImportedBuyerViewModel._initializeFrom(original.ImportedBuyer, ignoreReadOnlyProperties, context);
                    this._reduceData = function (ignoreReadOnlyProperties) {
                        var reduced = FundedPaidTransactions_TransactionViewModel._initializeFrom(this, ignoreReadOnlyProperties);
                        return reduced;
                    };
                }; /* end _initializeFrom() */
                FundedPaidTransactions_TransactionViewModel.prototype._reduceData = function (ignoreReadOnlyProperties) {
                    var reduced = FundedPaidTransactions_TransactionViewModel._initializeFrom(this, ignoreReadOnlyProperties);
                    return reduced;
                };
                FundedPaidTransactions_TransactionViewModel.prototype.hasMember = function (propertyName) {
                    var result = this._members[propertyName];
                    if (result == null) {
                        return false;
                    }
                ...
                return FundedPaidTransactions_TransactionViewModel;
            }(BaseClass.ViewModel));
            TransactionPaymentsForm.FundedPaidTransactions_TransactionViewModel = FundedPaidTransactions_TransactionViewModel;
            var FundedPaidTransactions_Transaction_CommercialAgreement_CommercialAgreementViewModel = (function (_super) {
                __extends(FundedPaidTransactions_Transaction_CommercialAgreement_CommercialAgreementViewModel, _super);
                function FundedPaidTransactions_Transaction_CommercialAgreement_CommercialAgreementViewModel() {
                    var _this = _super.call(this) || this;
                    _this._clientPostedProps = null;
                    if (_this._members == null) {
                        _this._members = {
                ...
                FundedPaidTransactions_Transaction_CommercialAgreement_CommercialAgreementViewModel._lightCast = function (instance) {
                    if (instance == null)
                        return;
                    return instance;
                };
                FundedPaidTransactions_Transaction_CommercialAgreement_CommercialAgreementViewModel._initializeFrom = function (original, ignoreReadOnlyProperties, context) {
                    if (ignoreReadOnlyProperties === void 0) { ignoreReadOnlyProperties = false; }
                    if (context === void 0) { context = new Joove.DTOHelper(); }
                    if (original == null)
                        return null;
                    ...
                    //    return context.Get(original);
                    // }
                    var result = new FundedPaidTransactions_Transaction_CommercialAgreement_CommercialAgreementViewModel();
                    if (context != null && context.fillDb == true) {
                        context.addToDb(original);
                    }
                ...
                FundedPaidTransactions_Transaction_CommercialAgreement_CommercialAgreementViewModel.prototype._hydrateFundedPaidTransactions_Transaction_CommercialAgreement_CommercialAgreementViewModel = function (original, ignoreReadOnlyProperties, context) {
                    if (context === void 0) { context = new Joove.DTOHelper(); }
                    if (original == null)
                        return;
                    if (original._key !== undefined)
                ...
                FundedPaidTransactions_Transaction_CommercialAgreement_CommercialAgreementViewModel.prototype._reduceData = function (ignoreReadOnlyProperties) {
                    var reduced = FundedPaidTransactions_Transaction_CommercialAgreement_CommercialAgreementViewModel._initializeFrom(this, ignoreReadOnlyProperties);
                    return reduced;
                };
                FundedPaidTransactions_Transaction_CommercialAgreement_CommercialAgreementViewModel.prototype.hasMember = function (propertyName) {
                    var result = this._members[propertyName];
                    if (result == null) {
                        return false;
                    }
                ...
                return FundedPaidTransactions_Transaction_CommercialAgreement_CommercialAgreementViewModel;
            }(BaseClass.ViewModel));
            TransactionPaymentsForm.FundedPaidTransactions_Transaction_CommercialAgreement_CommercialAgreementViewModel = FundedPaidTransactions_Transaction_CommercialAgreement_CommercialAgreementViewModel;
            var FundedPaidTransactions_Transaction_Invoices_InvoiceViewModel = (function (_super) {
                __extends(FundedPaidTransactions_Transaction_Invoices_InvoiceViewModel, _super);
                function FundedPaidTransactions_Transaction_Invoices_InvoiceViewModel() {
                    var _this = _super.call(this) || this;
                    _this._clientPostedProps = null;
                    if (_this._members == null) {
                        _this._members = {
                ...
                FundedPaidTransactions_Transaction_Invoices_InvoiceViewModel._lightCast = function (instance) {
                    if (instance == null)
                        return;
                    return instance;
                };
                FundedPaidTransactions_Transaction_Invoices_InvoiceViewModel._initializeFrom = function (original, ignoreReadOnlyProperties, context) {
                    if (ignoreReadOnlyProperties === void 0) { ignoreReadOnlyProperties = false; }
                    if (context === void 0) { context = new Joove.DTOHelper(); }
                    if (original == null)
                        return null;
                    ...
                    //    return context.Get(original);
                    // }
                    var result = new FundedPaidTransactions_Transaction_Invoices_InvoiceViewModel();
                    if (context != null && context.fillDb == true) {
                        context.addToDb(original);
                    }
                ...
                FundedPaidTransactions_Transaction_Invoices_InvoiceViewModel.prototype._hydrateFundedPaidTransactions_Transaction_Invoices_InvoiceViewModel = function (original, ignoreReadOnlyProperties, context) {
                    if (context === void 0) { context = new Joove.DTOHelper(); }
                    if (original == null)
                        return;
                    if (original._key !== undefined)
                ...
                FundedPaidTransactions_Transaction_Invoices_InvoiceViewModel.prototype._reduceData = function (ignoreReadOnlyProperties) {
                    var reduced = FundedPaidTransactions_Transaction_Invoices_InvoiceViewModel._initializeFrom(this, ignoreReadOnlyProperties);
                    return reduced;
                };
                FundedPaidTransactions_Transaction_Invoices_InvoiceViewModel.prototype.hasMember = function (propertyName) {
                    var result = this._members[propertyName];
                    if (result == null) {
                        return false;
                    }
                ...
                return FundedPaidTransactions_Transaction_Invoices_InvoiceViewModel;
            }(BaseClass.ViewModel));
            TransactionPaymentsForm.FundedPaidTransactions_Transaction_Invoices_InvoiceViewModel = FundedPaidTransactions_Transaction_Invoices_InvoiceViewModel;
            var FundedPaidTransactions_Transaction_ImportedBuyer_ImportedBuyerViewModel = (function (_super) {
                __extends(FundedPaidTransactions_Transaction_ImportedBuyer_ImportedBuyerViewModel, _super);
                function FundedPaidTransactions_Transaction_ImportedBuyer_ImportedBuyerViewModel() {
                    var _this = _super.call(this) || this;
                    _this._clientPostedProps = null;
                    if (_this._members == null) {
                        _this._members = {
                ...
                FundedPaidTransactions_Transaction_ImportedBuyer_ImportedBuyerViewModel._lightCast = function (instance) {
                    if (instance == null)
                        return;
                    return instance;
                };
                FundedPaidTransactions_Transaction_ImportedBuyer_ImportedBuyerViewModel._initializeFrom = function (original, ignoreReadOnlyProperties, context) {
                    if (ignoreReadOnlyProperties === void 0) { ignoreReadOnlyProperties = false; }
                    if (context === void 0) { context = new Joove.DTOHelper(); }
                    if (original == null)
                        return null;
                    ...
                    //    return context.Get(original);
                    // }
                    var result = new FundedPaidTransactions_Transaction_ImportedBuyer_ImportedBuyerViewModel();
                    if (context != null && context.fillDb == true) {
                        context.addToDb(original);
                    }
                ...
                FundedPaidTransactions_Transaction_ImportedBuyer_ImportedBuyerViewModel.prototype._hydrateFundedPaidTransactions_Transaction_ImportedBuyer_ImportedBuyerViewModel = function (original, ignoreReadOnlyProperties, context) {
                    if (context === void 0) { context = new Joove.DTOHelper(); }
                    if (original == null)
                        return;
                    if (original._key !== undefined)
                ...
                FundedPaidTransactions_Transaction_ImportedBuyer_ImportedBuyerViewModel.prototype._reduceData = function (ignoreReadOnlyProperties) {
                    var reduced = FundedPaidTransactions_Transaction_ImportedBuyer_ImportedBuyerViewModel._initializeFrom(this, ignoreReadOnlyProperties);
                    return reduced;
                };
                FundedPaidTransactions_Transaction_ImportedBuyer_ImportedBuyerViewModel.prototype.hasMember = function (propertyName) {
                    var result = this._members[propertyName];
                    if (result == null) {
                        return false;
                    }
                ...
                return FundedPaidTransactions_Transaction_ImportedBuyer_ImportedBuyerViewModel;
            }(BaseClass.ViewModel));
            TransactionPaymentsForm.FundedPaidTransactions_Transaction_ImportedBuyer_ImportedBuyerViewModel = FundedPaidTransactions_Transaction_ImportedBuyer_ImportedBuyerViewModel;
        })(TransactionPaymentsForm = ViewModels.TransactionPaymentsForm || (ViewModels.TransactionPaymentsForm = {}));
