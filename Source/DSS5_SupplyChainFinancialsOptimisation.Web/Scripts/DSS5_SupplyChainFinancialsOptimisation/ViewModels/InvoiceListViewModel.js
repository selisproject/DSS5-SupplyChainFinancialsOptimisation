...
(function (DSS5_SupplyChainFinancialsOptimisation) {
    ...
    (function (ViewModels) {
        ...
        (function (InvoiceList) {
            var InvoiceListViewModel = (function (_super) {
                __extends(InvoiceListViewModel, _super);
                ...
                InvoiceListViewModel._lightCast = function (instance) {
                    if (instance == null)
                        return;
                    return instance;
                };
                InvoiceListViewModel._initializeFrom = function (original, ignoreReadOnlyProperties, context) {
                    ...
                    result._hydrateInvoiceListViewModel(original, ignoreReadOnlyProperties, context);
                    // context.Add(original, result);
                    return result;
                };
                InvoiceListViewModel.prototype._hydrateInvoiceListViewModel = function (original, ignoreReadOnlyProperties, context) {
                    if (context === void 0) { context = new Joove.DTOHelper(); }
                    if (original == null)
                        return;
                    ...
                    this.InvoiceListNoDTSelectedItemKeys = original.InvoiceListNoDTSelectedItemKeys;
                    this._reduceData = function (ignoreReadOnlyProperties) {
                        var reduced = InvoiceListViewModel._initializeFrom(this, ignoreReadOnlyProperties);
                        InvoiceListViewModel._deleteDropDownInitialValues(reduced);
                        return reduced;
                    };
                }; /* end _initializeFrom() */
                InvoiceListViewModel.prototype._reduceData = function (ignoreReadOnlyProperties) {
                    var reduced = InvoiceListViewModel._initializeFrom(this, ignoreReadOnlyProperties);
                    InvoiceListViewModel._deleteDropDownInitialValues(reduced);
                    return reduced;
                };
                InvoiceListViewModel._deleteDropDownInitialValues = function (reduced) {
                    if (reduced == null)
                        return;
                ...
                InvoiceListViewModel.prototype.hasMember = function (propertyName) {
            ...
            InvoiceList.InvoiceListViewModel = InvoiceListViewModel;
        })(InvoiceList = ViewModels.InvoiceList || (ViewModels.InvoiceList = {}));
