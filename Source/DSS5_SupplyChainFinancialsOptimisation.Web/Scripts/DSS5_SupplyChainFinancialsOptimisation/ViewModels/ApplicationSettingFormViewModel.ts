...
namespace DSS5_SupplyChainFinancialsOptimisation.ViewModels.ApplicationSettingForm {
export class ApplicationSettingFormViewModel extends DSS5_SupplyChainFinancialsOptimisation.ViewModels.MasterPageForSlide.MasterPageForSlideViewModel {
    public constructor() {
        super();
