...
(function (DSS5_SupplyChainFinancialsOptimisation) {
    ...
    (function (ViewModels) {
        ...
        (function (Administration) {
            var AdministrationViewModel = (function (_super) {
                __extends(AdministrationViewModel, _super);
                ...
                AdministrationViewModel._lightCast = function (instance) {
                    if (instance == null)
                        return;
                    return instance;
                };
                AdministrationViewModel._initializeFrom = function (original, ignoreReadOnlyProperties, context) {
                    ...
                    // }
                    var result = new AdministrationViewModel();
                    if (context != null && context.fillDb == true) {
                        context.addToDb(original);
                    }
                    result._hydrateAdministrationViewModel(original, ignoreReadOnlyProperties, context);
                    // context.Add(original, result);
                    return result;
                };
                AdministrationViewModel.prototype._hydrateAdministrationViewModel = function (original, ignoreReadOnlyProperties, context) {
                    if (context === void 0) { context = new Joove.DTOHelper(); }
                    if (original == null)
                        return;
                    ...
                    this._reduceData = function (ignoreReadOnlyProperties) {
                        var reduced = AdministrationViewModel._initializeFrom(this, ignoreReadOnlyProperties);
                        AdministrationViewModel._deleteDropDownInitialValues(reduced);
                        return reduced;
                    };
                }; /* end _initializeFrom() */
                AdministrationViewModel.prototype._reduceData = function (ignoreReadOnlyProperties) {
                    var reduced = AdministrationViewModel._initializeFrom(this, ignoreReadOnlyProperties);
                    AdministrationViewModel._deleteDropDownInitialValues(reduced);
                    return reduced;
                };
                AdministrationViewModel._deleteDropDownInitialValues = function (reduced) {
                    if (reduced == null)
                        return;
                    DSS5_SupplyChainFinancialsOptimisation.ViewModels.MasterPage.MasterPageViewModel._deleteDropDownInitialValues(reduced);
                };
                AdministrationViewModel.prototype.hasMember = function (propertyName) {
            ...
            Administration.AdministrationViewModel = AdministrationViewModel;
        })(Administration = ViewModels.Administration || (ViewModels.Administration = {}));
