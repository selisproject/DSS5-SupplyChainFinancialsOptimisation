...
using DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.SupplierPaymentsList;
using AppCode;
...
namespace DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.SupplierPaymentsList
{
    public class SupplierPaymentsListViewModel : MasterPageForListsViewModel
    {
    ...
    [OriginalType(typeof(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.SupplierPaymentsList.SupplierPaymentsListViewModel))]
    public class SupplierPaymentsListViewModelDTO : MasterPageForListsViewModelDTO, IViewModelDTO<DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.SupplierPaymentsList.SupplierPaymentsListViewModel>
    {

        [JsonConstructor]
        public SupplierPaymentsListViewModelDTO() { }
        public SupplierPaymentsListViewModelDTO(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.SupplierPaymentsList.SupplierPaymentsListViewModel original, bool parentIsDirty = false)  : base(original)
        {
        ...
        public override string _originalTypeClassName => typeof(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.SupplierPaymentsList.SupplierPaymentsListViewModel).FullName;
        public List<SelectedItemInfo<int?>> TransactionListNoDTSelectedItemKeys;

        public new DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.SupplierPaymentsList.SupplierPaymentsListViewModel GetModel()
        {
            var alreadySeenInstance = DTOHelper.GetSeenModelInstance<DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.SupplierPaymentsList.SupplierPaymentsListViewModel>(_clientKey, _originalTypeClassName, _baseClasses);
            if (alreadySeenInstance != null) return alreadySeenInstance;
            return new DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.SupplierPaymentsList.SupplierPaymentsListViewModel();
        }
        new  public DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.SupplierPaymentsList.SupplierPaymentsListViewModel Convert()
        {
            var original = GetModel();
            if (original == null)
            {
                original = new DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.SupplierPaymentsList.SupplierPaymentsListViewModel();
            }
            DTOHelper.UpdateSeenModelInstances(this, original);
            Hydrate(original);
            return original;
        }
        public void Hydrate(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.SupplierPaymentsList.SupplierPaymentsListViewModel original)
        {
            if (original == null) return;
            ...
            original.TransactionListNoDTSelectedItems = TransactionListNoDTSelectedItemKeys == null
                    ...
                    : TransactionListNoDTSelectedItemKeys.Select(x => new SelectedItemInfo<DSS5_SupplyChainFinancialsOptimisation.BO.Transaction>(x.SelectedItems.Select(y => ViewModels.SupplierPaymentsList.TransactionDataSet_TransactionDTO.GetModelByKey(y)).ToList(), x.Indexes, x.FullRecordsetSelected)).ToList();
        }
    }
    ...
    public class TransactionDataSet_TransactionDTO : ViewModelDTOBase, IViewModelDTO<DSS5_SupplyChainFinancialsOptimisation.BO.Transaction>
    {
        ...
        public  static TransactionDataSet_TransactionDTO GetInstance(object key, string jbID)
        {
            ...
            if(foundEntry == null && !string.IsNullOrWhiteSpace(jbID))
            {
                ...
                {
                    var controller = new SupplierPaymentsListController();
