...
using DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.InvestorTransactionsList;
using AppCode;
...
namespace DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.InvestorTransactionsList
{
    public class InvestorTransactionsListViewModel : MasterPageForListsViewModel
    {
        public string InvestorUsername;
        public List<SelectedItemInfo<DSS5_SupplyChainFinancialsOptimisation.BO.Transaction>> ListNoDTSelectedItems;


        public InvestorTransactionsListViewModel()
        {
        }
    ...
    [OriginalType(typeof(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.InvestorTransactionsList.InvestorTransactionsListViewModel))]
    public class InvestorTransactionsListViewModelDTO : MasterPageForListsViewModelDTO, IViewModelDTO<DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.InvestorTransactionsList.InvestorTransactionsListViewModel>
    {

        [JsonConstructor]
        public InvestorTransactionsListViewModelDTO() { }
        public InvestorTransactionsListViewModelDTO(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.InvestorTransactionsList.InvestorTransactionsListViewModel original, bool parentIsDirty = false)  : base(original)
        {
            if (original == null) return;
            _runtimeType = original.GetType().FullName;
            InvestorUsername = original.InvestorUsername;
        ...
        public override string _originalTypeClassName => typeof(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.InvestorTransactionsList.InvestorTransactionsListViewModel).FullName;
        public List<SelectedItemInfo<int?>> ListNoDTSelectedItemKeys;

        public new DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.InvestorTransactionsList.InvestorTransactionsListViewModel GetModel()
        {
            var alreadySeenInstance = DTOHelper.GetSeenModelInstance<DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.InvestorTransactionsList.InvestorTransactionsListViewModel>(_clientKey, _originalTypeClassName, _baseClasses);
            if (alreadySeenInstance != null) return alreadySeenInstance;
            return new DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.InvestorTransactionsList.InvestorTransactionsListViewModel();
        }
        new  public DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.InvestorTransactionsList.InvestorTransactionsListViewModel Convert()
        {
            var original = GetModel();
            if (original == null)
            {
                original = new DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.InvestorTransactionsList.InvestorTransactionsListViewModel();
            }
            DTOHelper.UpdateSeenModelInstances(this, original);
            Hydrate(original);
            return original;
        }
        public void Hydrate(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.InvestorTransactionsList.InvestorTransactionsListViewModel original)
        {
            if (original == null) return;
            base.Hydrate(original);
            original.InvestorUsername = InvestorUsername;
            original.ListNoDTSelectedItems = ListNoDTSelectedItemKeys == null
                                             ...
                                             : ListNoDTSelectedItemKeys.Select(x => new SelectedItemInfo<DSS5_SupplyChainFinancialsOptimisation.BO.Transaction>(x.SelectedItems.Select(y => ViewModels.InvestorTransactionsList.TransactionDataSet_TransactionDTO.GetModelByKey(y)).ToList(), x.Indexes, x.FullRecordsetSelected)).ToList();
        }
    }
    ...
    public class TransactionDataSet_TransactionDTO : ViewModelDTOBase, IViewModelDTO<DSS5_SupplyChainFinancialsOptimisation.BO.Transaction>
    {
        ...
        public TransactionDataSet_TransactionStatusDTO TransactionStatus;
        ...
        public  static TransactionDataSet_TransactionDTO GetInstance(object key, string jbID)
        {
            ...
            if(foundEntry == null && !string.IsNullOrWhiteSpace(jbID))
            {
                ...
                {
                    var controller = new InvestorTransactionsListController();
        ...
        public TransactionDataSet_TransactionDTO(DSS5_SupplyChainFinancialsOptimisation.BO.Transaction original)
        {
            ...
            TransactionStatus = original.TransactionStatus == null
                                ? null
                                : DTOHelper.GetDTOFromModel<TransactionDataSet_TransactionStatusDTO>(original.TransactionStatus as DSS5_SupplyChainFinancialsOptimisation.BO.TransactionStatus);
        }
    ...
    [DataSetDTO]
    public class TransactionDataSet_TransactionStatusDTO : ViewModelDTOBase, IViewModelDTO<DSS5_SupplyChainFinancialsOptimisation.BO.TransactionStatus>
    {
        ...
        [JsonConstructor]
        public TransactionDataSet_TransactionStatusDTO() : base() {}
        public  static TransactionDataSet_TransactionStatusDTO GetInstance(object key, string jbID)
        {
            if (key == null) return null;
            var rawKey = key.ToString();
            var parsedKey = int.Parse(rawKey);
            var foundEntry = new DAL.Repository().GetById<DSS5_SupplyChainFinancialsOptimisation.BO.TransactionStatus>(parsedKey, false);
            if(foundEntry == null && !string.IsNullOrWhiteSpace(jbID))
            {
                if(int.TryParse(rawKey, out int _uniqueKey))
                {
                    var controller = new InvestorTransactionsListController();
                    var method = controller.GetType().GetMethod($"Get_{jbID}_DatasourceQueryable");
                    var records = method.Invoke(controller, new object[] { null }) as IQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.TransactionStatus>;
                    foundEntry = records.Where(c => c._GetUniqueIdentifier() == _uniqueKey).FirstOrDefault();
                }
            }
            if(foundEntry != null)
            {
                return new TransactionDataSet_TransactionStatusDTO(foundEntry);
            }
            return null;
        }
        public TransactionDataSet_TransactionStatusDTO(DSS5_SupplyChainFinancialsOptimisation.BO.TransactionStatus original, bool assignClientKey) : this(original)
        {
            _clientKey = DTOHelper.GetClientKey(original, Id);
        }
        public TransactionDataSet_TransactionStatusDTO(DSS5_SupplyChainFinancialsOptimisation.BO.TransactionStatus original)
        {
            if(original == null) throw new ApplicationException(BaseViewPage<object>.GetResourceValue("GlobalResources", "RES_DATASOURCE_Null_Value_In_Resultset", null, "The resultset of your DataSource contains null values."));
            _key = (original.Id == 0) ? original._GetUniqueIdentifier() as object : original.Id as object;
            _runtimeType = original?.GetType().FullName;
        ...
        public static DSS5_SupplyChainFinancialsOptimisation.BO.TransactionStatus GetModelByKey(object _key)
        {
            var rawKey = _key.ToString();
            var parsedKey = int.Parse(rawKey);
        ...
        {
            var model = new DSS5_SupplyChainFinancialsOptimisation.BO.TransactionStatus();
            if (_key != null && _key.ToString() != "0")
            {
                var rawKey = _key.ToString();
                var parsedKey = int.Parse(rawKey);
                model = new DAL.Repository().GetById<DSS5_SupplyChainFinancialsOptimisation.BO.TransactionStatus>(parsedKey, false) ?? model;
            }
            if (!DTOHelper.SeenModelInstances.ContainsKey(this))
            {
                DTOHelper.SeenModelInstances.Add(this, model);
