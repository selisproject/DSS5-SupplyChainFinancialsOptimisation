...
using DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.ValidatedSuppliersList;
using AppCode;
...
namespace DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ValidatedSuppliersList
{
    public class ValidatedSuppliersListViewModel : MasterPageForListsViewModel
    {
        public List<SelectedItemInfo<DSS5_SupplyChainFinancialsOptimisation.BO.Supplier>> SupplierListNoDTSelectedItems;


        public ValidatedSuppliersListViewModel()
        {
        }
    ...
    [OriginalType(typeof(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ValidatedSuppliersList.ValidatedSuppliersListViewModel))]
    public class ValidatedSuppliersListViewModelDTO : MasterPageForListsViewModelDTO, IViewModelDTO<DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ValidatedSuppliersList.ValidatedSuppliersListViewModel>
    {

        [JsonConstructor]
        public ValidatedSuppliersListViewModelDTO() { }
        public ValidatedSuppliersListViewModelDTO(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ValidatedSuppliersList.ValidatedSuppliersListViewModel original, bool parentIsDirty = false)  : base(original)
        {
        ...
        public override string _originalTypeClassName => typeof(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ValidatedSuppliersList.ValidatedSuppliersListViewModel).FullName;
        public List<SelectedItemInfo<string>> SupplierListNoDTSelectedItemKeys;

        public new DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ValidatedSuppliersList.ValidatedSuppliersListViewModel GetModel()
        {
            var alreadySeenInstance = DTOHelper.GetSeenModelInstance<DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ValidatedSuppliersList.ValidatedSuppliersListViewModel>(_clientKey, _originalTypeClassName, _baseClasses);
            if (alreadySeenInstance != null) return alreadySeenInstance;
            return new DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ValidatedSuppliersList.ValidatedSuppliersListViewModel();
        }
        new  public DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ValidatedSuppliersList.ValidatedSuppliersListViewModel Convert()
        {
            var original = GetModel();
            if (original == null)
            {
                original = new DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ValidatedSuppliersList.ValidatedSuppliersListViewModel();
            }
            DTOHelper.UpdateSeenModelInstances(this, original);
            Hydrate(original);
            return original;
        }
        public void Hydrate(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ValidatedSuppliersList.ValidatedSuppliersListViewModel original)
        {
            if (original == null) return;
            ...
            original.SupplierListNoDTSelectedItems = SupplierListNoDTSelectedItemKeys == null
                    ...
                    : SupplierListNoDTSelectedItemKeys.Select(x => new SelectedItemInfo<DSS5_SupplyChainFinancialsOptimisation.BO.Supplier>(x.SelectedItems.Select(y => ViewModels.ValidatedSuppliersList.SupplierDataSet_SupplierDTO.GetModelByKey(y)).ToList(), x.Indexes, x.FullRecordsetSelected)).ToList();
        }
    }
    ...
    public class SupplierDataSet_SupplierDTO : SupplierDataSet_ApplicationUserDTO, IViewModelDTO<DSS5_SupplyChainFinancialsOptimisation.BO.Supplier>
    {
        ...
        public SupplierDataSet_SupplierContactInformationDTO SupplierContactInformation;
        ...
        public new static SupplierDataSet_SupplierDTO GetInstance(object key, string jbID)
        {
            ...
            if(foundEntry == null && !string.IsNullOrWhiteSpace(jbID))
            {
                ...
                {
                    var controller = new ValidatedSuppliersListController();
    ...
    [DataSetDTO]
    public class SupplierDataSet_SupplierContactInformationDTO : ViewModelDTOBase, IViewModelDTO<DSS5_SupplyChainFinancialsOptimisation.BO.SupplierContactInformation>
    {
        ...
        [JsonConstructor]
        public SupplierDataSet_SupplierContactInformationDTO() : base() {}
        public  static SupplierDataSet_SupplierContactInformationDTO GetInstance(object key, string jbID)
        {
            if (key == null) return null;
            var rawKey = key.ToString();
            var parsedKey = int.Parse(rawKey);
            var foundEntry = new DAL.Repository().GetById<DSS5_SupplyChainFinancialsOptimisation.BO.SupplierContactInformation>(parsedKey, false);
            if(foundEntry == null && !string.IsNullOrWhiteSpace(jbID))
            {
                if(int.TryParse(rawKey, out int _uniqueKey))
                {
                    var controller = new ValidatedSuppliersListController();
                    var method = controller.GetType().GetMethod($"Get_{jbID}_DatasourceQueryable");
                    var records = method.Invoke(controller, new object[] { null }) as IQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.SupplierContactInformation>;
                    foundEntry = records.Where(c => c._GetUniqueIdentifier() == _uniqueKey).FirstOrDefault();
                }
            }
            if(foundEntry != null)
            {
                return new SupplierDataSet_SupplierContactInformationDTO(foundEntry);
            }
            return null;
        }
        public SupplierDataSet_SupplierContactInformationDTO(DSS5_SupplyChainFinancialsOptimisation.BO.SupplierContactInformation original, bool assignClientKey) : this(original)
        {
            _clientKey = DTOHelper.GetClientKey(original, Id);
        }
        public SupplierDataSet_SupplierContactInformationDTO(DSS5_SupplyChainFinancialsOptimisation.BO.SupplierContactInformation original)
        {
            if(original == null) throw new ApplicationException(BaseViewPage<object>.GetResourceValue("GlobalResources", "RES_DATASOURCE_Null_Value_In_Resultset", null, "The resultset of your DataSource contains null values."));
        ...
        public static DSS5_SupplyChainFinancialsOptimisation.BO.SupplierContactInformation GetModelByKey(object _key)
        {
            var rawKey = _key.ToString();
            var parsedKey = int.Parse(rawKey);
        ...
        {
            var model = new DSS5_SupplyChainFinancialsOptimisation.BO.SupplierContactInformation();
            if (_key != null && _key.ToString() != "0")
            {
                var rawKey = _key.ToString();
                var parsedKey = int.Parse(rawKey);
                model = new DAL.Repository().GetById<DSS5_SupplyChainFinancialsOptimisation.BO.SupplierContactInformation>(parsedKey, false) ?? model;
            }
            if (!DTOHelper.SeenModelInstances.ContainsKey(this))
            {
                DTOHelper.SeenModelInstances.Add(this, model);
