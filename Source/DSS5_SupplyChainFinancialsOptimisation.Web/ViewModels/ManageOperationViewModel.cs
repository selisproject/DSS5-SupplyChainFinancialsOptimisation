...
using DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.ManageOperation;
using AppCode;
...
namespace DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ManageOperation
{
    ...
    [OriginalType(typeof(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ManageOperation.ManageOperationViewModel))]
    public class ManageOperationViewModelDTO : MasterPageForSlideViewModelDTO, IViewModelDTO<DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ManageOperation.ManageOperationViewModel>
    {

        [JsonConstructor]
        public ManageOperationViewModelDTO() { }
        public ManageOperationViewModelDTO(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ManageOperation.ManageOperationViewModel original, bool parentIsDirty = false)  : base(original)
        {
        ...
        public override string _originalTypeClassName => typeof(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ManageOperation.ManageOperationViewModel).FullName;
        public List<SelectedItemInfo<int?>> Button2SelectedItemKeys;

        public new DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ManageOperation.ManageOperationViewModel GetModel()
        {
            var alreadySeenInstance = DTOHelper.GetSeenModelInstance<DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ManageOperation.ManageOperationViewModel>(_clientKey, _originalTypeClassName, _baseClasses);
            if (alreadySeenInstance != null) return alreadySeenInstance;
            return new DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ManageOperation.ManageOperationViewModel();
        }
        new  public DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ManageOperation.ManageOperationViewModel Convert()
        {
            var original = GetModel();
            if (original == null)
            {
                original = new DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ManageOperation.ManageOperationViewModel();
            }
            DTOHelper.UpdateSeenModelInstances(this, original);
            Hydrate(original);
            return original;
        }
        public void Hydrate(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ManageOperation.ManageOperationViewModel original)
        {
            if (original == null) return;
