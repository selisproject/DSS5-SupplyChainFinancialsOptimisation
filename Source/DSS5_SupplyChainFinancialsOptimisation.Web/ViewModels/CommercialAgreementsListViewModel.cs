...
using DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.CommercialAgreementsList;
using AppCode;
...
namespace DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.CommercialAgreementsList
{
    public class CommercialAgreementsListViewModel : MasterPageForListsViewModel
    {
        ...
        public CommercialAgreementsListViewModel()
        {
        }
    ...
    [OriginalType(typeof(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.CommercialAgreementsList.CommercialAgreementsListViewModel))]
    public class CommercialAgreementsListViewModelDTO : MasterPageForListsViewModelDTO, IViewModelDTO<DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.CommercialAgreementsList.CommercialAgreementsListViewModel>
    {

        [JsonConstructor]
        public CommercialAgreementsListViewModelDTO() { }
        public CommercialAgreementsListViewModelDTO(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.CommercialAgreementsList.CommercialAgreementsListViewModel original, bool parentIsDirty = false)  : base(original)
        {
        ...
        public override string _originalTypeClassName => typeof(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.CommercialAgreementsList.CommercialAgreementsListViewModel).FullName;
        public List<SelectedItemInfo<int?>> CommercialAgreementListNoDTSelectedItemKeys;

        public new DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.CommercialAgreementsList.CommercialAgreementsListViewModel GetModel()
        {
            var alreadySeenInstance = DTOHelper.GetSeenModelInstance<DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.CommercialAgreementsList.CommercialAgreementsListViewModel>(_clientKey, _originalTypeClassName, _baseClasses);
            if (alreadySeenInstance != null) return alreadySeenInstance;
            return new DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.CommercialAgreementsList.CommercialAgreementsListViewModel();
        }
        new  public DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.CommercialAgreementsList.CommercialAgreementsListViewModel Convert()
        {
            var original = GetModel();
            if (original == null)
            {
                original = new DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.CommercialAgreementsList.CommercialAgreementsListViewModel();
            }
            DTOHelper.UpdateSeenModelInstances(this, original);
            Hydrate(original);
            return original;
        }
        public void Hydrate(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.CommercialAgreementsList.CommercialAgreementsListViewModel original)
        {
            if (original == null) return;
            ...
            original.CommercialAgreementListNoDTSelectedItems = CommercialAgreementListNoDTSelectedItemKeys == null
                    ...
                    : CommercialAgreementListNoDTSelectedItemKeys.Select(x => new SelectedItemInfo<DSS5_SupplyChainFinancialsOptimisation.BO.CommercialAgreement>(x.SelectedItems.Select(y => ViewModels.CommercialAgreementsList.CommercialAgreementDataSet_CommercialAgreementDTO.GetModelByKey(y)).ToList(), x.Indexes, x.FullRecordsetSelected)).ToList();
        }
    }
    ...
    public class CommercialAgreementDataSet_CommercialAgreementDTO : ViewModelDTOBase, IViewModelDTO<DSS5_SupplyChainFinancialsOptimisation.BO.CommercialAgreement>
    {
        ...
        public  static CommercialAgreementDataSet_CommercialAgreementDTO GetInstance(object key, string jbID)
        {
            ...
            if(foundEntry == null && !string.IsNullOrWhiteSpace(jbID))
            {
                ...
                {
                    var controller = new CommercialAgreementsListController();
