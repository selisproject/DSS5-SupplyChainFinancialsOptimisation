...
using DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.ActiveSuppliersList;
using AppCode;
...
namespace DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ActiveSuppliersList
{
    public class ActiveSuppliersListViewModel : MasterPageForListsViewModel
    {
        public List<SelectedItemInfo<DSS5_SupplyChainFinancialsOptimisation.BO.Supplier>> SupplierListNoDTSelectedItems;


        public ActiveSuppliersListViewModel()
        {
        }
    ...
    [OriginalType(typeof(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ActiveSuppliersList.ActiveSuppliersListViewModel))]
    public class ActiveSuppliersListViewModelDTO : MasterPageForListsViewModelDTO, IViewModelDTO<DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ActiveSuppliersList.ActiveSuppliersListViewModel>
    {

        [JsonConstructor]
        public ActiveSuppliersListViewModelDTO() { }
        public ActiveSuppliersListViewModelDTO(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ActiveSuppliersList.ActiveSuppliersListViewModel original, bool parentIsDirty = false)  : base(original)
        {
        ...
        public override string _originalTypeClassName => typeof(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ActiveSuppliersList.ActiveSuppliersListViewModel).FullName;
        public List<SelectedItemInfo<string>> SupplierListNoDTSelectedItemKeys;

        public new DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ActiveSuppliersList.ActiveSuppliersListViewModel GetModel()
        {
            var alreadySeenInstance = DTOHelper.GetSeenModelInstance<DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ActiveSuppliersList.ActiveSuppliersListViewModel>(_clientKey, _originalTypeClassName, _baseClasses);
            if (alreadySeenInstance != null) return alreadySeenInstance;
            return new DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ActiveSuppliersList.ActiveSuppliersListViewModel();
        }
        new  public DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ActiveSuppliersList.ActiveSuppliersListViewModel Convert()
        {
            var original = GetModel();
            if (original == null)
            {
                original = new DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ActiveSuppliersList.ActiveSuppliersListViewModel();
            }
            DTOHelper.UpdateSeenModelInstances(this, original);
            Hydrate(original);
            return original;
        }
        public void Hydrate(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ActiveSuppliersList.ActiveSuppliersListViewModel original)
        {
            if (original == null) return;
            ...
            original.SupplierListNoDTSelectedItems = SupplierListNoDTSelectedItemKeys == null
                    ...
                    : SupplierListNoDTSelectedItemKeys.Select(x => new SelectedItemInfo<DSS5_SupplyChainFinancialsOptimisation.BO.Supplier>(x.SelectedItems.Select(y => ViewModels.ActiveSuppliersList.SupplierDataSet_SupplierDTO.GetModelByKey(y)).ToList(), x.Indexes, x.FullRecordsetSelected)).ToList();
        }
    }
    ...
    public class SupplierDataSet_SupplierDTO : SupplierDataSet_ApplicationUserDTO, IViewModelDTO<DSS5_SupplyChainFinancialsOptimisation.BO.Supplier>
    {
        ...
        public new static SupplierDataSet_SupplierDTO GetInstance(object key, string jbID)
        {
            ...
            if(foundEntry == null && !string.IsNullOrWhiteSpace(jbID))
            {
                ...
                {
                    var controller = new ActiveSuppliersListController();
