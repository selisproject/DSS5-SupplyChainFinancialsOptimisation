...
using DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.PendingRegisteredSuppliersList;
using AppCode;
...
namespace DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.PendingRegisteredSuppliersList
{
    public class PendingRegisteredSuppliersListViewModel : MasterPageForListsViewModel
    {
        public List<SelectedItemInfo<DSS5_SupplyChainFinancialsOptimisation.BO.Supplier>> SupplierListNoDTSelectedItems;


        public PendingRegisteredSuppliersListViewModel()
        {
        }
    ...
    [OriginalType(typeof(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.PendingRegisteredSuppliersList.PendingRegisteredSuppliersListViewModel))]
    public class PendingRegisteredSuppliersListViewModelDTO : MasterPageForListsViewModelDTO, IViewModelDTO<DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.PendingRegisteredSuppliersList.PendingRegisteredSuppliersListViewModel>
    {

        [JsonConstructor]
        public PendingRegisteredSuppliersListViewModelDTO() { }
        public PendingRegisteredSuppliersListViewModelDTO(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.PendingRegisteredSuppliersList.PendingRegisteredSuppliersListViewModel original, bool parentIsDirty = false)  : base(original)
        {
        ...
        public override string _originalTypeClassName => typeof(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.PendingRegisteredSuppliersList.PendingRegisteredSuppliersListViewModel).FullName;
        public List<SelectedItemInfo<string>> SupplierListNoDTSelectedItemKeys;

        public new DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.PendingRegisteredSuppliersList.PendingRegisteredSuppliersListViewModel GetModel()
        {
            var alreadySeenInstance = DTOHelper.GetSeenModelInstance<DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.PendingRegisteredSuppliersList.PendingRegisteredSuppliersListViewModel>(_clientKey, _originalTypeClassName, _baseClasses);
            if (alreadySeenInstance != null) return alreadySeenInstance;
            return new DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.PendingRegisteredSuppliersList.PendingRegisteredSuppliersListViewModel();
        }
        new  public DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.PendingRegisteredSuppliersList.PendingRegisteredSuppliersListViewModel Convert()
        {
            var original = GetModel();
            if (original == null)
            {
                original = new DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.PendingRegisteredSuppliersList.PendingRegisteredSuppliersListViewModel();
            }
            DTOHelper.UpdateSeenModelInstances(this, original);
            Hydrate(original);
            return original;
        }
        public void Hydrate(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.PendingRegisteredSuppliersList.PendingRegisteredSuppliersListViewModel original)
        {
            if (original == null) return;
            ...
            original.SupplierListNoDTSelectedItems = SupplierListNoDTSelectedItemKeys == null
                    ...
                    : SupplierListNoDTSelectedItemKeys.Select(x => new SelectedItemInfo<DSS5_SupplyChainFinancialsOptimisation.BO.Supplier>(x.SelectedItems.Select(y => ViewModels.PendingRegisteredSuppliersList.SupplierDataSet_SupplierDTO.GetModelByKey(y)).ToList(), x.Indexes, x.FullRecordsetSelected)).ToList();
        }
    }
    ...
    public class SupplierDataSet_SupplierDTO : SupplierDataSet_ApplicationUserDTO, IViewModelDTO<DSS5_SupplyChainFinancialsOptimisation.BO.Supplier>
    {
        ...
        public string PercentageOfCreditNotes;
        ...
        public new static SupplierDataSet_SupplierDTO GetInstance(object key, string jbID)
        {
            ...
            if(foundEntry == null && !string.IsNullOrWhiteSpace(jbID))
            {
                ...
                {
                    var controller = new PendingRegisteredSuppliersListController();
        ...
        public SupplierDataSet_SupplierDTO(DSS5_SupplyChainFinancialsOptimisation.BO.Supplier original)
        {
            ...
            PercentageOfCreditNotes = original.PercentageOfCreditNotes;
