...
using DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.TransactionsList;
using AppCode;
...
namespace DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.TransactionsList
{
    public class TransactionsListViewModel : MasterPageForListsViewModel
    {
    ...
    [OriginalType(typeof(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.TransactionsList.TransactionsListViewModel))]
    public class TransactionsListViewModelDTO : MasterPageForListsViewModelDTO, IViewModelDTO<DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.TransactionsList.TransactionsListViewModel>
    {

        [JsonConstructor]
        public TransactionsListViewModelDTO() { }
        public TransactionsListViewModelDTO(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.TransactionsList.TransactionsListViewModel original, bool parentIsDirty = false)  : base(original)
        {
        ...
        public override string _originalTypeClassName => typeof(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.TransactionsList.TransactionsListViewModel).FullName;
        public List<SelectedItemInfo<int?>> TransactionListNoDTSelectedItemKeys;

        public new DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.TransactionsList.TransactionsListViewModel GetModel()
        {
            var alreadySeenInstance = DTOHelper.GetSeenModelInstance<DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.TransactionsList.TransactionsListViewModel>(_clientKey, _originalTypeClassName, _baseClasses);
            if (alreadySeenInstance != null) return alreadySeenInstance;
            return new DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.TransactionsList.TransactionsListViewModel();
        }
        new  public DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.TransactionsList.TransactionsListViewModel Convert()
        {
            var original = GetModel();
            if (original == null)
            {
                original = new DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.TransactionsList.TransactionsListViewModel();
            }
            DTOHelper.UpdateSeenModelInstances(this, original);
            Hydrate(original);
            return original;
        }
        public void Hydrate(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.TransactionsList.TransactionsListViewModel original)
        {
            if (original == null) return;
            ...
            original.TransactionListNoDTSelectedItems = TransactionListNoDTSelectedItemKeys == null
                    ...
                    : TransactionListNoDTSelectedItemKeys.Select(x => new SelectedItemInfo<DSS5_SupplyChainFinancialsOptimisation.BO.Transaction>(x.SelectedItems.Select(y => ViewModels.TransactionsList.TransactionDataSet_TransactionDTO.GetModelByKey(y)).ToList(), x.Indexes, x.FullRecordsetSelected)).ToList();
        }
    }
    ...
    public class TransactionDataSet_TransactionDTO : ViewModelDTOBase, IViewModelDTO<DSS5_SupplyChainFinancialsOptimisation.BO.Transaction>
    {
        ...
        public  static TransactionDataSet_TransactionDTO GetInstance(object key, string jbID)
        {
            ...
            if(foundEntry == null && !string.IsNullOrWhiteSpace(jbID))
            {
                ...
                {
                    var controller = new TransactionsListController();
