...
using DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.ApplicationSettingForm;
using AppCode;
...
namespace DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ApplicationSettingForm
{
    ...
    [OriginalType(typeof(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ApplicationSettingForm.ApplicationSettingFormViewModel))]
    public class ApplicationSettingFormViewModelDTO : MasterPageForSlideViewModelDTO, IViewModelDTO<DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ApplicationSettingForm.ApplicationSettingFormViewModel>
    {

        [JsonConstructor]
        public ApplicationSettingFormViewModelDTO() { }
        public ApplicationSettingFormViewModelDTO(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ApplicationSettingForm.ApplicationSettingFormViewModel original, bool parentIsDirty = false)  : base(original)
        {
        ...
        public override string _originalTypeClassName => typeof(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ApplicationSettingForm.ApplicationSettingFormViewModel).FullName;

        public new DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ApplicationSettingForm.ApplicationSettingFormViewModel GetModel()
        {
            var alreadySeenInstance = DTOHelper.GetSeenModelInstance<DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ApplicationSettingForm.ApplicationSettingFormViewModel>(_clientKey, _originalTypeClassName, _baseClasses);
            if (alreadySeenInstance != null) return alreadySeenInstance;
            return new DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ApplicationSettingForm.ApplicationSettingFormViewModel();
        }
        new  public DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ApplicationSettingForm.ApplicationSettingFormViewModel Convert()
        {
            var original = GetModel();
            if (original == null)
            {
                original = new DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ApplicationSettingForm.ApplicationSettingFormViewModel();
            }
            DTOHelper.UpdateSeenModelInstances(this, original);
            Hydrate(original);
            return original;
        }
        public void Hydrate(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ApplicationSettingForm.ApplicationSettingFormViewModel original)
        {
            if (original == null) return;
