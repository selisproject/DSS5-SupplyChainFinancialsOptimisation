...
using DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.AdminTransactionsList;
using AppCode;
...
namespace DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.AdminTransactionsList
{
    public class AdminTransactionsListViewModel : MasterPageForListsViewModel
    {
        public List<SelectedItemInfo<DSS5_SupplyChainFinancialsOptimisation.BO.Transaction>> ListNoDTSelectedItems;


        public AdminTransactionsListViewModel()
        {
        }
    ...
    [OriginalType(typeof(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.AdminTransactionsList.AdminTransactionsListViewModel))]
    public class AdminTransactionsListViewModelDTO : MasterPageForListsViewModelDTO, IViewModelDTO<DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.AdminTransactionsList.AdminTransactionsListViewModel>
    {

        [JsonConstructor]
        public AdminTransactionsListViewModelDTO() { }
        public AdminTransactionsListViewModelDTO(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.AdminTransactionsList.AdminTransactionsListViewModel original, bool parentIsDirty = false)  : base(original)
        {
        ...
        public override string _originalTypeClassName => typeof(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.AdminTransactionsList.AdminTransactionsListViewModel).FullName;
        public List<SelectedItemInfo<int?>> ListNoDTSelectedItemKeys;

        public new DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.AdminTransactionsList.AdminTransactionsListViewModel GetModel()
        {
            var alreadySeenInstance = DTOHelper.GetSeenModelInstance<DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.AdminTransactionsList.AdminTransactionsListViewModel>(_clientKey, _originalTypeClassName, _baseClasses);
            if (alreadySeenInstance != null) return alreadySeenInstance;
            return new DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.AdminTransactionsList.AdminTransactionsListViewModel();
        }
        new  public DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.AdminTransactionsList.AdminTransactionsListViewModel Convert()
        {
            var original = GetModel();
            if (original == null)
            {
                original = new DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.AdminTransactionsList.AdminTransactionsListViewModel();
            }
            DTOHelper.UpdateSeenModelInstances(this, original);
            Hydrate(original);
            return original;
        }
        public void Hydrate(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.AdminTransactionsList.AdminTransactionsListViewModel original)
        {
            if (original == null) return;
            ...
            original.ListNoDTSelectedItems = ListNoDTSelectedItemKeys == null
                                             ...
                                             : ListNoDTSelectedItemKeys.Select(x => new SelectedItemInfo<DSS5_SupplyChainFinancialsOptimisation.BO.Transaction>(x.SelectedItems.Select(y => ViewModels.AdminTransactionsList.TransactionDataSet_TransactionDTO.GetModelByKey(y)).ToList(), x.Indexes, x.FullRecordsetSelected)).ToList();
        }
    }
    ...
    public class TransactionDataSet_TransactionDTO : ViewModelDTOBase, IViewModelDTO<DSS5_SupplyChainFinancialsOptimisation.BO.Transaction>
    {
        ...
        public  static TransactionDataSet_TransactionDTO GetInstance(object key, string jbID)
        {
            ...
            if(foundEntry == null && !string.IsNullOrWhiteSpace(jbID))
            {
                ...
                {
                    var controller = new AdminTransactionsListController();
