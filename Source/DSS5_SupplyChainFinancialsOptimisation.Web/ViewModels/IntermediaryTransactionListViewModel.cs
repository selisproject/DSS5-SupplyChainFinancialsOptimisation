...
using DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.IntermediaryTransactionList;
using AppCode;
...
namespace DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.IntermediaryTransactionList
{
    public class IntermediaryTransactionListViewModel : MasterPageForListsViewModel
    {
        ...
        public IntermediaryTransactionListViewModel()
        {
        }
    ...
    [OriginalType(typeof(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.IntermediaryTransactionList.IntermediaryTransactionListViewModel))]
    public class IntermediaryTransactionListViewModelDTO : MasterPageForListsViewModelDTO, IViewModelDTO<DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.IntermediaryTransactionList.IntermediaryTransactionListViewModel>
    {

        [JsonConstructor]
        public IntermediaryTransactionListViewModelDTO() { }
        public IntermediaryTransactionListViewModelDTO(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.IntermediaryTransactionList.IntermediaryTransactionListViewModel original, bool parentIsDirty = false)  : base(original)
        {
        ...
        public override string _originalTypeClassName => typeof(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.IntermediaryTransactionList.IntermediaryTransactionListViewModel).FullName;
        public List<SelectedItemInfo<int?>> ListNoDTSelectedItemKeys;

        public new DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.IntermediaryTransactionList.IntermediaryTransactionListViewModel GetModel()
        {
            var alreadySeenInstance = DTOHelper.GetSeenModelInstance<DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.IntermediaryTransactionList.IntermediaryTransactionListViewModel>(_clientKey, _originalTypeClassName, _baseClasses);
            if (alreadySeenInstance != null) return alreadySeenInstance;
            return new DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.IntermediaryTransactionList.IntermediaryTransactionListViewModel();
        }
        new  public DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.IntermediaryTransactionList.IntermediaryTransactionListViewModel Convert()
        {
            var original = GetModel();
            if (original == null)
            {
                original = new DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.IntermediaryTransactionList.IntermediaryTransactionListViewModel();
            }
            DTOHelper.UpdateSeenModelInstances(this, original);
            Hydrate(original);
            return original;
        }
        public void Hydrate(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.IntermediaryTransactionList.IntermediaryTransactionListViewModel original)
        {
            if (original == null) return;
            base.Hydrate(original);
            original.IntermediaryId = IntermediaryId;
            original.ListNoDTSelectedItems = ListNoDTSelectedItemKeys == null
                                             ...
                                             : ListNoDTSelectedItemKeys.Select(x => new SelectedItemInfo<DSS5_SupplyChainFinancialsOptimisation.BO.Transaction>(x.SelectedItems.Select(y => ViewModels.IntermediaryTransactionList.TransactionDataSet_TransactionDTO.GetModelByKey(y)).ToList(), x.Indexes, x.FullRecordsetSelected)).ToList();
        }
    }
    ...
    public class TransactionDataSet_TransactionDTO : ViewModelDTOBase, IViewModelDTO<DSS5_SupplyChainFinancialsOptimisation.BO.Transaction>
    {
        ...
        public  static TransactionDataSet_TransactionDTO GetInstance(object key, string jbID)
        {
            ...
            if(foundEntry == null && !string.IsNullOrWhiteSpace(jbID))
            {
                ...
                {
                    var controller = new IntermediaryTransactionListController();
