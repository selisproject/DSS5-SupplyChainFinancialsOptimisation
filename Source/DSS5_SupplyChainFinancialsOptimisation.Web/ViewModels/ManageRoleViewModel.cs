...
using DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.ManageRole;
using AppCode;
...
namespace DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ManageRole
{
    public class ManageRoleViewModel : MasterPageForSlideViewModel
    {
        public zAppDev.DotNet.Framework.Identity.Model.ApplicationRole ApplicationRole;
        public List<SelectedItemInfo<zAppDev.DotNet.Framework.Identity.Model.ApplicationPermission>> AddPermissionSelectedItems;
    ...
    [OriginalType(typeof(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ManageRole.ManageRoleViewModel))]
    public class ManageRoleViewModelDTO : MasterPageForSlideViewModelDTO, IViewModelDTO<DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ManageRole.ManageRoleViewModel>
    {

        [JsonConstructor]
        public ManageRoleViewModelDTO() { }
        public ManageRoleViewModelDTO(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ManageRole.ManageRoleViewModel original, bool parentIsDirty = false)  : base(original)
        {
            ...
            AddPermissionSelectedItemKeys = original.AddPermissionSelectedItems == null
                                            ? null
                                            : original.AddPermissionSelectedItems.Select(x => new SelectedItemInfo<int?>(x.SelectedItems.Select(y => y.Id).ToList(), x.Indexes, x.FullRecordsetSelected)).ToList();
        }
        ...
        public override string _originalTypeClassName => typeof(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ManageRole.ManageRoleViewModel).FullName;
        public List<SelectedItemInfo<int?>> AddPermissionSelectedItemKeys;

        public new DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ManageRole.ManageRoleViewModel GetModel()
        {
            var alreadySeenInstance = DTOHelper.GetSeenModelInstance<DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ManageRole.ManageRoleViewModel>(_clientKey, _originalTypeClassName, _baseClasses);
            if (alreadySeenInstance != null) return alreadySeenInstance;
            return new DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ManageRole.ManageRoleViewModel();
        }
        new  public DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ManageRole.ManageRoleViewModel Convert()
        {
            var original = GetModel();
            if (original == null)
            {
                original = new DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ManageRole.ManageRoleViewModel();
            }
            DTOHelper.UpdateSeenModelInstances(this, original);
            Hydrate(original);
            return original;
        }
        public void Hydrate(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ManageRole.ManageRoleViewModel original)
        {
            if (original == null) return;
            ...
            original.AddPermissionSelectedItems = AddPermissionSelectedItemKeys == null
                                                  ? new List<SelectedItemInfo<zAppDev.DotNet.Framework.Identity.Model.ApplicationPermission>>()
                                                  : AddPermissionSelectedItemKeys.Select(x => new SelectedItemInfo<zAppDev.DotNet.Framework.Identity.Model.ApplicationPermission>(x.SelectedItems.Select(y => ViewModels.ManageRole.AddPermissionDataSet_ApplicationPermissionDTO.GetModelByKey(y)).ToList(), x.Indexes, x.FullRecordsetSelected)).ToList();
        }
    }
    ...
    public class ApplicationPermissionDTO : ViewModelDTOBase, IViewModelDTO<zAppDev.DotNet.Framework.Identity.Model.ApplicationPermission>
    {
        ...
        public  static ApplicationPermissionDTO GetInstance(object key, string jbID)
        {
            ...
            if(foundEntry == null && !string.IsNullOrWhiteSpace(jbID))
            {
                ...
                {
                    var controller = new ManageRoleController();
    ...
    [OriginalType(typeof(zAppDev.DotNet.Framework.Identity.Model.ApplicationPermission))]
    [DataSetDTO]
    public class AddPermissionDataSet_ApplicationPermissionDTO : ViewModelDTOBase, IViewModelDTO<zAppDev.DotNet.Framework.Identity.Model.ApplicationPermission>
    {
        public override string _originalTypeClassName => typeof(zAppDev.DotNet.Framework.Identity.Model.ApplicationPermission).FullName;
        public string _versionTimestamp;
        public  string _runtimeType;
        ...
        [JsonConstructor]
        public AddPermissionDataSet_ApplicationPermissionDTO() : base() {}
        public  static AddPermissionDataSet_ApplicationPermissionDTO GetInstance(object key, string jbID)
        {
            if (key == null) return null;
            var rawKey = key.ToString();
            var parsedKey = int.Parse(rawKey);
            ...
            if(foundEntry != null)
            {
                return new AddPermissionDataSet_ApplicationPermissionDTO(foundEntry);
            }
            return null;
        }
        public AddPermissionDataSet_ApplicationPermissionDTO(zAppDev.DotNet.Framework.Identity.Model.ApplicationPermission original, bool assignClientKey) : this(original)
        {
            _clientKey = DTOHelper.GetClientKey(original, Id);
        }
        public AddPermissionDataSet_ApplicationPermissionDTO(zAppDev.DotNet.Framework.Identity.Model.ApplicationPermission original)
        {
            if(original == null) throw new ApplicationException(BaseViewPage<object>.GetResourceValue("GlobalResources", "RES_DATASOURCE_Null_Value_In_Resultset", null, "The resultset of your DataSource contains null values."));
            _key = (original.Id == 0) ? original._GetUniqueIdentifier() as object : original.Id as object;
            _runtimeType = original?.GetType().FullName;
