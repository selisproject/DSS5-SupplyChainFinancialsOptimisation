...
using DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.ManageUser;
using AppCode;
...
namespace DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ManageUser
{
    ...
    [OriginalType(typeof(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ManageUser.ManageUserViewModel))]
    public class ManageUserViewModelDTO : MasterPageForSlideViewModelDTO, IViewModelDTO<DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ManageUser.ManageUserViewModel>
    {

        [JsonConstructor]
        public ManageUserViewModelDTO() { }
        public ManageUserViewModelDTO(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ManageUser.ManageUserViewModel original, bool parentIsDirty = false)  : base(original)
        {
        ...
        public override string _originalTypeClassName => typeof(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ManageUser.ManageUserViewModel).FullName;
        public List<SelectedItemInfo<int?>> Button1SelectedItemKeys;
        public List<SelectedItemInfo<int?>> Button2SelectedItemKeys;

        public new DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ManageUser.ManageUserViewModel GetModel()
        {
            var alreadySeenInstance = DTOHelper.GetSeenModelInstance<DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ManageUser.ManageUserViewModel>(_clientKey, _originalTypeClassName, _baseClasses);
            if (alreadySeenInstance != null) return alreadySeenInstance;
            return new DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ManageUser.ManageUserViewModel();
        }
        new  public DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ManageUser.ManageUserViewModel Convert()
        {
            var original = GetModel();
            if (original == null)
            {
                original = new DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ManageUser.ManageUserViewModel();
            }
            DTOHelper.UpdateSeenModelInstances(this, original);
            Hydrate(original);
            return original;
        }
        public void Hydrate(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ManageUser.ManageUserViewModel original)
        {
            if (original == null) return;
