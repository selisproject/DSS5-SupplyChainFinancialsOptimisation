...
using DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.FirstAdminSetup;
using AppCode;
...
namespace DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.FirstAdminSetup
{
    ...
    [OriginalType(typeof(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.FirstAdminSetup.FirstAdminSetupViewModel))]
    public class FirstAdminSetupViewModelDTO : MasterPageViewModelDTO, IViewModelDTO<DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.FirstAdminSetup.FirstAdminSetupViewModel>
    {

        [JsonConstructor]
        public FirstAdminSetupViewModelDTO() { }
        public FirstAdminSetupViewModelDTO(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.FirstAdminSetup.FirstAdminSetupViewModel original, bool parentIsDirty = false)  : base(original)
        {
        ...
        public override string _originalTypeClassName => typeof(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.FirstAdminSetup.FirstAdminSetupViewModel).FullName;

        public new DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.FirstAdminSetup.FirstAdminSetupViewModel GetModel()
        {
            var alreadySeenInstance = DTOHelper.GetSeenModelInstance<DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.FirstAdminSetup.FirstAdminSetupViewModel>(_clientKey, _originalTypeClassName, _baseClasses);
            if (alreadySeenInstance != null) return alreadySeenInstance;
            return new DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.FirstAdminSetup.FirstAdminSetupViewModel();
        }
        new  public DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.FirstAdminSetup.FirstAdminSetupViewModel Convert()
        {
            var original = GetModel();
            if (original == null)
            {
                original = new DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.FirstAdminSetup.FirstAdminSetupViewModel();
            }
            DTOHelper.UpdateSeenModelInstances(this, original);
            Hydrate(original);
            return original;
        }
        public void Hydrate(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.FirstAdminSetup.FirstAdminSetupViewModel original)
        {
            if (original == null) return;
