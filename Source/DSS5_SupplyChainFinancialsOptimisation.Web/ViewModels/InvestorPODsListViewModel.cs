...
using DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.InvestorPODsList;
using AppCode;
...
namespace DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.InvestorPODsList
{
    public class InvestorPODsListViewModel : MasterPageForListsViewModel
    {
        ...
        public InvestorPODsListViewModel()
        {
        }
    ...
    [OriginalType(typeof(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.InvestorPODsList.InvestorPODsListViewModel))]
    public class InvestorPODsListViewModelDTO : MasterPageForListsViewModelDTO, IViewModelDTO<DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.InvestorPODsList.InvestorPODsListViewModel>
    {

        [JsonConstructor]
        public InvestorPODsListViewModelDTO() { }
        public InvestorPODsListViewModelDTO(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.InvestorPODsList.InvestorPODsListViewModel original, bool parentIsDirty = false)  : base(original)
        {
        ...
        public override string _originalTypeClassName => typeof(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.InvestorPODsList.InvestorPODsListViewModel).FullName;
        public List<SelectedItemInfo<int?>> ProofOfDeliveryListNoDTSelectedItemKeys;

        public new DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.InvestorPODsList.InvestorPODsListViewModel GetModel()
        {
            var alreadySeenInstance = DTOHelper.GetSeenModelInstance<DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.InvestorPODsList.InvestorPODsListViewModel>(_clientKey, _originalTypeClassName, _baseClasses);
            if (alreadySeenInstance != null) return alreadySeenInstance;
            return new DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.InvestorPODsList.InvestorPODsListViewModel();
        }
        new  public DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.InvestorPODsList.InvestorPODsListViewModel Convert()
        {
            var original = GetModel();
            if (original == null)
            {
                original = new DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.InvestorPODsList.InvestorPODsListViewModel();
            }
            DTOHelper.UpdateSeenModelInstances(this, original);
            Hydrate(original);
            return original;
        }
        public void Hydrate(DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.InvestorPODsList.InvestorPODsListViewModel original)
        {
            if (original == null) return;
            ...
            original.ProofOfDeliveryListNoDTSelectedItems = ProofOfDeliveryListNoDTSelectedItemKeys == null
                    ...
                    : ProofOfDeliveryListNoDTSelectedItemKeys.Select(x => new SelectedItemInfo<DSS5_SupplyChainFinancialsOptimisation.BO.ProofOfDelivery>(x.SelectedItems.Select(y => ViewModels.InvestorPODsList.ProofOfDeliveryDataSet_ProofOfDeliveryDTO.GetModelByKey(y)).ToList(), x.Indexes, x.FullRecordsetSelected)).ToList();
        }
    }
    ...
    public class ProofOfDeliveryDataSet_ProofOfDeliveryDTO : ViewModelDTOBase, IViewModelDTO<DSS5_SupplyChainFinancialsOptimisation.BO.ProofOfDelivery>
    {
        ...
        public  static ProofOfDeliveryDataSet_ProofOfDeliveryDTO GetInstance(object key, string jbID)
        {
            ...
            if(foundEntry == null && !string.IsNullOrWhiteSpace(jbID))
            {
                ...
                {
                    var controller = new InvestorPODsListController();
