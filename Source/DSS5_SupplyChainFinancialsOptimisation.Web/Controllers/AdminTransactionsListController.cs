...
using DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.AdminTransactionsList;
...
namespace DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.AdminTransactionsList
{

    [RoutePrefix("AdminTransactionsList")]
    public class AdminTransactionsListController : ControllerBase<AdminTransactionsListViewModel, AdminTransactionsListViewModelDTO>
    {

        /*<Form:AdminTransactionsList:0/>*/
        public AdminTransactionsListController()
        {
            _logger = log4net.LogManager.GetLogger(typeof(AdminTransactionsListController));
        ...
        public void SetModel(AdminTransactionsListViewModel m)
        {
            @model = m;
        }
        ...
        {
            return PrepareUpdateInstanceResult(typeof(AdminTransactionsListViewModel));
        }
        ...
        {
            return FileHelper.PendingDownloadInstance.DownloadByKey("AdminTransactionsList", id);
        }
        ...
        public JsonResult SaveListView()
        {
            ...
            return SaveListView(postedData, "AdminTransactionsList");
        }
        ...
        {
            var postedData = _ParsePostedData();
            return DeleteListView(postedData, "AdminTransactionsList");
        }
        ...
        {
            var postedData = _ParsePostedData();
            return LoadListViews(postedData, "AdminTransactionsList");
        }
        ...
        {
            @model = new AdminTransactionsListViewModel();
            System.Web.HttpContext.Current.Session["LastEntryPoint_AdminTransactionsList"] = "Render";
            return null;
        }
        ...
        public JsonResult ListNoDT_GetFullRecordset()
        {
            ...
            var data = CreateDtoInstancesFromKeys(typeof(AdminTransactionsListViewModel), dataType, items.Select(i => i.Id.ToString()).ToList(), "ListNoDT");
...
//Fix for total items in GetGroupsClosed
        ...
        public string ListNoDT_ExportImplementation(DatasourceRequest datasourceRequest, ExportHelper.ExportOptions exportOptions, List<AggregatorInfo<DSS5_SupplyChainFinancialsOptimisation.BO.Transaction>> aggregatorsInfo)
        {
            ...
            foreach (var record in dto)
            {
                ...
                recordDTO.Columns.Add(new ExportHelper.ExportColumnDTO
                {
                    ...
                    Format = "",
                    ExcelFormat = @"",
                    Caption = BaseViewPage<object>.GetResourceValue("AdminTransactionsList", "RES_LIST_ListNoDT_COLUMN_Id")
                });
                recordDTO.Columns.Add(new ExportHelper.ExportColumnDTO
                {
                    ...
                    Format = "",
                    ExcelFormat = @"",
                    Caption = BaseViewPage<object>.GetResourceValue("AdminTransactionsList", "RES_LIST_ListNoDT_COLUMN_Supplier.Company")
                });
                recordDTO.Columns.Add(new ExportHelper.ExportColumnDTO
                {
                    ...
                    Format = "",
                    ExcelFormat = @"",
                    Caption = BaseViewPage<object>.GetResourceValue("AdminTransactionsList", "RES_LIST_ListNoDT_COLUMN_ImportedBuyer.Company")
                });
                recordDTO.Columns.Add(new ExportHelper.ExportColumnDTO
                {
                    ...
                    Caption = BaseViewPage<object>.GetResourceValue("AdminTransactionsList", "RES_LIST_ListNoDT_COLUMN_TransactionDateOccured")
                });
                recordDTO.Columns.Add(new ExportHelper.ExportColumnDTO
                {
                    ...
                    Caption = BaseViewPage<object>.GetResourceValue("AdminTransactionsList", "RES_LIST_ListNoDT_COLUMN_TransactionValue")
                });
                recordDTO.Columns.Add(new ExportHelper.ExportColumnDTO
                {
                    ...
                    Format = "",
                    ExcelFormat = @"",
                    Caption = BaseViewPage<object>.GetResourceValue("AdminTransactionsList", "RES_LIST_ListNoDT_COLUMN_TransactionStatus.Status")
                });
            ...
            return FileHelper.PendingDownloadInstance.Add("AdminTransactionsList", content, fileName);
        }
        ...
        public string ListNoDT_ExportV2Implementation(DatasourceRequest datasourceRequest, ExportOptionsV2 exportOptions, List<AggregatorInfo<DSS5_SupplyChainFinancialsOptimisation.BO.Transaction>> aggregatorsInfo)
        {
            ...
            if (exportHelper.Options.ColumnInfo == null)
            {
                ...
                {
                    new ColumnOptionsV2 { Caption = BaseViewPage<object>.GetResourceValue("AdminTransactionsList", "RES_LIST_ListNoDT_COLUMN_Id"), Formatting = "", Name = "Id", ExcelFormat = @"" },
                    new ColumnOptionsV2 { Caption = BaseViewPage<object>.GetResourceValue("AdminTransactionsList", "RES_LIST_ListNoDT_COLUMN_Supplier.Company"), Formatting = "", Name = "Supplier.Company", ExcelFormat = @"" },
                    new ColumnOptionsV2 { Caption = BaseViewPage<object>.GetResourceValue("AdminTransactionsList", "RES_LIST_ListNoDT_COLUMN_ImportedBuyer.Company"), Formatting = "", Name = "ImportedBuyer.Company", ExcelFormat = @"" },
                    new ColumnOptionsV2 { Caption = BaseViewPage<object>.GetResourceValue("AdminTransactionsList", "RES_LIST_ListNoDT_COLUMN_TransactionDateOccured"), Formatting = "dd/MM/yyyy", Name = "TransactionDateOccured", ExcelFormat = @"dd/MM/yyyy" },
                    new ColumnOptionsV2 { Caption = BaseViewPage<object>.GetResourceValue("AdminTransactionsList", "RES_LIST_ListNoDT_COLUMN_TransactionValue"), Formatting = "#,0.00;'-'#,0.00;'0'", Name = "TransactionValue", ExcelFormat = @"#,##0.00;-#,##0.00;#,##0.00" },
                    new ColumnOptionsV2 { Caption = BaseViewPage<object>.GetResourceValue("AdminTransactionsList", "RES_LIST_ListNoDT_COLUMN_TransactionStatus.Status"), Formatting = "", Name = "TransactionStatus.Status", ExcelFormat = @"" },
            ...
            var content = System.IO.File.ReadAllBytes(Path.Combine(Path.GetTempPath(), path));
            var fileName = Path.GetFileName(path);
            var downloadKey = FileHelper.PendingDownloadInstance.Add("AdminTransactionsList", content, fileName);
        ...
        /*<Datasource:AdminTransactionsList_TransactionDataSet:1/>*/
        /*<DataSourceFilter:AdminTransactionsList_TransactionDataSet:2/>*/
        public IQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.Transaction> Get_AdminTransactionsList_TransactionDataSet_DatasourceQueryable(DatasourceRequest __request = null, bool shouldEvict = true)
        {
            __request = __request ?? new DatasourceRequest(0, int.MaxValue);
            if (shouldEvict)
            {
            ...
            var __items = Get_AdminTransactionsList_TransactionDataSet_DatasourceQueryableImplementation(__request);
            return __items;
        }
        public IQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.Transaction> Get_AdminTransactionsList_TransactionDataSet_DatasourceQueryableImplementation(DatasourceRequest __request = null, bool shouldEvict = true)
        {
            __request = __request ?? new DatasourceRequest(0, int.MaxValue);
            var __items = new DSS5_SupplyChainFinancialsOptimisation.DAL.Repository().GetAsQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.Transaction>().AsQueryable();
            return __items.Where(@this => true);
        ...
        /*<DataSourceGetFullRecordset:AdminTransactionsList_TransactionDataSet:1/>*/

        [HttpPost]
        [Route("AdminTransactionsList_TransactionDataSet_GetFullRecordset")]
        [CustomControllerActionFilter(HasDefaultResultView=true, ActionName = "TransactionDataSet", ClaimType = ClaimTypes.Dataset)]
        public JsonResult AdminTransactionsList_TransactionDataSet_GetFullRecordset()
        {
            var postedData = _ParsePostedData();
            var dataType = postedData["dataType"].ToString();
            var keysToExclude = postedData["keys"] == null
            ...
            _LoadViewModel();
            var datasourceRequest = new DatasourceRequest(0, 2147483647, postedDatasourceRequest.Filters, null, keysToExclude, indexes);
            var queryable = Get_AdminTransactionsList_TransactionDataSet_DatasourceQueryable(datasourceRequest);
            var items = DatasourceRetriever.ApplyDynamicFilterToQueryable(datasourceRequest, queryable);
            //The following method of creating DTO responses has been changed due to the fact that the returned objects were missing properties that were not used by the client.
            //It now uses the UpdateInstance method. To be removed after some testing if no problems occur.
            //var data = items.Select(i => new TransactionDataSet_TransactionDTO(i, true)).ToList();
            var data = CreateDtoInstancesFromKeys(typeof(AdminTransactionsListViewModel), dataType, items.Select(i => i.Id.ToString()).ToList(), "AdminTransactionsList_TransactionDataSet");
            var __result = Json(new
            {
                Type = "UpdateInstance",Data = Utilities.Serialize(data)
            }, JsonRequestBehavior.AllowGet);
        ...
        /*<DataSourceEntryPoint:AdminTransactionsList_TransactionDataSet:1/>*/

        [HttpPost]
        [CustomControllerActionFilter(HasDefaultResultView=true, ActionName = "TransactionDataSet", ClaimType = ClaimTypes.Dataset)]
        [Route("AdminTransactionsList_TransactionDataSet_Datasource")]
        public JsonResult AdminTransactionsList_TransactionDataSet_Datasource()
        {
            var postedData = _LoadViewModel();
            var datasourceRequest = DeserializeDatasourceRequest(postedData["datasourceRequest"].ToString());
            var queryable = Get_AdminTransactionsList_TransactionDataSet_DatasourceQueryable(datasourceRequest);
            ...
            //Total items count
            if (CLMS.AppDev.Cache.CacheManager.Current.HasKey($"{Request.RequestContext.HttpContext.Session.SessionID}_AdminTransactionsList_TransactionDataSet_TotalItems"))
            {
                CLMS.AppDev.Cache.CacheManager.Current.Set($"{Request.RequestContext.HttpContext.Session.SessionID}_AdminTransactionsList_TransactionDataSet_TotalItems", response.TotalRows);
            }
            else
            {
                CLMS.AppDev.Cache.CacheManager.Current.Add($"{Request.RequestContext.HttpContext.Session.SessionID}_AdminTransactionsList_TransactionDataSet_TotalItems", response.TotalRows);
            }
            if (response.TotalRows < datasourceRequest.StartRow + 1)
            {
                datasourceRequest.StartRow = 0;
...
//Fix for total items in GetGroupsClosed
        ...
        public override ActionResult PostActionFilterHook(bool hasDefaultResultView, bool fillDropDownInitialValues = false)
        {
            ...
            {
                var _modelDTO = new AdminTransactionsListViewModelDTO(@model);
            ...
            return View("AdminTransactionsList");
        }
        ...
        private ActionResult GetFailedDataValidationsResult()
        {
            ...
            catch (Exception e)
            {
                ...
                log4net.LogManager.GetLogger(this.GetType()).Error("Form: AdminTransactionsList, Action: " + System.Web.HttpContext.Current.Items["_currentControllerAction"], e);
                //throw;
                return null;
            }
        }
