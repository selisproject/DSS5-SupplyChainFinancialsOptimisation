...
using DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.PendingValidatedSuppliersList;
...
namespace DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.PendingValidatedSuppliersList
{

    [RoutePrefix("PendingValidatedSuppliersList")]
    public class PendingValidatedSuppliersListController : ControllerBase<PendingValidatedSuppliersListViewModel, PendingValidatedSuppliersListViewModelDTO>
    {

        /*<Form:PendingValidatedSuppliersList:0/>*/
        public PendingValidatedSuppliersListController()
        {
            _logger = log4net.LogManager.GetLogger(typeof(PendingValidatedSuppliersListController));
        ...
        public void SetModel(PendingValidatedSuppliersListViewModel m)
        {
            @model = m;
        }
        ...
        {
            return PrepareUpdateInstanceResult(typeof(PendingValidatedSuppliersListViewModel));
        }
        ...
        {
            return FileHelper.PendingDownloadInstance.DownloadByKey("PendingValidatedSuppliersList", id);
        }
        ...
        public JsonResult SaveListView()
        {
            ...
            return SaveListView(postedData, "PendingValidatedSuppliersList");
        }
        ...
        {
            var postedData = _ParsePostedData();
            return DeleteListView(postedData, "PendingValidatedSuppliersList");
        }
        ...
        {
            var postedData = _ParsePostedData();
            return LoadListViews(postedData, "PendingValidatedSuppliersList");
        }
        ...
        {
            @model = new PendingValidatedSuppliersListViewModel();
            System.Web.HttpContext.Current.Session["LastEntryPoint_PendingValidatedSuppliersList"] = "Retrieve";
            return null;
        }
        ...
        [CustomControllerActionFilter(CausesValidation=true, ActionName="ValidateSupplier", ClaimType = ClaimTypes.ControllerAction)]
        [HttpPost]
        [Route("ValidateSupplier")]
        public ActionResult ValidateSupplier(string username)

        {
            ...
            var redirectInfo = ExecuteValidateSupplier(username);
            return redirectInfo;
        }
        ...
        /*<ControllerActionImplementation:ValidateSupplier:1/>*/
        public ActionResult ExecuteValidateSupplier(string username)
        {
            ActionResult _result = null;
            ...
            supplier.Roles = new DSS5_SupplyChainFinancialsOptimisation.DAL.Repository().Get<zAppDev.DotNet.Framework.Identity.Model.ApplicationRole>((a) => a.Name == "ValidatedSupplier").ToList();
            zAppDev.DotNet.Framework.Utilities.DebugHelper.Log(zAppDev.DotNet.Framework.Utilities.DebugMessageType.Info, "PendingValidatedSuppliersList",  DSS5_SupplyChainFinancialsOptimisation.Hubs.EventsHub.RaiseDebugMessage, "Supplier Role: " + (supplier?.Roles?.FirstOrDefault()?.Name ?? ""));
            supplier.SupplierStatus = "ValidatedSupplier";
            ...
            ClientCommand(ClientCommands.SHOW_MESSAGE, "Supplier " + (supplier?.UserName ?? "") + " is now Validated");
            zAppDev.DotNet.Framework.Utilities.EMailMessage email = new zAppDev.DotNet.Framework.Utilities.EMailMessage();
            email.To = new List<string> { (supplier?.Email ?? "") } .ToList();
            email.Subject = "Account Validation";
            email.IsBodyHtml = true;
            email.Body = "Your account has been validated from the TOME FINANCE ® Administrator. " + "Please continue to see, which Investor is available for you to collaborate with, check their profiles and contact them.";
        ...
        public IQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.Supplier> Get_SupplierListNoDT_DatasourceQueryableImplementation(DatasourceRequest __request = null, bool shouldEvict = true)
        {
            ...
            return __items.Where(@this => @this.SupplierStatus == "PendingValidated");
        }
        ...
        public JsonResult SupplierListNoDT_GetFullRecordset()
        {
            ...
            var data = CreateDtoInstancesFromKeys(typeof(PendingValidatedSuppliersListViewModel), dataType, items.Select(i => i.UserName.ToString()).ToList(), "SupplierListNoDT");
...
//Fix for total items in GetGroupsClosed
        ...
        public string SupplierListNoDT_ExportImplementation(DatasourceRequest datasourceRequest, ExportHelper.ExportOptions exportOptions, List<AggregatorInfo<DSS5_SupplyChainFinancialsOptimisation.BO.Supplier>> aggregatorsInfo)
        {
            ...
            if (exportOptions.ColumnOptions == null)
            {
                exportOptions.ColumnOptions = new List<ExportHelper.ColumnOptions>
                {
                    ...
                    new ExportHelper.ColumnOptions { Column = "AcceptedPolicyTerms", IsVisible = true },
            ...
            foreach (var record in dto)
            {
                ...
                recordDTO.Columns.Add(new ExportHelper.ExportColumnDTO
                {
                    ...
                    Format = "",
                    ExcelFormat = @"",
                    Caption = BaseViewPage<object>.GetResourceValue("PendingValidatedSuppliersList", "RES_LIST_SupplierListNoDT_COLUMN_UserName")
                });
                recordDTO.Columns.Add(new ExportHelper.ExportColumnDTO
                {
                    ...
                    Format = "",
                    ExcelFormat = @"",
                    Caption = BaseViewPage<object>.GetResourceValue("PendingValidatedSuppliersList", "RES_LIST_SupplierListNoDT_COLUMN_Company")
                });
                recordDTO.Columns.Add(new ExportHelper.ExportColumnDTO
                {
                    ...
                    Format = "",
                    ExcelFormat = @"",
                    Caption = BaseViewPage<object>.GetResourceValue("PendingValidatedSuppliersList", "RES_LIST_SupplierListNoDT_COLUMN_Email")
                });
                recordDTO.Columns.Add(new ExportHelper.ExportColumnDTO
                {
                    ...
                    Format = "",
                    ExcelFormat = @"",
                    Caption = BaseViewPage<object>.GetResourceValue("PendingValidatedSuppliersList", "RES_LIST_SupplierListNoDT_COLUMN_Business")
                });
                recordDTO.Columns.Add(new ExportHelper.ExportColumnDTO
                {
                    ...
                    Format = "",
                    ExcelFormat = @"",
                    Caption = BaseViewPage<object>.GetResourceValue("PendingValidatedSuppliersList", "RES_LIST_SupplierListNoDT_COLUMN_AcceptedPolicyTerms")
                });
                recordDTO.Columns.Add(new ExportHelper.ExportColumnDTO
                {
                    ...
                    Format = "",
                    ExcelFormat = @"",
                    Caption = BaseViewPage<object>.GetResourceValue("PendingValidatedSuppliersList", "RES_LIST_SupplierListNoDT_COLUMN_SupplierStatus")
                });
            ...
            return FileHelper.PendingDownloadInstance.Add("PendingValidatedSuppliersList", content, fileName);
        }
        ...
        public string SupplierListNoDT_ExportV2Implementation(DatasourceRequest datasourceRequest, ExportOptionsV2 exportOptions, List<AggregatorInfo<DSS5_SupplyChainFinancialsOptimisation.BO.Supplier>> aggregatorsInfo)
        {
            ...
            {
                {"UserName" , item => item?.UserName }, {"Company" , item => item?.Company }, {"Email" , item => item?.Email }, {"Business" , item => item?.Business }, {"AcceptedPolicyTerms" , item => item?.AcceptedPolicyTerms }, {"SupplierStatus" , item => item?.SupplierStatus },
            });
            if (exportHelper.Options.ColumnInfo == null)
            {
                exportHelper.Options.ColumnInfo = new List<ColumnOptionsV2>
                {
                    new ColumnOptionsV2 { Caption = BaseViewPage<object>.GetResourceValue("PendingValidatedSuppliersList", "RES_LIST_SupplierListNoDT_COLUMN_UserName"), Formatting = "", Name = "UserName", ExcelFormat = @"" },
                    new ColumnOptionsV2 { Caption = BaseViewPage<object>.GetResourceValue("PendingValidatedSuppliersList", "RES_LIST_SupplierListNoDT_COLUMN_Company"), Formatting = "", Name = "Company", ExcelFormat = @"" },
                    new ColumnOptionsV2 { Caption = BaseViewPage<object>.GetResourceValue("PendingValidatedSuppliersList", "RES_LIST_SupplierListNoDT_COLUMN_Email"), Formatting = "", Name = "Email", ExcelFormat = @"" },
                    new ColumnOptionsV2 { Caption = BaseViewPage<object>.GetResourceValue("PendingValidatedSuppliersList", "RES_LIST_SupplierListNoDT_COLUMN_Business"), Formatting = "", Name = "Business", ExcelFormat = @"" },
                    new ColumnOptionsV2 { Caption = BaseViewPage<object>.GetResourceValue("PendingValidatedSuppliersList", "RES_LIST_SupplierListNoDT_COLUMN_AcceptedPolicyTerms"), Formatting = "", Name = "AcceptedPolicyTerms", ExcelFormat = @"" },
                    new ColumnOptionsV2 { Caption = BaseViewPage<object>.GetResourceValue("PendingValidatedSuppliersList", "RES_LIST_SupplierListNoDT_COLUMN_SupplierStatus"), Formatting = "", Name = "SupplierStatus", ExcelFormat = @"" },
            ...
            var content = System.IO.File.ReadAllBytes(Path.Combine(Path.GetTempPath(), path));
            var fileName = Path.GetFileName(path);
            var downloadKey = FileHelper.PendingDownloadInstance.Add("PendingValidatedSuppliersList", content, fileName);
        ...
        /*<Datasource:PendingValidatedSuppliersList_SupplierDataSet:1/>*/
        /*<DataSourceFilter:PendingValidatedSuppliersList_SupplierDataSet:2/>*/
        public IQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.Supplier> Get_PendingValidatedSuppliersList_SupplierDataSet_DatasourceQueryable(DatasourceRequest __request = null, bool shouldEvict = true)
        {
            __request = __request ?? new DatasourceRequest(0, int.MaxValue);
            if (shouldEvict)
            {
            ...
            var __items = Get_PendingValidatedSuppliersList_SupplierDataSet_DatasourceQueryableImplementation(__request);
            return __items;
        }
        public IQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.Supplier> Get_PendingValidatedSuppliersList_SupplierDataSet_DatasourceQueryableImplementation(DatasourceRequest __request = null, bool shouldEvict = true)
        {
            __request = __request ?? new DatasourceRequest(0, int.MaxValue);
            var __items = new DSS5_SupplyChainFinancialsOptimisation.DAL.Repository().GetAsQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.Supplier>().AsQueryable();
            return __items.Where(@this => @this.SupplierStatus == "PendingValidated");
        ...
        /*<DataSourceGetFullRecordset:PendingValidatedSuppliersList_SupplierDataSet:1/>*/

        [HttpPost]
        [Route("PendingValidatedSuppliersList_SupplierDataSet_GetFullRecordset")]
        [CustomControllerActionFilter(HasDefaultResultView=true, ActionName = "SupplierDataSet", ClaimType = ClaimTypes.Dataset)]
        public JsonResult PendingValidatedSuppliersList_SupplierDataSet_GetFullRecordset()
        {
            var postedData = _ParsePostedData();
            var dataType = postedData["dataType"].ToString();
            var keysToExclude = postedData["keys"] == null
            ...
            _LoadViewModel();
            var datasourceRequest = new DatasourceRequest(0, 2147483647, postedDatasourceRequest.Filters, null, keysToExclude, indexes);
            var queryable = Get_PendingValidatedSuppliersList_SupplierDataSet_DatasourceQueryable(datasourceRequest);
            var items = DatasourceRetriever.ApplyDynamicFilterToQueryable(datasourceRequest, queryable);
            //The following method of creating DTO responses has been changed due to the fact that the returned objects were missing properties that were not used by the client.
            //It now uses the UpdateInstance method. To be removed after some testing if no problems occur.
            //var data = items.Select(i => new SupplierDataSet_SupplierDTO(i, true)).ToList();
            var data = CreateDtoInstancesFromKeys(typeof(PendingValidatedSuppliersListViewModel), dataType, items.Select(i => i.UserName.ToString()).ToList(), "PendingValidatedSuppliersList_SupplierDataSet");
            var __result = Json(new
            {
                Type = "UpdateInstance",Data = Utilities.Serialize(data)
            }, JsonRequestBehavior.AllowGet);
        ...
        /*<DataSourceEntryPoint:PendingValidatedSuppliersList_SupplierDataSet:1/>*/

        [HttpPost]
        [CustomControllerActionFilter(HasDefaultResultView=true, ActionName = "SupplierDataSet", ClaimType = ClaimTypes.Dataset)]
        [Route("PendingValidatedSuppliersList_SupplierDataSet_Datasource")]
        public JsonResult PendingValidatedSuppliersList_SupplierDataSet_Datasource()
        {
            var postedData = _LoadViewModel();
            var datasourceRequest = DeserializeDatasourceRequest(postedData["datasourceRequest"].ToString());
            var queryable = Get_PendingValidatedSuppliersList_SupplierDataSet_DatasourceQueryable(datasourceRequest);
            ...
            //Total items count
            if (CLMS.AppDev.Cache.CacheManager.Current.HasKey($"{Request.RequestContext.HttpContext.Session.SessionID}_PendingValidatedSuppliersList_SupplierDataSet_TotalItems"))
            {
                CLMS.AppDev.Cache.CacheManager.Current.Set($"{Request.RequestContext.HttpContext.Session.SessionID}_PendingValidatedSuppliersList_SupplierDataSet_TotalItems", response.TotalRows);
            }
            else
            {
                CLMS.AppDev.Cache.CacheManager.Current.Add($"{Request.RequestContext.HttpContext.Session.SessionID}_PendingValidatedSuppliersList_SupplierDataSet_TotalItems", response.TotalRows);
            }
            if (response.TotalRows < datasourceRequest.StartRow + 1)
            {
                datasourceRequest.StartRow = 0;
...
//Fix for total items in GetGroupsClosed
        ...
        public override ActionResult PostActionFilterHook(bool hasDefaultResultView, bool fillDropDownInitialValues = false)
        {
            ...
            {
                var _modelDTO = new PendingValidatedSuppliersListViewModelDTO(@model);
            ...
            return View("PendingValidatedSuppliersList");
        }
        ...
        private ActionResult GetFailedDataValidationsResult()
        {
            ...
            catch (Exception e)
            {
                ...
                log4net.LogManager.GetLogger(this.GetType()).Error("Form: PendingValidatedSuppliersList, Action: " + System.Web.HttpContext.Current.Items["_currentControllerAction"], e);
                //throw;
                return null;
            }
        }
