...
using DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.UserSettingsForm;
...
namespace DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.UserSettingsForm
{

    [RoutePrefix("UserSettingsForm")]
    public class UserSettingsFormController : ControllerBase<UserSettingsFormViewModel, UserSettingsFormViewModelDTO>
    {

        /*<Form:UserSettingsForm:0/>*/
        public UserSettingsFormController()
        {
            _logger = log4net.LogManager.GetLogger(typeof(UserSettingsFormController));
        ...
        public void SetModel(UserSettingsFormViewModel m)
        {
            @model = m;
        }
        ...
        {
            return PrepareUpdateInstanceResult(typeof(UserSettingsFormViewModel));
        }
        ...
        {
            @model = new UserSettingsFormViewModel();
            System.Web.HttpContext.Current.Session["LastEntryPoint_UserSettingsForm"] = "Render";
            return null;
        }
        ...
        public override ActionResult PostActionFilterHook(bool hasDefaultResultView, bool fillDropDownInitialValues = false)
        {
            ...
            {
                var _modelDTO = new UserSettingsFormViewModelDTO(@model);
        ...
        private ActionResult GetFailedDataValidationsResult()
        {
            ...
            catch (Exception e)
            {
                ...
                log4net.LogManager.GetLogger(this.GetType()).Error("Form: UserSettingsForm, Action: " + System.Web.HttpContext.Current.Items["_currentControllerAction"], e);
                //throw;
                return null;
            }
        }
