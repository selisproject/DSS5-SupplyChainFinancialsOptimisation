...
using DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.InvestorInvoicesList;
...
namespace DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.InvestorInvoicesList
{

    [RoutePrefix("InvestorInvoicesList")]
    public class InvestorInvoicesListController : ControllerBase<InvestorInvoicesListViewModel, InvestorInvoicesListViewModelDTO>
    {

        /*<Form:InvestorInvoicesList:0/>*/
        public InvestorInvoicesListController()
        {
            _logger = log4net.LogManager.GetLogger(typeof(InvestorInvoicesListController));
        ...
        public void SetModel(InvestorInvoicesListViewModel m)
        {
            @model = m;
        }
        ...
        {
            return PrepareUpdateInstanceResult(typeof(InvestorInvoicesListViewModel));
        }
        ...
        {
            return FileHelper.PendingDownloadInstance.DownloadByKey("InvestorInvoicesList", id);
        }
        ...
        public JsonResult SaveListView()
        {
            ...
            return SaveListView(postedData, "InvestorInvoicesList");
        }
        ...
        {
            var postedData = _ParsePostedData();
            return DeleteListView(postedData, "InvestorInvoicesList");
        }
        ...
        {
            var postedData = _ParsePostedData();
            return LoadListViews(postedData, "InvestorInvoicesList");
        }
        ...
        {
            @model = new InvestorInvoicesListViewModel();
            System.Web.HttpContext.Current.Session["LastEntryPoint_InvestorInvoicesList"] = "Retrieve";
            return null;
        }
        ...
        {
            ActionResult _result = null;
            foreach (var selectedInvoice in SelectedItemInfo<DSS5_SupplyChainFinancialsOptimisation.BO.Invoice>.GetSelectedItems(Get_ListNoDT_DatasourceQueryable(null, false), @model.ListNoDTSelectedItems) ?? Enumerable.Empty<DSS5_SupplyChainFinancialsOptimisation.BO.Invoice>())
            {
        ...
        public IQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.Invoice> Get_ListNoDT_DatasourceQueryable(DatasourceRequest __request = null, bool shouldEvict = true)
        {
        ...
        public IQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.Invoice> Get_ListNoDT_DatasourceQueryableImplementation(DatasourceRequest __request = null, bool shouldEvict = true)
        {
            __request = __request ?? new DatasourceRequest(0, int.MaxValue);
        ...
        public JsonResult ListNoDT_GetFullRecordset()
        {
            ...
            var data = CreateDtoInstancesFromKeys(typeof(InvestorInvoicesListViewModel), dataType, items.Select(i => i.Id.ToString()).ToList(), "ListNoDT");
...
//Fix for total items in GetGroupsClosed
        ...
        /*<Datasource:InvestorInvoicesList_InvoiceDataSet:1/>*/
        /*<DataSourceFilter:InvestorInvoicesList_InvoiceDataSet:2/>*/
        public IQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.Invoice> Get_InvestorInvoicesList_InvoiceDataSet_DatasourceQueryable(DatasourceRequest __request = null, bool shouldEvict = true)
        {
            __request = __request ?? new DatasourceRequest(0, int.MaxValue);
            if (shouldEvict)
            {
            ...
            var __items = Get_InvestorInvoicesList_InvoiceDataSet_DatasourceQueryableImplementation(__request);
            return __items;
        }
        public IQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.Invoice> Get_InvestorInvoicesList_InvoiceDataSet_DatasourceQueryableImplementation(DatasourceRequest __request = null, bool shouldEvict = true)
        {
            __request = __request ?? new DatasourceRequest(0, int.MaxValue);
            var __items = DSS5_SupplyChainFinancialsOptimisation.BO.InvoiceExtensions.FindAgreement().AsQueryable();
            return __items.Where(@this => @this.Transaction.Supplier.Roles.Any((a) => a.Name == "ActiveSupplier"));
        ...
        /*<DataSourceGetFullRecordset:InvestorInvoicesList_InvoiceDataSet:1/>*/

        [HttpPost]
        [Route("InvestorInvoicesList_InvoiceDataSet_GetFullRecordset")]
        [CustomControllerActionFilter(HasDefaultResultView=true, ActionName = "InvoiceDataSet", ClaimType = ClaimTypes.Dataset)]
        public JsonResult InvestorInvoicesList_InvoiceDataSet_GetFullRecordset()
        {
            var postedData = _ParsePostedData();
            var dataType = postedData["dataType"].ToString();
            var keysToExclude = postedData["keys"] == null
            ...
            _LoadViewModel();
            var datasourceRequest = new DatasourceRequest(0, 2147483647, postedDatasourceRequest.Filters, null, keysToExclude, indexes);
            var queryable = Get_InvestorInvoicesList_InvoiceDataSet_DatasourceQueryable(datasourceRequest);
            var items = DatasourceRetriever.ApplyDynamicFilterToQueryable(datasourceRequest, queryable);
            //The following method of creating DTO responses has been changed due to the fact that the returned objects were missing properties that were not used by the client.
            //It now uses the UpdateInstance method. To be removed after some testing if no problems occur.
            //var data = items.Select(i => new InvoiceDataSet_InvoiceDTO(i, true)).ToList();
            var data = CreateDtoInstancesFromKeys(typeof(InvestorInvoicesListViewModel), dataType, items.Select(i => i.Id.ToString()).ToList(), "InvestorInvoicesList_InvoiceDataSet");
            var __result = Json(new
            {
                Type = "UpdateInstance",Data = Utilities.Serialize(data)
            }, JsonRequestBehavior.AllowGet);
        ...
        /*<DataSourceEntryPoint:InvestorInvoicesList_InvoiceDataSet:1/>*/

        [HttpPost]
        [CustomControllerActionFilter(HasDefaultResultView=true, ActionName = "InvoiceDataSet", ClaimType = ClaimTypes.Dataset)]
        [Route("InvestorInvoicesList_InvoiceDataSet_Datasource")]
        public JsonResult InvestorInvoicesList_InvoiceDataSet_Datasource()
        {
            var postedData = _LoadViewModel();
            var datasourceRequest = DeserializeDatasourceRequest(postedData["datasourceRequest"].ToString());
            var queryable = Get_InvestorInvoicesList_InvoiceDataSet_DatasourceQueryable(datasourceRequest);
            ...
            //Total items count
            if (CLMS.AppDev.Cache.CacheManager.Current.HasKey($"{Request.RequestContext.HttpContext.Session.SessionID}_InvestorInvoicesList_InvoiceDataSet_TotalItems"))
            {
                CLMS.AppDev.Cache.CacheManager.Current.Set($"{Request.RequestContext.HttpContext.Session.SessionID}_InvestorInvoicesList_InvoiceDataSet_TotalItems", response.TotalRows);
            }
            else
            {
                CLMS.AppDev.Cache.CacheManager.Current.Add($"{Request.RequestContext.HttpContext.Session.SessionID}_InvestorInvoicesList_InvoiceDataSet_TotalItems", response.TotalRows);
            }
            if (response.TotalRows < datasourceRequest.StartRow + 1)
            {
                datasourceRequest.StartRow = 0;
...
//Fix for total items in GetGroupsClosed
        ...
        public override ActionResult PostActionFilterHook(bool hasDefaultResultView, bool fillDropDownInitialValues = false)
        {
            ...
            {
                var _modelDTO = new InvestorInvoicesListViewModelDTO(@model);
            ...
            return View("InvestorInvoicesList");
        }
        ...
        private ActionResult GetFailedDataValidationsResult()
        {
            ...
            catch (Exception e)
            {
                ...
                log4net.LogManager.GetLogger(this.GetType()).Error("Form: InvestorInvoicesList, Action: " + System.Web.HttpContext.Current.Items["_currentControllerAction"], e);
                //throw;
                return null;
            }
        }
