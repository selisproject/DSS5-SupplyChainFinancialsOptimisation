...
using DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.Unauthorized;
...
namespace DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.Unauthorized
{
    ...
    public class UnauthorizedController : ControllerBase<UnauthorizedViewModel, UnauthorizedViewModelDTO>
    {
        ...
        public ActionResult ExecuteRender()
        {
            ...
            @model.Title = BaseViewPage<string>.GetResourceValue("Unauthorized", "RES_PAGETITLE_Render").ToString();
            return _result;
        }
        #endregion
