...
namespace DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.MasterPageSignIn
{

    [RoutePrefix("MasterPageSignIn")]
    public class MasterPageSignInController : ControllerBase<MasterPageSignInViewModel, MasterPageSignInViewModelDTO>
    {
        public MasterPageSignInController()
        {
            _logger = log4net.LogManager.GetLogger(typeof(MasterPageSignInController));
            if (ViewModelDTOBase.DTOHelper == null)
            {
                ViewModelDTOBase.DTOHelper = new DTOHelper();
            }
        }
        public MasterPageSignInController(MasterPageSignInViewModel m) : this()
        {
            model = m;
        }
        ...
        public void SetModel(MasterPageSignInViewModel m)
        {
            @model = m;
        }
        ...
        {
            return PrepareUpdateInstanceResult(typeof(MasterPageSignInViewModel));
        }
        ...
        {
            @model = new MasterPageSignInViewModel();
            return null;
        }
        ...
        public override ActionResult PostActionFilterHook(bool hasDefaultResultView, bool fillDropDownInitialValues = false)
        {
            ...
            {
                var _modelDTO = new MasterPageSignInViewModelDTO(@model);
        ...
        private ActionResult GetFailedDataValidationsResult()
        {
            ...
            catch (Exception e)
            {
                ...
                log4net.LogManager.GetLogger(this.GetType()).Error("Form: MasterPageSignIn, Action: " + System.Web.HttpContext.Current.Items["_currentControllerAction"], e);
                //throw;
                return null;
            }
        }
