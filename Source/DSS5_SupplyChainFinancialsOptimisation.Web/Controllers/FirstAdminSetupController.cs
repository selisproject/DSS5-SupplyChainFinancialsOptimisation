...
using DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.FirstAdminSetup;
...
namespace DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.FirstAdminSetup
{
    ...
    public class FirstAdminSetupController : ControllerBase<FirstAdminSetupViewModel, FirstAdminSetupViewModelDTO>
    {
        ...
        public ActionResult ExecuteRender()
        {
            ...
            if ((zAppDev.DotNet.Framework.Utilities.Common.GetConfigurationKey("FirstAdminSetup") != "true"))
            {
                throw new Exception((BaseViewPage<string>.GetResourceValue("FirstAdminSetup", "RES_CUSTOM_NoAccess").ToString()));
            }
