...
using DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.DeliveryNoteList;
...
namespace DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.DeliveryNoteList
{

    [RoutePrefix("DeliveryNoteList")]
    public class DeliveryNoteListController : ControllerBase<DeliveryNoteListViewModel, DeliveryNoteListViewModelDTO>
    {

        /*<Form:DeliveryNoteList:0/>*/
        public DeliveryNoteListController()
        {
            _logger = log4net.LogManager.GetLogger(typeof(DeliveryNoteListController));
        ...
        public void SetModel(DeliveryNoteListViewModel m)
        {
            @model = m;
        }
        ...
        {
            return PrepareUpdateInstanceResult(typeof(DeliveryNoteListViewModel));
        }
        ...
        {
            return FileHelper.PendingDownloadInstance.DownloadByKey("DeliveryNoteList", id);
        }
        ...
        public JsonResult SaveListView()
        {
            ...
            return SaveListView(postedData, "DeliveryNoteList");
        }
        ...
        {
            var postedData = _ParsePostedData();
            return DeleteListView(postedData, "DeliveryNoteList");
        }
        ...
        {
            var postedData = _ParsePostedData();
            return LoadListViews(postedData, "DeliveryNoteList");
        }
        ...
        {
            @model = new DeliveryNoteListViewModel();
            System.Web.HttpContext.Current.Session["LastEntryPoint_DeliveryNoteList"] = "Retrieve";
            return null;
        }
        ...
        public JsonResult DeliveryNoteListNoDT_GetFullRecordset()
        {
            ...
            var data = CreateDtoInstancesFromKeys(typeof(DeliveryNoteListViewModel), dataType, items.Select(i => i.Id.ToString()).ToList(), "DeliveryNoteListNoDT");
        ...
        public JsonResult DeliveryNoteListNoDT_Datasource()
        {
            ...
            if (datasourceRequest.GroupBy.Any())
            {
                ...
                response.Data = items.Select(i => new DeliveryNoteDataSet_DeliveryNoteDTO(i, true)).ToList();
...
//Fix for total items in GetGroupsClosed
        ...
        public string DeliveryNoteListNoDT_ExportImplementation(DatasourceRequest datasourceRequest, ExportHelper.ExportOptions exportOptions, List<AggregatorInfo<DSS5_SupplyChainFinancialsOptimisation.BO.DeliveryNote>> aggregatorsInfo)
        {
            ...
            foreach (var record in dto)
            {
                ...
                recordDTO.Columns.Add(new ExportHelper.ExportColumnDTO
                {
                    ...
                    Format = "",
                    ExcelFormat = @"",
                    Caption = BaseViewPage<object>.GetResourceValue("DeliveryNoteList", "RES_LIST_DeliveryNoteListNoDT_COLUMN_Transaction.Id")
                });
                recordDTO.Columns.Add(new ExportHelper.ExportColumnDTO
                {
                    ...
                    Format = "",
                    ExcelFormat = @"",
                    Caption = BaseViewPage<object>.GetResourceValue("DeliveryNoteList", "RES_LIST_DeliveryNoteListNoDT_COLUMN_DeliveryNoteNumber")
                });
                recordDTO.Columns.Add(new ExportHelper.ExportColumnDTO
                {
                    ...
                    Format = "",
                    ExcelFormat = @"",
                    Caption = BaseViewPage<object>.GetResourceValue("DeliveryNoteList", "RES_LIST_DeliveryNoteListNoDT_COLUMN_Description")
                });
                recordDTO.Columns.Add(new ExportHelper.ExportColumnDTO
                {
                    ...
                    Caption = BaseViewPage<object>.GetResourceValue("DeliveryNoteList", "RES_LIST_DeliveryNoteListNoDT_COLUMN_DateIssued")
                });
                recordDTO.Columns.Add(new ExportHelper.ExportColumnDTO
                {
                    ...
                    Caption = BaseViewPage<object>.GetResourceValue("DeliveryNoteList", "RES_LIST_DeliveryNoteListNoDT_COLUMN_Amount")
                });
            ...
            return FileHelper.PendingDownloadInstance.Add("DeliveryNoteList", content, fileName);
        }
        ...
        public string DeliveryNoteListNoDT_ExportV2Implementation(DatasourceRequest datasourceRequest, ExportOptionsV2 exportOptions, List<AggregatorInfo<DSS5_SupplyChainFinancialsOptimisation.BO.DeliveryNote>> aggregatorsInfo)
        {
            ...
            {
                {"Transaction.Id" , item => item?.Transaction?.Id }, {"DeliveryNoteNumber" , item => item?.DeliveryNoteNumber }, {"Description" , item => item?.Description }, {"DateIssued" , item => item?.DateIssued }, {"Amount" , item => item?.Amount },
            });
            if (exportHelper.Options.ColumnInfo == null)
            {
                exportHelper.Options.ColumnInfo = new List<ColumnOptionsV2>
                {
                    new ColumnOptionsV2 { Caption = BaseViewPage<object>.GetResourceValue("DeliveryNoteList", "RES_LIST_DeliveryNoteListNoDT_COLUMN_Transaction.Id"), Formatting = "", Name = "Transaction.Id", ExcelFormat = @"" },
                    new ColumnOptionsV2 { Caption = BaseViewPage<object>.GetResourceValue("DeliveryNoteList", "RES_LIST_DeliveryNoteListNoDT_COLUMN_DeliveryNoteNumber"), Formatting = "", Name = "DeliveryNoteNumber", ExcelFormat = @"" },
                    new ColumnOptionsV2 { Caption = BaseViewPage<object>.GetResourceValue("DeliveryNoteList", "RES_LIST_DeliveryNoteListNoDT_COLUMN_Description"), Formatting = "", Name = "Description", ExcelFormat = @"" },
                    new ColumnOptionsV2 { Caption = BaseViewPage<object>.GetResourceValue("DeliveryNoteList", "RES_LIST_DeliveryNoteListNoDT_COLUMN_DateIssued"), Formatting = "dd/MM/yyyy", Name = "DateIssued", ExcelFormat = @"dd/MM/yyyy" },
                    new ColumnOptionsV2 { Caption = BaseViewPage<object>.GetResourceValue("DeliveryNoteList", "RES_LIST_DeliveryNoteListNoDT_COLUMN_Amount"), Formatting = "#,0.00;'-'#,0.00;'0'", Name = "Amount", ExcelFormat = @"#,##0.00;-#,##0.00;#,##0.00" },
            ...
            var content = System.IO.File.ReadAllBytes(Path.Combine(Path.GetTempPath(), path));
            var fileName = Path.GetFileName(path);
            var downloadKey = FileHelper.PendingDownloadInstance.Add("DeliveryNoteList", content, fileName);
        ...
        /*<Datasource:DeliveryNoteList_DeliveryNoteDataSet:1/>*/
        /*<DataSourceFilter:DeliveryNoteList_DeliveryNoteDataSet:2/>*/
        public IQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.DeliveryNote> Get_DeliveryNoteList_DeliveryNoteDataSet_DatasourceQueryable(DatasourceRequest __request = null, bool shouldEvict = true)
        {
            __request = __request ?? new DatasourceRequest(0, int.MaxValue);
            if (shouldEvict)
            {
            ...
            var __items = Get_DeliveryNoteList_DeliveryNoteDataSet_DatasourceQueryableImplementation(__request);
            return __items;
        }
        public IQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.DeliveryNote> Get_DeliveryNoteList_DeliveryNoteDataSet_DatasourceQueryableImplementation(DatasourceRequest __request = null, bool shouldEvict = true)
        {
            __request = __request ?? new DatasourceRequest(0, int.MaxValue);
            var __items = new DSS5_SupplyChainFinancialsOptimisation.DAL.Repository().GetAsQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.DeliveryNote>().AsQueryable();
            var _var0 = zAppDev.DotNet.Framework.Identity.IdentityHelper.GetCurrentUserName();
        ...
        /*<DataSourceGetFullRecordset:DeliveryNoteList_DeliveryNoteDataSet:1/>*/

        [HttpPost]
        [Route("DeliveryNoteList_DeliveryNoteDataSet_GetFullRecordset")]
        [CustomControllerActionFilter(HasDefaultResultView=true, ActionName = "DeliveryNoteDataSet", ClaimType = ClaimTypes.Dataset)]
        public JsonResult DeliveryNoteList_DeliveryNoteDataSet_GetFullRecordset()
        {
            var postedData = _ParsePostedData();
            var dataType = postedData["dataType"].ToString();
            var keysToExclude = postedData["keys"] == null
            ...
            _LoadViewModel();
            var datasourceRequest = new DatasourceRequest(0, 2147483647, postedDatasourceRequest.Filters, null, keysToExclude, indexes);
            var queryable = Get_DeliveryNoteList_DeliveryNoteDataSet_DatasourceQueryable(datasourceRequest);
            var items = DatasourceRetriever.ApplyDynamicFilterToQueryable(datasourceRequest, queryable);
            //The following method of creating DTO responses has been changed due to the fact that the returned objects were missing properties that were not used by the client.
            //It now uses the UpdateInstance method. To be removed after some testing if no problems occur.
            //var data = items.Select(i => new DeliveryNoteDataSet_DeliveryNoteDTO(i, true)).ToList();
            var data = CreateDtoInstancesFromKeys(typeof(DeliveryNoteListViewModel), dataType, items.Select(i => i.Id.ToString()).ToList(), "DeliveryNoteList_DeliveryNoteDataSet");
            var __result = Json(new
            {
                Type = "UpdateInstance",Data = Utilities.Serialize(data)
            }, JsonRequestBehavior.AllowGet);
        ...
        /*<DataSourceEntryPoint:DeliveryNoteList_DeliveryNoteDataSet:1/>*/

        [HttpPost]
        [CustomControllerActionFilter(HasDefaultResultView=true, ActionName = "DeliveryNoteDataSet", ClaimType = ClaimTypes.Dataset)]
        [Route("DeliveryNoteList_DeliveryNoteDataSet_Datasource")]
        public JsonResult DeliveryNoteList_DeliveryNoteDataSet_Datasource()
        {
            var postedData = _LoadViewModel();
            var datasourceRequest = DeserializeDatasourceRequest(postedData["datasourceRequest"].ToString());
            var queryable = Get_DeliveryNoteList_DeliveryNoteDataSet_DatasourceQueryable(datasourceRequest);
            ...
            //Total items count
            if (CLMS.AppDev.Cache.CacheManager.Current.HasKey($"{Request.RequestContext.HttpContext.Session.SessionID}_DeliveryNoteList_DeliveryNoteDataSet_TotalItems"))
            {
                CLMS.AppDev.Cache.CacheManager.Current.Set($"{Request.RequestContext.HttpContext.Session.SessionID}_DeliveryNoteList_DeliveryNoteDataSet_TotalItems", response.TotalRows);
            }
            else
            {
                CLMS.AppDev.Cache.CacheManager.Current.Add($"{Request.RequestContext.HttpContext.Session.SessionID}_DeliveryNoteList_DeliveryNoteDataSet_TotalItems", response.TotalRows);
            }
            if (response.TotalRows < datasourceRequest.StartRow + 1)
            {
                datasourceRequest.StartRow = 0;
...
//Fix for total items in GetGroupsClosed
        ...
        public override ActionResult PostActionFilterHook(bool hasDefaultResultView, bool fillDropDownInitialValues = false)
        {
            ...
            {
                var _modelDTO = new DeliveryNoteListViewModelDTO(@model);
        ...
        private ActionResult GetFailedDataValidationsResult()
        {
            ...
            catch (Exception e)
            {
                ...
                log4net.LogManager.GetLogger(this.GetType()).Error("Form: DeliveryNoteList, Action: " + System.Web.HttpContext.Current.Items["_currentControllerAction"], e);
                //throw;
                return null;
            }
        }
