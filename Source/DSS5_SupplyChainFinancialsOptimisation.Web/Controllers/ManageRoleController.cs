...
using DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ManageRole;
...
namespace DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.ManageRole
{
    ...
    public class ManageRoleController : ControllerBase<ManageRoleViewModel, ManageRoleViewModelDTO>
    {
        ...
        [CustomControllerActionFilter(LogEnabled=true, ActionName="SaveRole", ClaimType = ClaimTypes.ControllerAction)]
        [HttpPost]
        [Route("SaveRole")]
        ...
        [CustomControllerActionFilter(ActionName="AddPermissionChanged", ClaimType = ClaimTypes.ControllerAction)]
        [HttpPost]
        [Route("AddPermissionChanged")]
        public ActionResult AddPermissionChanged(System.Collections.Generic.List<zAppDev.DotNet.Framework.Identity.Model.ApplicationPermission> DataItems, bool byUser = false)

        {
            ...
            var redirectInfo = ExecuteAddPermissionChanged(DataItems,byUser);
            return redirectInfo;
        }
        ...
        public ActionResult ExecuteEditRole(int? Id)
        {
            ...
            ((MasterPageForSlide.MasterPageForSlideController) _parentController).ExecuteRender();
            ActionResult _result = null;
            @model.ApplicationRole =  new DSS5_SupplyChainFinancialsOptimisation.DAL.Repository().GetById<zAppDev.DotNet.Framework.Identity.Model.ApplicationRole>(Id);
        ...
        {
            ActionResult _result = null;
            new DSS5_SupplyChainFinancialsOptimisation.DAL.Repository().Save<zAppDev.DotNet.Framework.Identity.Model.ApplicationRole>(@model.ApplicationRole);
            _result = CloseForm();
            return _result;
        }
        ...
        {
            ActionResult _result = null;
            new DSS5_SupplyChainFinancialsOptimisation.DAL.Repository().DeleteApplicationRole(@model.ApplicationRole);
            _result = CloseForm();
            return _result;
        }
        /*<ControllerActionImplementation:AddPermissionChanged:1/>*/
        public ActionResult ExecuteAddPermissionChanged(System.Collections.Generic.List<zAppDev.DotNet.Framework.Identity.Model.ApplicationPermission> DataItems, bool byUser)
        {
            ActionResult _result = null;
            return _result;
        }
