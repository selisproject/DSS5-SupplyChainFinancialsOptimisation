...
using DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.CreateAdmin;
...
namespace DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.CreateAdmin
{
    ...
    public class CreateAdminController : ControllerBase<CreateAdminViewModel, CreateAdminViewModelDTO>
    {
        ...
        {
            var masterViewModel = new DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.MasterPageSignIn.MasterPageSignInViewModel
            {
...

        {
            ...
            System.Web.HttpContext.Current.Session["LastEntryPoint_CreateAdmin"] = "Index";
            PushToHistory();
            var _masterController = new DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.MasterPageSignIn.MasterPageSignInController(@model);
        ...
        {
            if (_parentController == null) _parentController = new MasterPageSignIn.MasterPageSignInController(new  DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.MasterPageSignIn.MasterPageSignInViewModel());
        ...
        {
            ActionResult _result = null;
            if ((new DSS5_SupplyChainFinancialsOptimisation.DAL.Repository().GetCount<zAppDev.DotNet.Framework.Identity.Model.ApplicationUser>((u) => u.Roles.Any((r) => r.Name == "Administrator")) > 0))
            {
