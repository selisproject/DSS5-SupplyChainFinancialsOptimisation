...
using DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.DashboardStatistics;
...
namespace DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.DashboardStatistics
{
    ...
    public class DashboardStatisticsController : ControllerBase<DashboardStatisticsViewModel, DashboardStatisticsViewModelDTO>
    {
        ...
        /*<Datasource:ChartDataAvailability1:1/>*/
        /*<DataSourceFilter:ChartDataAvailability1:2/>*/
        public IQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.SupplierStatistic> Get_ChartDataAvailability1_DatasourceQueryable(DatasourceRequest __request = null, bool shouldEvict = true)
        {
            ...
            var __items = Get_ChartDataAvailability1_DatasourceQueryableImplementation(__request);
            return __items;
        }
        public IQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.SupplierStatistic> Get_ChartDataAvailability1_DatasourceQueryableImplementation(DatasourceRequest __request = null, bool shouldEvict = true)
        {
            __request = __request ?? new DatasourceRequest(0, int.MaxValue);
            var __items = DSS5_SupplyChainFinancialsOptimisation.BO.SupplierStatisticExtensions.GetSupplierDataStatistics2().AsQueryable();
            return __items.Where(@this => @this.Supplier.SupplierStatus == "ActiveSupplier");
        }


        /*<DataSourceEntryPoint:ChartDataAvailability1:1/>*/

        [HttpPost]
        [CustomControllerActionFilter(HasDefaultResultView=true, ActionName = "SupplierStatisticDataSet", ClaimType = ClaimTypes.Dataset)]
        [Route("ChartDataAvailability1_Datasource")]
        public JsonResult ChartDataAvailability1_Datasource()
        {
            var postedData = _LoadViewModel();
            var datasourceRequest = DeserializeDatasourceRequest(postedData["datasourceRequest"].ToString());
            var queryable = Get_ChartDataAvailability1_DatasourceQueryable(datasourceRequest);
            var response = new ListResponse
            {
                TotalRows = DatasourceRetriever.ApplyDynamicFilterToQueryable(datasourceRequest, queryable).Count(),
            };
            //Total items count
            if (CLMS.AppDev.Cache.CacheManager.Current.HasKey($"{Request.RequestContext.HttpContext.Session.SessionID}_ChartDataAvailability1_TotalItems"))
            {
                CLMS.AppDev.Cache.CacheManager.Current.Set($"{Request.RequestContext.HttpContext.Session.SessionID}_ChartDataAvailability1_TotalItems", response.TotalRows);
            }
            else
            {
                CLMS.AppDev.Cache.CacheManager.Current.Add($"{Request.RequestContext.HttpContext.Session.SessionID}_ChartDataAvailability1_TotalItems", response.TotalRows);
            }
...
//Fix for total items in GetGroupsClosed
        ...
        public IQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.SupplierStatistic> Get_ChartDataAvailability_DatasourceQueryable(DatasourceRequest __request = null, bool shouldEvict = true)
        {
            __request = __request ?? new DatasourceRequest(0, int.MaxValue);
            if (shouldEvict)
            {
        ...
        public IQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.SupplierStatistic> Get_ChartDataAvailability_DatasourceQueryableImplementation(DatasourceRequest __request = null, bool shouldEvict = true)
        {
            __request = __request ?? new DatasourceRequest(0, int.MaxValue);
            var __items = DSS5_SupplyChainFinancialsOptimisation.BO.SupplierStatisticExtensions.GetSupplierDataStatistics2().AsQueryable();
            return __items.Where(@this => @this.Supplier.SupplierStatus == "ActiveSupplier");
...
//Fix for total items in GetGroupsClosed
        ...
        public IQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.SupplierStatistic> Get_ChartTurnover_DatasourceQueryable(DatasourceRequest __request = null, bool shouldEvict = true)
        {
            __request = __request ?? new DatasourceRequest(0, int.MaxValue);
            if (shouldEvict)
            {
        ...
        public IQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.SupplierStatistic> Get_ChartTurnover_DatasourceQueryableImplementation(DatasourceRequest __request = null, bool shouldEvict = true)
        {
            __request = __request ?? new DatasourceRequest(0, int.MaxValue);
            var __items = DSS5_SupplyChainFinancialsOptimisation.BO.SupplierStatisticExtensions.GetSupplierTurnover().AsQueryable();
            return __items.Where(@this => true);
        }
...
//Fix for total items in GetGroupsClosed
        ...
        public IQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.SupplierStatistic> Get_DashboardStatistics_SupplierStatisticDataSet_DatasourceQueryable(DatasourceRequest __request = null, bool shouldEvict = true)
        {
            __request = __request ?? new DatasourceRequest(0, int.MaxValue);
            if (shouldEvict)
            {
        ...
        public IQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.SupplierStatistic> Get_DashboardStatistics_SupplierStatisticDataSet_DatasourceQueryableImplementation(DatasourceRequest __request = null, bool shouldEvict = true)
        {
            __request = __request ?? new DatasourceRequest(0, int.MaxValue);
            var __items = DSS5_SupplyChainFinancialsOptimisation.BO.SupplierStatisticExtensions.GetSupplierDataStatistics2().AsQueryable();
            return __items.Where(@this => @this.Supplier.SupplierStatus == "ActiveSupplier");
...
//Fix for total items in GetGroupsClosed
        ...
        public IQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.SupplierStatistic> Get_DashboardStatistics_SupplierStatisticDataSetOnTime_DatasourceQueryable(DatasourceRequest __request = null, bool shouldEvict = true)
        {
            __request = __request ?? new DatasourceRequest(0, int.MaxValue);
            if (shouldEvict)
            {
        ...
        public IQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.SupplierStatistic> Get_DashboardStatistics_SupplierStatisticDataSetOnTime_DatasourceQueryableImplementation(DatasourceRequest __request = null, bool shouldEvict = true)
        {
            __request = __request ?? new DatasourceRequest(0, int.MaxValue);
            var __items = DSS5_SupplyChainFinancialsOptimisation.BO.SupplierStatisticExtensions.GetSupplierStatistics().AsQueryable();
            return __items.Where(@this => true);
...
//Fix for total items in GetGroupsClosed
        ...
        public IQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.SupplierStatistic> Get_DashboardStatistics_SupplierTurnoverDataSet_DatasourceQueryable(DatasourceRequest __request = null, bool shouldEvict = true)
        {
            __request = __request ?? new DatasourceRequest(0, int.MaxValue);
            if (shouldEvict)
            {
        ...
        public IQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.SupplierStatistic> Get_DashboardStatistics_SupplierTurnoverDataSet_DatasourceQueryableImplementation(DatasourceRequest __request = null, bool shouldEvict = true)
        {
            __request = __request ?? new DatasourceRequest(0, int.MaxValue);
            var __items = DSS5_SupplyChainFinancialsOptimisation.BO.SupplierStatisticExtensions.GetSupplierTurnover().AsQueryable();
            return __items.Where(@this => true);
