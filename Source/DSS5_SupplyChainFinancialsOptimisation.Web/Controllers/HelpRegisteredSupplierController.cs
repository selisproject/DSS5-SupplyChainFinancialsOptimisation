...
using DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.HelpRegisteredSupplier;
...
namespace DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.HelpRegisteredSupplier
{

    [RoutePrefix("HelpRegisteredSupplier")]
    public class HelpRegisteredSupplierController : ControllerBase<HelpRegisteredSupplierViewModel, HelpRegisteredSupplierViewModelDTO>
    {

        /*<Form:HelpRegisteredSupplier:0/>*/
        public HelpRegisteredSupplierController()
        {
            _logger = log4net.LogManager.GetLogger(typeof(HelpRegisteredSupplierController));
        ...
        public void SetModel(HelpRegisteredSupplierViewModel m)
        {
            @model = m;
        }
        ...
        {
            return PrepareUpdateInstanceResult(typeof(HelpRegisteredSupplierViewModel));
        }
        ...
        {
            @model = new HelpRegisteredSupplierViewModel();
            System.Web.HttpContext.Current.Session["LastEntryPoint_HelpRegisteredSupplier"] = "Render";
            return null;
        }
        ...
        public override ActionResult PostActionFilterHook(bool hasDefaultResultView, bool fillDropDownInitialValues = false)
        {
            ...
            {
                var _modelDTO = new HelpRegisteredSupplierViewModelDTO(@model);
            ...
            return View("HelpRegisteredSupplier");
        }
        ...
        private ActionResult GetFailedDataValidationsResult()
        {
            ...
            catch (Exception e)
            {
                ...
                log4net.LogManager.GetLogger(this.GetType()).Error("Form: HelpRegisteredSupplier, Action: " + System.Web.HttpContext.Current.Items["_currentControllerAction"], e);
                //throw;
                return null;
            }
        }
