...
using DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ForgotPassword;
...
namespace DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.ForgotPassword
{
    ...
    public class ForgotPasswordController : ControllerBase<ForgotPasswordViewModel, ForgotPasswordViewModelDTO>
    {
        ...
        public ActionResult ExecuteResetPassword()
        {
            ...
            emailMessage.To = new List<string> { (user?.Email ?? "") } .ToList();
