...
using DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.PermissionsList;
...
namespace DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.PermissionsList
{
    ...
    public class PermissionsListController : ControllerBase<PermissionsListViewModel, PermissionsListViewModelDTO>
    {
        ...
        public void SetModel(PermissionsListViewModel m)
        {
            @model = m;
        }
        ...
        public IQueryable<zAppDev.DotNet.Framework.Identity.Model.ApplicationPermission> Get_Table_DatasourceQueryable(DatasourceRequest __request = null, bool shouldEvict = true)
        {
...
// Predefined Ordering
        ...
        public IQueryable<zAppDev.DotNet.Framework.Identity.Model.ApplicationPermission> Get_Table_DatasourceQueryableImplementation(DatasourceRequest __request = null, bool shouldEvict = true)
        {
            __request = __request ?? new DatasourceRequest(0, int.MaxValue);
        ...
        public JsonResult Table_GetFullRecordset()
        {
            ...
            var data = CreateDtoInstancesFromKeys(typeof(PermissionsListViewModel), dataType, items.Select(i => i.Id.ToString()).ToList(), "Table");
        ...
        public JsonResult Table_Datasource()
        {
            ...
            response.Data = items.Select(i => new List1DataSet_ApplicationPermissionDTO(i, true)).ToList();
