...
using DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.PopUpDataAvailability;
...
namespace DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.PopUpDataAvailability
{

    [RoutePrefix("PopUpDataAvailability")]
    public class PopUpDataAvailabilityController : ControllerBase<PopUpDataAvailabilityViewModel, PopUpDataAvailabilityViewModelDTO>
    {

        /*<Form:PopUpDataAvailability:0/>*/
        public PopUpDataAvailabilityController()
        {
            _logger = log4net.LogManager.GetLogger(typeof(PopUpDataAvailabilityController));
        ...
        public void SetModel(PopUpDataAvailabilityViewModel m)
        {
            @model = m;
        }
        ...
        {
            return PrepareUpdateInstanceResult(typeof(PopUpDataAvailabilityViewModel));
        }
        ...
        {
            @model = new PopUpDataAvailabilityViewModel();
            System.Web.HttpContext.Current.Session["LastEntryPoint_PopUpDataAvailability"] = "Render";
            return null;
        }
        ...
        public override ActionResult PostActionFilterHook(bool hasDefaultResultView, bool fillDropDownInitialValues = false)
        {
            ...
            {
                var _modelDTO = new PopUpDataAvailabilityViewModelDTO(@model);
            ...
            return View("PopUpDataAvailability");
        }
        ...
        private ActionResult GetFailedDataValidationsResult()
        {
            ...
            catch (Exception e)
            {
                ...
                log4net.LogManager.GetLogger(this.GetType()).Error("Form: PopUpDataAvailability, Action: " + System.Web.HttpContext.Current.Items["_currentControllerAction"], e);
                //throw;
                return null;
            }
        }
