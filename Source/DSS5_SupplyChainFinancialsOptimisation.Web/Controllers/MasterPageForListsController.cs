...
namespace DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.MasterPageForLists
{

    [RoutePrefix("MasterPageForLists")]
    public class MasterPageForListsController : ControllerBase<MasterPageForListsViewModel, MasterPageForListsViewModelDTO>
    {
        public MasterPageForListsController()
        {
            _logger = log4net.LogManager.GetLogger(typeof(MasterPageForListsController));
            if (ViewModelDTOBase.DTOHelper == null)
            {
                ViewModelDTOBase.DTOHelper = new DTOHelper();
            }
        }
        public MasterPageForListsController(MasterPageForListsViewModel m) : this()
        {
            model = m;
        }
        ...
        public void SetModel(MasterPageForListsViewModel m)
        {
            @model = m;
        }
        ...
        {
            return PrepareUpdateInstanceResult(typeof(MasterPageForListsViewModel));
        }
        ...
        {
            @model = new MasterPageForListsViewModel();
            return null;
        }
        ...
        public ActionResult ExecuteRender()
        {
            ...
            @model.Title = BaseViewPage<string>.GetResourceValue("MasterPageForLists", "RES_PAGETITLE_Render").ToString();
            @model.Version = "v" + zAppDev.DotNet.Framework.Utilities.Common.GetConfigurationKey("app:version");
            return _result;
        }
        ...
        public override ActionResult PostActionFilterHook(bool hasDefaultResultView, bool fillDropDownInitialValues = false)
        {
            ...
            {
                var _modelDTO = new MasterPageForListsViewModelDTO(@model);
            ...
            return View("MasterPageForLists");
        }
        ...
        private ActionResult GetFailedDataValidationsResult()
        {
            ...
            catch (Exception e)
            {
                ...
                log4net.LogManager.GetLogger(this.GetType()).Error("Form: MasterPageForLists, Action: " + System.Web.HttpContext.Current.Items["_currentControllerAction"], e);
                //throw;
                return null;
            }
        }
