...
using DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ValidatedSuppliersList;
...
namespace DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.ValidatedSuppliersList
{

    [RoutePrefix("ValidatedSuppliersList")]
    public class ValidatedSuppliersListController : ControllerBase<ValidatedSuppliersListViewModel, ValidatedSuppliersListViewModelDTO>
    {

        /*<Form:ValidatedSuppliersList:0/>*/
        public ValidatedSuppliersListController()
        {
            _logger = log4net.LogManager.GetLogger(typeof(ValidatedSuppliersListController));
        ...
        public void SetModel(ValidatedSuppliersListViewModel m)
        {
            @model = m;
        }
        ...
        {
            return PrepareUpdateInstanceResult(typeof(ValidatedSuppliersListViewModel));
        }
        ...
        {
            return FileHelper.PendingDownloadInstance.DownloadByKey("ValidatedSuppliersList", id);
        }
        ...
        public JsonResult SaveListView()
        {
            ...
            return SaveListView(postedData, "ValidatedSuppliersList");
        }
        ...
        {
            var postedData = _ParsePostedData();
            return DeleteListView(postedData, "ValidatedSuppliersList");
        }
        ...
        {
            var postedData = _ParsePostedData();
            return LoadListViews(postedData, "ValidatedSuppliersList");
        }
        ...
        {
            @model = new ValidatedSuppliersListViewModel();
            System.Web.HttpContext.Current.Session["LastEntryPoint_ValidatedSuppliersList"] = "Retrieve";
            return null;
        }
        ...
        public IQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.Supplier> Get_SupplierListNoDT_DatasourceQueryableImplementation(DatasourceRequest __request = null, bool shouldEvict = true)
        {
            ...
            return __items.Where(@this => @this.SupplierStatus == "ValidatedSupplier");
        }
        ...
        public JsonResult SupplierListNoDT_GetFullRecordset()
        {
            ...
            var data = CreateDtoInstancesFromKeys(typeof(ValidatedSuppliersListViewModel), dataType, items.Select(i => i.UserName.ToString()).ToList(), "SupplierListNoDT");
...
//Fix for total items in GetGroupsClosed
        ...
        public string SupplierListNoDT_ExportImplementation(DatasourceRequest datasourceRequest, ExportHelper.ExportOptions exportOptions, List<AggregatorInfo<DSS5_SupplyChainFinancialsOptimisation.BO.Supplier>> aggregatorsInfo)
        {
            ...
            if (exportOptions.ColumnOptions == null)
            {
                exportOptions.ColumnOptions = new List<ExportHelper.ColumnOptions>
                {
                    ...
                    new ExportHelper.ColumnOptions { Column = "SupplierContactInformation.Telephone", IsVisible = true },
            ...
            foreach (var record in dto)
            {
                ...
                recordDTO.Columns.Add(new ExportHelper.ExportColumnDTO
                {
                    ...
                    Format = "",
                    ExcelFormat = @"",
                    Caption = BaseViewPage<object>.GetResourceValue("ValidatedSuppliersList", "RES_LIST_SupplierListNoDT_COLUMN_UserName")
                });
                recordDTO.Columns.Add(new ExportHelper.ExportColumnDTO
                {
                    ...
                    Format = "",
                    ExcelFormat = @"",
                    Caption = BaseViewPage<object>.GetResourceValue("ValidatedSuppliersList", "RES_LIST_SupplierListNoDT_COLUMN_Company")
                });
                recordDTO.Columns.Add(new ExportHelper.ExportColumnDTO
                {
                    ...
                    Format = "",
                    ExcelFormat = @"",
                    Caption = BaseViewPage<object>.GetResourceValue("ValidatedSuppliersList", "RES_LIST_SupplierListNoDT_COLUMN_Email")
                });
                recordDTO.Columns.Add(new ExportHelper.ExportColumnDTO
                {
                    ...
                    Format = "",
                    ExcelFormat = @"",
                    Caption = BaseViewPage<object>.GetResourceValue("ValidatedSuppliersList", "RES_LIST_SupplierListNoDT_COLUMN_Business")
                });
                recordDTO.Columns.Add(new ExportHelper.ExportColumnDTO
                {
                    ColumnName = "SupplierContactInformation.Telephone",
                    Value = record?.SupplierContactInformation?.Telephone,
                    ColumnDataType = "string",
                    Format = "",
                    ExcelFormat = @"",
                    Caption = BaseViewPage<object>.GetResourceValue("ValidatedSuppliersList", "RES_LIST_SupplierListNoDT_COLUMN_SupplierContactInformation.Telephone")
                });
                recordDTO.Columns.Add(new ExportHelper.ExportColumnDTO
                {
                    ...
                    Format = "",
                    ExcelFormat = @"",
                    Caption = BaseViewPage<object>.GetResourceValue("ValidatedSuppliersList", "RES_LIST_SupplierListNoDT_COLUMN_SupplierStatus")
                });
            ...
            return FileHelper.PendingDownloadInstance.Add("ValidatedSuppliersList", content, fileName);
        }
        ...
        public string SupplierListNoDT_ExportV2Implementation(DatasourceRequest datasourceRequest, ExportOptionsV2 exportOptions, List<AggregatorInfo<DSS5_SupplyChainFinancialsOptimisation.BO.Supplier>> aggregatorsInfo)
        {
            ...
            {
                {"UserName" , item => item?.UserName }, {"Company" , item => item?.Company }, {"Email" , item => item?.Email }, {"Business" , item => item?.Business }, {"SupplierContactInformation.Telephone" , item => item?.SupplierContactInformation?.Telephone }, {"SupplierStatus" , item => item?.SupplierStatus },
            });
            if (exportHelper.Options.ColumnInfo == null)
            {
                exportHelper.Options.ColumnInfo = new List<ColumnOptionsV2>
                {
                    new ColumnOptionsV2 { Caption = BaseViewPage<object>.GetResourceValue("ValidatedSuppliersList", "RES_LIST_SupplierListNoDT_COLUMN_UserName"), Formatting = "", Name = "UserName", ExcelFormat = @"" },
                    new ColumnOptionsV2 { Caption = BaseViewPage<object>.GetResourceValue("ValidatedSuppliersList", "RES_LIST_SupplierListNoDT_COLUMN_Company"), Formatting = "", Name = "Company", ExcelFormat = @"" },
                    new ColumnOptionsV2 { Caption = BaseViewPage<object>.GetResourceValue("ValidatedSuppliersList", "RES_LIST_SupplierListNoDT_COLUMN_Email"), Formatting = "", Name = "Email", ExcelFormat = @"" },
                    new ColumnOptionsV2 { Caption = BaseViewPage<object>.GetResourceValue("ValidatedSuppliersList", "RES_LIST_SupplierListNoDT_COLUMN_Business"), Formatting = "", Name = "Business", ExcelFormat = @"" },
                    new ColumnOptionsV2 { Caption = BaseViewPage<object>.GetResourceValue("ValidatedSuppliersList", "RES_LIST_SupplierListNoDT_COLUMN_SupplierContactInformation.Telephone"), Formatting = "", Name = "SupplierContactInformation.Telephone", ExcelFormat = @"" },
                    new ColumnOptionsV2 { Caption = BaseViewPage<object>.GetResourceValue("ValidatedSuppliersList", "RES_LIST_SupplierListNoDT_COLUMN_SupplierStatus"), Formatting = "", Name = "SupplierStatus", ExcelFormat = @"" },
            ...
            var content = System.IO.File.ReadAllBytes(Path.Combine(Path.GetTempPath(), path));
            var fileName = Path.GetFileName(path);
            var downloadKey = FileHelper.PendingDownloadInstance.Add("ValidatedSuppliersList", content, fileName);
        ...
        /*<Datasource:ValidatedSuppliersList_SupplierDataSet:1/>*/
        /*<DataSourceFilter:ValidatedSuppliersList_SupplierDataSet:2/>*/
        public IQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.Supplier> Get_ValidatedSuppliersList_SupplierDataSet_DatasourceQueryable(DatasourceRequest __request = null, bool shouldEvict = true)
        {
            __request = __request ?? new DatasourceRequest(0, int.MaxValue);
            if (shouldEvict)
            {
            ...
            var __items = Get_ValidatedSuppliersList_SupplierDataSet_DatasourceQueryableImplementation(__request);
            return __items;
        }
        public IQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.Supplier> Get_ValidatedSuppliersList_SupplierDataSet_DatasourceQueryableImplementation(DatasourceRequest __request = null, bool shouldEvict = true)
        {
            __request = __request ?? new DatasourceRequest(0, int.MaxValue);
            var __items = new DSS5_SupplyChainFinancialsOptimisation.DAL.Repository().GetAsQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.Supplier>().AsQueryable();
            return __items.Where(@this => @this.SupplierStatus == "ValidatedSupplier");
        ...
        /*<DataSourceGetFullRecordset:ValidatedSuppliersList_SupplierDataSet:1/>*/

        [HttpPost]
        [Route("ValidatedSuppliersList_SupplierDataSet_GetFullRecordset")]
        [CustomControllerActionFilter(HasDefaultResultView=true, ActionName = "SupplierDataSet", ClaimType = ClaimTypes.Dataset)]
        public JsonResult ValidatedSuppliersList_SupplierDataSet_GetFullRecordset()
        {
            var postedData = _ParsePostedData();
            var dataType = postedData["dataType"].ToString();
            var keysToExclude = postedData["keys"] == null
            ...
            _LoadViewModel();
            var datasourceRequest = new DatasourceRequest(0, 2147483647, postedDatasourceRequest.Filters, null, keysToExclude, indexes);
            var queryable = Get_ValidatedSuppliersList_SupplierDataSet_DatasourceQueryable(datasourceRequest);
            var items = DatasourceRetriever.ApplyDynamicFilterToQueryable(datasourceRequest, queryable);
            //The following method of creating DTO responses has been changed due to the fact that the returned objects were missing properties that were not used by the client.
            //It now uses the UpdateInstance method. To be removed after some testing if no problems occur.
            //var data = items.Select(i => new SupplierDataSet_SupplierDTO(i, true)).ToList();
            var data = CreateDtoInstancesFromKeys(typeof(ValidatedSuppliersListViewModel), dataType, items.Select(i => i.UserName.ToString()).ToList(), "ValidatedSuppliersList_SupplierDataSet");
            var __result = Json(new
            {
                Type = "UpdateInstance",Data = Utilities.Serialize(data)
            }, JsonRequestBehavior.AllowGet);
        ...
        /*<DataSourceEntryPoint:ValidatedSuppliersList_SupplierDataSet:1/>*/

        [HttpPost]
        [CustomControllerActionFilter(HasDefaultResultView=true, ActionName = "SupplierDataSet", ClaimType = ClaimTypes.Dataset)]
        [Route("ValidatedSuppliersList_SupplierDataSet_Datasource")]
        public JsonResult ValidatedSuppliersList_SupplierDataSet_Datasource()
        {
            var postedData = _LoadViewModel();
            var datasourceRequest = DeserializeDatasourceRequest(postedData["datasourceRequest"].ToString());
            var queryable = Get_ValidatedSuppliersList_SupplierDataSet_DatasourceQueryable(datasourceRequest);
            ...
            //Total items count
            if (CLMS.AppDev.Cache.CacheManager.Current.HasKey($"{Request.RequestContext.HttpContext.Session.SessionID}_ValidatedSuppliersList_SupplierDataSet_TotalItems"))
            {
                CLMS.AppDev.Cache.CacheManager.Current.Set($"{Request.RequestContext.HttpContext.Session.SessionID}_ValidatedSuppliersList_SupplierDataSet_TotalItems", response.TotalRows);
            }
            else
            {
                CLMS.AppDev.Cache.CacheManager.Current.Add($"{Request.RequestContext.HttpContext.Session.SessionID}_ValidatedSuppliersList_SupplierDataSet_TotalItems", response.TotalRows);
            }
            if (response.TotalRows < datasourceRequest.StartRow + 1)
            {
                datasourceRequest.StartRow = 0;
...
//Fix for total items in GetGroupsClosed
        ...
        public override ActionResult PostActionFilterHook(bool hasDefaultResultView, bool fillDropDownInitialValues = false)
        {
            ...
            {
                var _modelDTO = new ValidatedSuppliersListViewModelDTO(@model);
            ...
            return View("ValidatedSuppliersList");
        }
        ...
        private ActionResult GetFailedDataValidationsResult()
        {
            ...
            catch (Exception e)
            {
                ...
                log4net.LogManager.GetLogger(this.GetType()).Error("Form: ValidatedSuppliersList, Action: " + System.Web.HttpContext.Current.Items["_currentControllerAction"], e);
                //throw;
                return null;
            }
        }
