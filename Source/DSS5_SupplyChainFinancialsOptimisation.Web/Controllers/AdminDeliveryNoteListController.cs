...
using DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.AdminDeliveryNoteList;
...
namespace DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.AdminDeliveryNoteList
{

    [RoutePrefix("AdminDeliveryNoteList")]
    public class AdminDeliveryNoteListController : ControllerBase<AdminDeliveryNoteListViewModel, AdminDeliveryNoteListViewModelDTO>
    {

        /*<Form:AdminDeliveryNoteList:0/>*/
        public AdminDeliveryNoteListController()
        {
            _logger = log4net.LogManager.GetLogger(typeof(AdminDeliveryNoteListController));
        ...
        public void SetModel(AdminDeliveryNoteListViewModel m)
        {
            @model = m;
        }
        ...
        {
            return PrepareUpdateInstanceResult(typeof(AdminDeliveryNoteListViewModel));
        }
        ...
        {
            return FileHelper.PendingDownloadInstance.DownloadByKey("AdminDeliveryNoteList", id);
        }
        ...
        public JsonResult SaveListView()
        {
            ...
            return SaveListView(postedData, "AdminDeliveryNoteList");
        }
        ...
        {
            var postedData = _ParsePostedData();
            return DeleteListView(postedData, "AdminDeliveryNoteList");
        }
        ...
        {
            var postedData = _ParsePostedData();
            return LoadListViews(postedData, "AdminDeliveryNoteList");
        }
        ...
        {
            @model = new AdminDeliveryNoteListViewModel();
            System.Web.HttpContext.Current.Session["LastEntryPoint_AdminDeliveryNoteList"] = "Retrieve";
            return null;
        }
        ...
        public JsonResult DeliveryNoteListNoDT_GetFullRecordset()
        {
            ...
            var data = CreateDtoInstancesFromKeys(typeof(AdminDeliveryNoteListViewModel), dataType, items.Select(i => i.Id.ToString()).ToList(), "DeliveryNoteListNoDT");
...
//Fix for total items in GetGroupsClosed
        ...
        public string DeliveryNoteListNoDT_ExportV2Implementation(DatasourceRequest datasourceRequest, ExportOptionsV2 exportOptions, List<AggregatorInfo<DSS5_SupplyChainFinancialsOptimisation.BO.DeliveryNote>> aggregatorsInfo)
        {
            ...
            if (exportHelper.Options.ColumnInfo == null)
            {
                ...
                {
                    new ColumnOptionsV2 { Caption = BaseViewPage<object>.GetResourceValue("AdminDeliveryNoteList", "RES_LIST_DeliveryNoteListNoDT_COLUMN_Transaction.Id"), Formatting = "", Name = "Transaction.Id", ExcelFormat = @"" },
                    new ColumnOptionsV2 { Caption = BaseViewPage<object>.GetResourceValue("AdminDeliveryNoteList", "RES_LIST_DeliveryNoteListNoDT_COLUMN_DeliveryNoteNumber"), Formatting = "", Name = "DeliveryNoteNumber", ExcelFormat = @"" },
                    new ColumnOptionsV2 { Caption = BaseViewPage<object>.GetResourceValue("AdminDeliveryNoteList", "RES_LIST_DeliveryNoteListNoDT_COLUMN_Description"), Formatting = "", Name = "Description", ExcelFormat = @"" },
                    new ColumnOptionsV2 { Caption = BaseViewPage<object>.GetResourceValue("AdminDeliveryNoteList", "RES_LIST_DeliveryNoteListNoDT_COLUMN_DateIssued"), Formatting = "dd/MM/yyyy", Name = "DateIssued", ExcelFormat = @"dd/MM/yyyy" },
                    new ColumnOptionsV2 { Caption = BaseViewPage<object>.GetResourceValue("AdminDeliveryNoteList", "RES_LIST_DeliveryNoteListNoDT_COLUMN_Amount"), Formatting = "#,0.00;'-'#,0.00;'0'", Name = "Amount", ExcelFormat = @"#,##0.00;-#,##0.00;#,##0.00" },
                    new ColumnOptionsV2 { Caption = BaseViewPage<object>.GetResourceValue("AdminDeliveryNoteList", "RES_LIST_DeliveryNoteListNoDT_COLUMN_Transaction.Supplier.Company"), Formatting = "", Name = "Transaction.Supplier.Company", ExcelFormat = @"" },
        ...
        /*<Datasource:AdminDeliveryNoteList_DeliveryNoteDataSet:1/>*/
        /*<DataSourceFilter:AdminDeliveryNoteList_DeliveryNoteDataSet:2/>*/
        public IQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.DeliveryNote> Get_AdminDeliveryNoteList_DeliveryNoteDataSet_DatasourceQueryable(DatasourceRequest __request = null, bool shouldEvict = true)
        {
            __request = __request ?? new DatasourceRequest(0, int.MaxValue);
            if (shouldEvict)
            {
            ...
            var __items = Get_AdminDeliveryNoteList_DeliveryNoteDataSet_DatasourceQueryableImplementation(__request);
            return __items;
        }
        public IQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.DeliveryNote> Get_AdminDeliveryNoteList_DeliveryNoteDataSet_DatasourceQueryableImplementation(DatasourceRequest __request = null, bool shouldEvict = true)
        {
            __request = __request ?? new DatasourceRequest(0, int.MaxValue);
            var __items = new DSS5_SupplyChainFinancialsOptimisation.DAL.Repository().GetAsQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.DeliveryNote>().AsQueryable();
            return __items.Where(@this => @this.Transaction.Supplier.Roles.Any((a) => a.Name == "ActiveSupplier"));
        ...
        /*<DataSourceGetFullRecordset:AdminDeliveryNoteList_DeliveryNoteDataSet:1/>*/

        [HttpPost]
        [Route("AdminDeliveryNoteList_DeliveryNoteDataSet_GetFullRecordset")]
        [CustomControllerActionFilter(HasDefaultResultView=true, ActionName = "DeliveryNoteDataSet", ClaimType = ClaimTypes.Dataset)]
        public JsonResult AdminDeliveryNoteList_DeliveryNoteDataSet_GetFullRecordset()
        {
            var postedData = _ParsePostedData();
            var dataType = postedData["dataType"].ToString();
            var keysToExclude = postedData["keys"] == null
            ...
            _LoadViewModel();
            var datasourceRequest = new DatasourceRequest(0, 2147483647, postedDatasourceRequest.Filters, null, keysToExclude, indexes);
            var queryable = Get_AdminDeliveryNoteList_DeliveryNoteDataSet_DatasourceQueryable(datasourceRequest);
            var items = DatasourceRetriever.ApplyDynamicFilterToQueryable(datasourceRequest, queryable);
            //The following method of creating DTO responses has been changed due to the fact that the returned objects were missing properties that were not used by the client.
            //It now uses the UpdateInstance method. To be removed after some testing if no problems occur.
            //var data = items.Select(i => new DeliveryNoteDataSet_DeliveryNoteDTO(i, true)).ToList();
            var data = CreateDtoInstancesFromKeys(typeof(AdminDeliveryNoteListViewModel), dataType, items.Select(i => i.Id.ToString()).ToList(), "AdminDeliveryNoteList_DeliveryNoteDataSet");
            var __result = Json(new
            {
                Type = "UpdateInstance",Data = Utilities.Serialize(data)
            }, JsonRequestBehavior.AllowGet);
        ...
        /*<DataSourceEntryPoint:AdminDeliveryNoteList_DeliveryNoteDataSet:1/>*/

        [HttpPost]
        [CustomControllerActionFilter(HasDefaultResultView=true, ActionName = "DeliveryNoteDataSet", ClaimType = ClaimTypes.Dataset)]
        [Route("AdminDeliveryNoteList_DeliveryNoteDataSet_Datasource")]
        public JsonResult AdminDeliveryNoteList_DeliveryNoteDataSet_Datasource()
        {
            var postedData = _LoadViewModel();
            var datasourceRequest = DeserializeDatasourceRequest(postedData["datasourceRequest"].ToString());
            var queryable = Get_AdminDeliveryNoteList_DeliveryNoteDataSet_DatasourceQueryable(datasourceRequest);
            ...
            //Total items count
            if (CLMS.AppDev.Cache.CacheManager.Current.HasKey($"{Request.RequestContext.HttpContext.Session.SessionID}_AdminDeliveryNoteList_DeliveryNoteDataSet_TotalItems"))
            {
                CLMS.AppDev.Cache.CacheManager.Current.Set($"{Request.RequestContext.HttpContext.Session.SessionID}_AdminDeliveryNoteList_DeliveryNoteDataSet_TotalItems", response.TotalRows);
            }
            else
            {
                CLMS.AppDev.Cache.CacheManager.Current.Add($"{Request.RequestContext.HttpContext.Session.SessionID}_AdminDeliveryNoteList_DeliveryNoteDataSet_TotalItems", response.TotalRows);
            }
            if (response.TotalRows < datasourceRequest.StartRow + 1)
            {
                datasourceRequest.StartRow = 0;
...
//Fix for total items in GetGroupsClosed
        ...
        public override ActionResult PostActionFilterHook(bool hasDefaultResultView, bool fillDropDownInitialValues = false)
        {
            ...
            {
                var _modelDTO = new AdminDeliveryNoteListViewModelDTO(@model);
            ...
            return View("AdminDeliveryNoteList");
        }
        ...
        private ActionResult GetFailedDataValidationsResult()
        {
            ...
            catch (Exception e)
            {
                ...
                log4net.LogManager.GetLogger(this.GetType()).Error("Form: AdminDeliveryNoteList, Action: " + System.Web.HttpContext.Current.Items["_currentControllerAction"], e);
                //throw;
                return null;
            }
        }
