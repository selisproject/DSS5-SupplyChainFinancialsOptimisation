...
using DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ChangePassword;
...
namespace DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.ChangePassword
{
    ...
    public class ChangePasswordController : ControllerBase<ChangePasswordViewModel, ChangePasswordViewModelDTO>
    {
        ...
        [CustomControllerActionFilter(ActionName="ChangePassword", ClaimType = ClaimTypes.ControllerAction)]
        [HttpPost]
