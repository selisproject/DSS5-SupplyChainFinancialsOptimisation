...
using DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.InvestorTransactionsList;
...
namespace DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.InvestorTransactionsList
{

    [RoutePrefix("InvestorTransactionsList")]
    public class InvestorTransactionsListController : ControllerBase<InvestorTransactionsListViewModel, InvestorTransactionsListViewModelDTO>
    {

        /*<Form:InvestorTransactionsList:0/>*/
        public InvestorTransactionsListController()
        {
            _logger = log4net.LogManager.GetLogger(typeof(InvestorTransactionsListController));
        ...
        public void SetModel(InvestorTransactionsListViewModel m)
        {
            @model = m;
        }
        ...
        {
            return PrepareUpdateInstanceResult(typeof(InvestorTransactionsListViewModel));
        }
        ...
        {
            return FileHelper.PendingDownloadInstance.DownloadByKey("InvestorTransactionsList", id);
        }
        ...
        public JsonResult SaveListView()
        {
            ...
            return SaveListView(postedData, "InvestorTransactionsList");
        }
        ...
        {
            var postedData = _ParsePostedData();
            return DeleteListView(postedData, "InvestorTransactionsList");
        }
        ...
        {
            var postedData = _ParsePostedData();
            return LoadListViews(postedData, "InvestorTransactionsList");
        }
        ...
        {
            @model = new InvestorTransactionsListViewModel();
            System.Web.HttpContext.Current.Session["LastEntryPoint_InvestorTransactionsList"] = "Render";
            return null;
        }
        ...
        public ActionResult ExecuteRender()
        {
            ...
            @model.InvestorUsername = zAppDev.DotNet.Framework.Identity.IdentityHelper.GetCurrentUserName();
            @model.Title = "";
            return _result;
        }
        #endregion
        ...
        public JsonResult ListNoDT_GetFullRecordset()
        {
            ...
            var data = CreateDtoInstancesFromKeys(typeof(InvestorTransactionsListViewModel), dataType, items.Select(i => i.Id.ToString()).ToList(), "ListNoDT");
...
//Fix for total items in GetGroupsClosed
        ...
        public string ListNoDT_ExportImplementation(DatasourceRequest datasourceRequest, ExportHelper.ExportOptions exportOptions, List<AggregatorInfo<DSS5_SupplyChainFinancialsOptimisation.BO.Transaction>> aggregatorsInfo)
        {
            ...
            foreach (var record in dto)
            {
                ...
                recordDTO.Columns.Add(new ExportHelper.ExportColumnDTO
                {
                    ...
                    Format = "",
                    ExcelFormat = @"",
                    Caption = BaseViewPage<object>.GetResourceValue("InvestorTransactionsList", "RES_LIST_ListNoDT_COLUMN_Id")
                });
                recordDTO.Columns.Add(new ExportHelper.ExportColumnDTO
                {
                    ...
                    Format = "",
                    ExcelFormat = @"",
                    Caption = BaseViewPage<object>.GetResourceValue("InvestorTransactionsList", "RES_LIST_ListNoDT_COLUMN_Supplier.Company")
                });
                recordDTO.Columns.Add(new ExportHelper.ExportColumnDTO
                {
                    ...
                    Format = "",
                    ExcelFormat = @"",
                    Caption = BaseViewPage<object>.GetResourceValue("InvestorTransactionsList", "RES_LIST_ListNoDT_COLUMN_ImportedBuyer.Company")
                });
                recordDTO.Columns.Add(new ExportHelper.ExportColumnDTO
                {
                    ...
                    Caption = BaseViewPage<object>.GetResourceValue("InvestorTransactionsList", "RES_LIST_ListNoDT_COLUMN_TransactionDateOccured")
                });
                recordDTO.Columns.Add(new ExportHelper.ExportColumnDTO
                {
                    ...
                    Caption = BaseViewPage<object>.GetResourceValue("InvestorTransactionsList", "RES_LIST_ListNoDT_COLUMN_TransactionValue")
                });
                recordDTO.Columns.Add(new ExportHelper.ExportColumnDTO
                {
                    ...
                    Format = "",
                    ExcelFormat = @"",
                    Caption = BaseViewPage<object>.GetResourceValue("InvestorTransactionsList", "RES_LIST_ListNoDT_COLUMN_TransactionStatus.Status")
                });
            ...
            return FileHelper.PendingDownloadInstance.Add("InvestorTransactionsList", content, fileName);
        }
        ...
        public string ListNoDT_ExportV2Implementation(DatasourceRequest datasourceRequest, ExportOptionsV2 exportOptions, List<AggregatorInfo<DSS5_SupplyChainFinancialsOptimisation.BO.Transaction>> aggregatorsInfo)
        {
            ...
            if (exportHelper.Options.ColumnInfo == null)
            {
                ...
                {
                    new ColumnOptionsV2 { Caption = BaseViewPage<object>.GetResourceValue("InvestorTransactionsList", "RES_LIST_ListNoDT_COLUMN_Id"), Formatting = "", Name = "Id", ExcelFormat = @"" },
                    new ColumnOptionsV2 { Caption = BaseViewPage<object>.GetResourceValue("InvestorTransactionsList", "RES_LIST_ListNoDT_COLUMN_Supplier.Company"), Formatting = "", Name = "Supplier.Company", ExcelFormat = @"" },
                    new ColumnOptionsV2 { Caption = BaseViewPage<object>.GetResourceValue("InvestorTransactionsList", "RES_LIST_ListNoDT_COLUMN_ImportedBuyer.Company"), Formatting = "", Name = "ImportedBuyer.Company", ExcelFormat = @"" },
                    new ColumnOptionsV2 { Caption = BaseViewPage<object>.GetResourceValue("InvestorTransactionsList", "RES_LIST_ListNoDT_COLUMN_TransactionDateOccured"), Formatting = "dd/MM/yyyy", Name = "TransactionDateOccured", ExcelFormat = @"dd/MM/yyyy" },
                    new ColumnOptionsV2 { Caption = BaseViewPage<object>.GetResourceValue("InvestorTransactionsList", "RES_LIST_ListNoDT_COLUMN_TransactionValue"), Formatting = "#,0.00;'-'#,0.00;'0'", Name = "TransactionValue", ExcelFormat = @"#,##0.00;-#,##0.00;#,##0.00" },
                    new ColumnOptionsV2 { Caption = BaseViewPage<object>.GetResourceValue("InvestorTransactionsList", "RES_LIST_ListNoDT_COLUMN_TransactionStatus.Status"), Formatting = "", Name = "TransactionStatus.Status", ExcelFormat = @"" },
            ...
            var content = System.IO.File.ReadAllBytes(Path.Combine(Path.GetTempPath(), path));
            var fileName = Path.GetFileName(path);
            var downloadKey = FileHelper.PendingDownloadInstance.Add("InvestorTransactionsList", content, fileName);
        ...
        /*<Datasource:InvestorTransactionsList_TransactionDataSet:1/>*/
        /*<DataSourceFilter:InvestorTransactionsList_TransactionDataSet:2/>*/
        public IQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.Transaction> Get_InvestorTransactionsList_TransactionDataSet_DatasourceQueryable(DatasourceRequest __request = null, bool shouldEvict = true)
        {
            __request = __request ?? new DatasourceRequest(0, int.MaxValue);
            if (shouldEvict)
            {
            ...
            var __items = Get_InvestorTransactionsList_TransactionDataSet_DatasourceQueryableImplementation(__request);
            return __items;
        }
        ...
        /*<DataSourceGetFullRecordset:InvestorTransactionsList_TransactionDataSet:1/>*/

        [HttpPost]
        [Route("InvestorTransactionsList_TransactionDataSet_GetFullRecordset")]
        [CustomControllerActionFilter(HasDefaultResultView=true, ActionName = "TransactionDataSet", ClaimType = ClaimTypes.Dataset)]
        public JsonResult InvestorTransactionsList_TransactionDataSet_GetFullRecordset()
        {
            var postedData = _ParsePostedData();
            var dataType = postedData["dataType"].ToString();
            var keysToExclude = postedData["keys"] == null
            ...
            _LoadViewModel();
            var datasourceRequest = new DatasourceRequest(0, 2147483647, postedDatasourceRequest.Filters, null, keysToExclude, indexes);
            var queryable = Get_InvestorTransactionsList_TransactionDataSet_DatasourceQueryable(datasourceRequest);
            var items = DatasourceRetriever.ApplyDynamicFilterToQueryable(datasourceRequest, queryable);
            //The following method of creating DTO responses has been changed due to the fact that the returned objects were missing properties that were not used by the client.
            //It now uses the UpdateInstance method. To be removed after some testing if no problems occur.
            //var data = items.Select(i => new TransactionDataSet_TransactionDTO(i, true)).ToList();
            var data = CreateDtoInstancesFromKeys(typeof(InvestorTransactionsListViewModel), dataType, items.Select(i => i.Id.ToString()).ToList(), "InvestorTransactionsList_TransactionDataSet");
            var __result = Json(new
            {
                Type = "UpdateInstance",Data = Utilities.Serialize(data)
            }, JsonRequestBehavior.AllowGet);
        ...
        /*<DataSourceEntryPoint:InvestorTransactionsList_TransactionDataSet:1/>*/

        [HttpPost]
        [CustomControllerActionFilter(HasDefaultResultView=true, ActionName = "TransactionDataSet", ClaimType = ClaimTypes.Dataset)]
        [Route("InvestorTransactionsList_TransactionDataSet_Datasource")]
        public JsonResult InvestorTransactionsList_TransactionDataSet_Datasource()
        {
            var postedData = _LoadViewModel();
            var datasourceRequest = DeserializeDatasourceRequest(postedData["datasourceRequest"].ToString());
            var queryable = Get_InvestorTransactionsList_TransactionDataSet_DatasourceQueryable(datasourceRequest);
            ...
            //Total items count
            if (CLMS.AppDev.Cache.CacheManager.Current.HasKey($"{Request.RequestContext.HttpContext.Session.SessionID}_InvestorTransactionsList_TransactionDataSet_TotalItems"))
            {
                CLMS.AppDev.Cache.CacheManager.Current.Set($"{Request.RequestContext.HttpContext.Session.SessionID}_InvestorTransactionsList_TransactionDataSet_TotalItems", response.TotalRows);
            }
            else
            {
                CLMS.AppDev.Cache.CacheManager.Current.Add($"{Request.RequestContext.HttpContext.Session.SessionID}_InvestorTransactionsList_TransactionDataSet_TotalItems", response.TotalRows);
            }
            if (response.TotalRows < datasourceRequest.StartRow + 1)
            {
                datasourceRequest.StartRow = 0;
...
//Fix for total items in GetGroupsClosed
        ...
        public override ActionResult PostActionFilterHook(bool hasDefaultResultView, bool fillDropDownInitialValues = false)
        {
            ...
            {
                var _modelDTO = new InvestorTransactionsListViewModelDTO(@model);
            ...
            return View("InvestorTransactionsList");
        }
        ...
        private ActionResult GetFailedDataValidationsResult()
        {
            ...
            catch (Exception e)
            {
                ...
                log4net.LogManager.GetLogger(this.GetType()).Error("Form: InvestorTransactionsList, Action: " + System.Web.HttpContext.Current.Items["_currentControllerAction"], e);
                //throw;
                return null;
            }
        }
