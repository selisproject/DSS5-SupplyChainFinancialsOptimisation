...
using DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ApplicationSettingForm;
...
namespace DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.ApplicationSettingForm
{
    ...
    public class ApplicationSettingFormController : ControllerBase<ApplicationSettingFormViewModel, ApplicationSettingFormViewModelDTO>
    {
        ...
        {
            ActionResult _result = null;
            new DSS5_SupplyChainFinancialsOptimisation.DAL.Repository().Save<zAppDev.DotNet.Framework.Identity.Model.ApplicationSetting>(@model.ApplicationSetting);
            _result = CloseForm();
            return _result;
        }
        ...
        {
            ActionResult _result = null;
            new DSS5_SupplyChainFinancialsOptimisation.DAL.Repository().DeleteApplicationSetting(@model.ApplicationSetting);
            _result = CloseForm();
            return _result;
        }
        #endregion
