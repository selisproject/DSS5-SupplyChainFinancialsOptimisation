...
using DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.PendingRegisteredSuppliersList;
...
namespace DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.PendingRegisteredSuppliersList
{

    [RoutePrefix("PendingRegisteredSuppliersList")]
    public class PendingRegisteredSuppliersListController : ControllerBase<PendingRegisteredSuppliersListViewModel, PendingRegisteredSuppliersListViewModelDTO>
    {

        /*<Form:PendingRegisteredSuppliersList:0/>*/
        public PendingRegisteredSuppliersListController()
        {
            _logger = log4net.LogManager.GetLogger(typeof(PendingRegisteredSuppliersListController));
        ...
        public void SetModel(PendingRegisteredSuppliersListViewModel m)
        {
            @model = m;
        }
        ...
        {
            return PrepareUpdateInstanceResult(typeof(PendingRegisteredSuppliersListViewModel));
        }
        ...
        {
            return FileHelper.PendingDownloadInstance.DownloadByKey("PendingRegisteredSuppliersList", id);
        }
        ...
        public JsonResult SaveListView()
        {
            ...
            return SaveListView(postedData, "PendingRegisteredSuppliersList");
        }
        ...
        {
            var postedData = _ParsePostedData();
            return DeleteListView(postedData, "PendingRegisteredSuppliersList");
        }
        ...
        {
            var postedData = _ParsePostedData();
            return LoadListViews(postedData, "PendingRegisteredSuppliersList");
        }
        ...
        {
            @model = new PendingRegisteredSuppliersListViewModel();
            System.Web.HttpContext.Current.Session["LastEntryPoint_PendingRegisteredSuppliersList"] = "Retrieve";
            return null;
        }
        ...
        [CustomControllerActionFilter(CausesValidation=true, ActionName="HandlePayment", ClaimType = ClaimTypes.ControllerAction)]
        [HttpPost]
        [Route("HandlePayment")]
        public ActionResult HandlePayment(string username, bool approved = false)

        {
            ...
            if (!_redirectionFromSameController)
            {
                ...
                approved = _data["approved"]?.ToString()?.ToLower() == "true";
            }
            var redirectInfo = ExecuteHandlePayment(username,approved);
            return redirectInfo;
        }
        ...
        public JsonResult SupplierListNoDT_GetFullRecordset()
        {
            ...
            var data = CreateDtoInstancesFromKeys(typeof(PendingRegisteredSuppliersListViewModel), dataType, items.Select(i => i.UserName.ToString()).ToList(), "SupplierListNoDT");
...
//Fix for total items in GetGroupsClosed
        ...
        public string SupplierListNoDT_ExportImplementation(DatasourceRequest datasourceRequest, ExportHelper.ExportOptions exportOptions, List<AggregatorInfo<DSS5_SupplyChainFinancialsOptimisation.BO.Supplier>> aggregatorsInfo)
        {
            ...
            if (exportOptions.ColumnOptions == null)
            {
                exportOptions.ColumnOptions = new List<ExportHelper.ColumnOptions>
                {
                    ...
                    new ExportHelper.ColumnOptions { Column = "PercentageOfCreditNotes", IsVisible = true },
        ...
        public string SupplierListNoDT_ExportV2Implementation(DatasourceRequest datasourceRequest, ExportOptionsV2 exportOptions, List<AggregatorInfo<DSS5_SupplyChainFinancialsOptimisation.BO.Supplier>> aggregatorsInfo)
        {
            ...
            if (exportHelper.Options.ColumnInfo == null)
            {
                ...
                {
                    new ColumnOptionsV2 { Caption = BaseViewPage<object>.GetResourceValue("PendingRegisteredSuppliersList", "RES_LIST_SupplierListNoDT_COLUMN_UserName"), Formatting = "", Name = "UserName", ExcelFormat = @"" },
                    new ColumnOptionsV2 { Caption = BaseViewPage<object>.GetResourceValue("PendingRegisteredSuppliersList", "RES_LIST_SupplierListNoDT_COLUMN_Company"), Formatting = "", Name = "Company", ExcelFormat = @"" },
                    new ColumnOptionsV2 { Caption = BaseViewPage<object>.GetResourceValue("PendingRegisteredSuppliersList", "RES_LIST_SupplierListNoDT_COLUMN_Business"), Formatting = "", Name = "Business", ExcelFormat = @"" },
                    new ColumnOptionsV2 { Caption = BaseViewPage<object>.GetResourceValue("PendingRegisteredSuppliersList", "RES_LIST_SupplierListNoDT_COLUMN_PercentageOfCreditNotes"), Formatting = "", Name = "PercentageOfCreditNotes", ExcelFormat = @"" },
                    new ColumnOptionsV2 { Caption = BaseViewPage<object>.GetResourceValue("PendingRegisteredSuppliersList", "RES_LIST_SupplierListNoDT_COLUMN_AcceptedPolicyTerms"), Formatting = "", Name = "AcceptedPolicyTerms", ExcelFormat = @"" },
                    new ColumnOptionsV2 { Caption = BaseViewPage<object>.GetResourceValue("PendingRegisteredSuppliersList", "RES_LIST_SupplierListNoDT_COLUMN_SupplierStatus"), Formatting = "", Name = "SupplierStatus", ExcelFormat = @"" },
        ...
        /*<Datasource:PendingRegisteredSuppliersList_SupplierDataSet:1/>*/
        /*<DataSourceFilter:PendingRegisteredSuppliersList_SupplierDataSet:2/>*/
        public IQueryable<DSS5_SupplyChainFinancialsOptimisation.BO.Supplier> Get_PendingRegisteredSuppliersList_SupplierDataSet_DatasourceQueryable(DatasourceRequest __request = null, bool shouldEvict = true)
        {
            __request = __request ?? new DatasourceRequest(0, int.MaxValue);
            if (shouldEvict)
            {
            ...
            var __items = Get_PendingRegisteredSuppliersList_SupplierDataSet_DatasourceQueryableImplementation(__request);
            return __items;
        }
        ...
        /*<DataSourceGetFullRecordset:PendingRegisteredSuppliersList_SupplierDataSet:1/>*/

        [HttpPost]
        [Route("PendingRegisteredSuppliersList_SupplierDataSet_GetFullRecordset")]
        [CustomControllerActionFilter(HasDefaultResultView=true, ActionName = "SupplierDataSet", ClaimType = ClaimTypes.Dataset)]
        public JsonResult PendingRegisteredSuppliersList_SupplierDataSet_GetFullRecordset()
        {
            var postedData = _ParsePostedData();
            var dataType = postedData["dataType"].ToString();
            var keysToExclude = postedData["keys"] == null
            ...
            _LoadViewModel();
            var datasourceRequest = new DatasourceRequest(0, 2147483647, postedDatasourceRequest.Filters, null, keysToExclude, indexes);
            var queryable = Get_PendingRegisteredSuppliersList_SupplierDataSet_DatasourceQueryable(datasourceRequest);
            var items = DatasourceRetriever.ApplyDynamicFilterToQueryable(datasourceRequest, queryable);
            //The following method of creating DTO responses has been changed due to the fact that the returned objects were missing properties that were not used by the client.
            //It now uses the UpdateInstance method. To be removed after some testing if no problems occur.
            //var data = items.Select(i => new SupplierDataSet_SupplierDTO(i, true)).ToList();
            var data = CreateDtoInstancesFromKeys(typeof(PendingRegisteredSuppliersListViewModel), dataType, items.Select(i => i.UserName.ToString()).ToList(), "PendingRegisteredSuppliersList_SupplierDataSet");
            var __result = Json(new
            {
                Type = "UpdateInstance",Data = Utilities.Serialize(data)
            }, JsonRequestBehavior.AllowGet);
        ...
        /*<DataSourceEntryPoint:PendingRegisteredSuppliersList_SupplierDataSet:1/>*/

        [HttpPost]
        [CustomControllerActionFilter(HasDefaultResultView=true, ActionName = "SupplierDataSet", ClaimType = ClaimTypes.Dataset)]
        [Route("PendingRegisteredSuppliersList_SupplierDataSet_Datasource")]
        public JsonResult PendingRegisteredSuppliersList_SupplierDataSet_Datasource()
        {
            var postedData = _LoadViewModel();
            var datasourceRequest = DeserializeDatasourceRequest(postedData["datasourceRequest"].ToString());
            var queryable = Get_PendingRegisteredSuppliersList_SupplierDataSet_DatasourceQueryable(datasourceRequest);
            ...
            //Total items count
            if (CLMS.AppDev.Cache.CacheManager.Current.HasKey($"{Request.RequestContext.HttpContext.Session.SessionID}_PendingRegisteredSuppliersList_SupplierDataSet_TotalItems"))
            {
                CLMS.AppDev.Cache.CacheManager.Current.Set($"{Request.RequestContext.HttpContext.Session.SessionID}_PendingRegisteredSuppliersList_SupplierDataSet_TotalItems", response.TotalRows);
            }
            else
            {
                CLMS.AppDev.Cache.CacheManager.Current.Add($"{Request.RequestContext.HttpContext.Session.SessionID}_PendingRegisteredSuppliersList_SupplierDataSet_TotalItems", response.TotalRows);
            }
            if (response.TotalRows < datasourceRequest.StartRow + 1)
            {
                datasourceRequest.StartRow = 0;
...
//Fix for total items in GetGroupsClosed
        ...
        public override ActionResult PostActionFilterHook(bool hasDefaultResultView, bool fillDropDownInitialValues = false)
        {
            ...
            {
                var _modelDTO = new PendingRegisteredSuppliersListViewModelDTO(@model);
            ...
            return View("PendingRegisteredSuppliersList");
        }
        ...
        private ActionResult GetFailedDataValidationsResult()
        {
            ...
            catch (Exception e)
            {
                ...
                log4net.LogManager.GetLogger(this.GetType()).Error("Form: PendingRegisteredSuppliersList, Action: " + System.Web.HttpContext.Current.Items["_currentControllerAction"], e);
                //throw;
                return null;
            }
        }
