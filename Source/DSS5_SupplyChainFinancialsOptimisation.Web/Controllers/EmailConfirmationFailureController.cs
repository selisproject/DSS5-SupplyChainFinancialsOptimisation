...
using DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.EmailConfirmationFailure;
...
namespace DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.EmailConfirmationFailure
{

    [RoutePrefix("EmailConfirmationFailure")]
    public class EmailConfirmationFailureController : ControllerBase<EmailConfirmationFailureViewModel, EmailConfirmationFailureViewModelDTO>
    {

        /*<Form:EmailConfirmationFailure:0/>*/
        public EmailConfirmationFailureController()
        {
            _logger = log4net.LogManager.GetLogger(typeof(EmailConfirmationFailureController));
        ...
        public void SetModel(EmailConfirmationFailureViewModel m)
        {
            @model = m;
        }
        ...
        {
            return PrepareUpdateInstanceResult(typeof(EmailConfirmationFailureViewModel));
        }
        ...
        {
            @model = new EmailConfirmationFailureViewModel();
            System.Web.HttpContext.Current.Session["LastEntryPoint_EmailConfirmationFailure"] = "Render";
            return null;
        }
        ...
        public override ActionResult PostActionFilterHook(bool hasDefaultResultView, bool fillDropDownInitialValues = false)
        {
            ...
            {
                var _modelDTO = new EmailConfirmationFailureViewModelDTO(@model);
            ...
            return View("EmailConfirmationFailure");
        }
        ...
        private ActionResult GetFailedDataValidationsResult()
        {
            ...
            catch (Exception e)
            {
                ...
                log4net.LogManager.GetLogger(this.GetType()).Error("Form: EmailConfirmationFailure, Action: " + System.Web.HttpContext.Current.Items["_currentControllerAction"], e);
                //throw;
                return null;
            }
        }
