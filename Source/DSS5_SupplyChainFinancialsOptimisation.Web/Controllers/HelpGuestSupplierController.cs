...
using DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.HelpGuestSupplier;
...
namespace DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.HelpGuestSupplier
{

    [RoutePrefix("HelpGuestSupplier")]
    public class HelpGuestSupplierController : ControllerBase<HelpGuestSupplierViewModel, HelpGuestSupplierViewModelDTO>
    {

        /*<Form:HelpGuestSupplier:0/>*/
        public HelpGuestSupplierController()
        {
            _logger = log4net.LogManager.GetLogger(typeof(HelpGuestSupplierController));
        ...
        public void SetModel(HelpGuestSupplierViewModel m)
        {
            @model = m;
        }
        ...
        {
            return PrepareUpdateInstanceResult(typeof(HelpGuestSupplierViewModel));
        }
        ...
        {
            @model = new HelpGuestSupplierViewModel();
            System.Web.HttpContext.Current.Session["LastEntryPoint_HelpGuestSupplier"] = "Render";
            return null;
        }
        ...
        public override ActionResult PostActionFilterHook(bool hasDefaultResultView, bool fillDropDownInitialValues = false)
        {
            ...
            {
                var _modelDTO = new HelpGuestSupplierViewModelDTO(@model);
        ...
        private ActionResult GetFailedDataValidationsResult()
        {
            ...
            catch (Exception e)
            {
                ...
                log4net.LogManager.GetLogger(this.GetType()).Error("Form: HelpGuestSupplier, Action: " + System.Web.HttpContext.Current.Items["_currentControllerAction"], e);
                //throw;
                return null;
            }
        }
