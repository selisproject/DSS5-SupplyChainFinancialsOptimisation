...
using DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ErrorPage;
...
namespace DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.ErrorPage
{
    ...
    public class ErrorPageController : ControllerBase<ErrorPageViewModel, ErrorPageViewModelDTO>
    {
        ...
        public ActionResult ExecuteSendErrorToAdministrator()
        {
            ...
            mail.Subject = "DSS5_SupplyChainFinancialsOptimisation" + " threw an Exception";
