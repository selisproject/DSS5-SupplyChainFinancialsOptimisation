...
using DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ResetPassword;
...
namespace DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.ResetPassword
{

    [RoutePrefix("ResetPassword")]
    public class ResetPasswordController : ControllerBase<ResetPasswordViewModel, ResetPasswordViewModelDTO>
    {

        /*<Form:ResetPassword:0/>*/
        public ResetPasswordController()
        {
            _logger = log4net.LogManager.GetLogger(typeof(ResetPasswordController));
        ...
        public void SetModel(ResetPasswordViewModel m)
        {
            @model = m;
        }
        ...
        {
            return PrepareUpdateInstanceResult(typeof(ResetPasswordViewModel));
        }
        ...
        [HttpGet]
        [Route("Render/{*code?}")]
        public ActionResult Render(string code)

        {
            @model = new ResetPasswordViewModel();
            System.Web.HttpContext.Current.Session["LastEntryPoint_ResetPassword"] = "Render";
            return null;
        }

        [CustomControllerActionFilter(FillDropDownInitialValues=true, ActionName="Render", ClaimType = ClaimTypes.ControllerAction)]
        [HttpGet]
        [Route("_API_Render/{*code?}")]
        public ActionResult _API_Render(string code)

        {
            ...
            var redirectInfo = ExecuteRender(code);
            return redirectInfo;
        }

        [CustomControllerActionFilter(CausesValidation=true, ActionName="Reset", ClaimType = ClaimTypes.ControllerAction)]
        [HttpPost]
        [Route("Reset")]
        ...
        public ActionResult ExecuteRender(string code)
        {
        ...
        public override ActionResult PostActionFilterHook(bool hasDefaultResultView, bool fillDropDownInitialValues = false)
        {
            ...
            {
                var _modelDTO = new ResetPasswordViewModelDTO(@model);
        ...
        private ActionResult GetFailedDataValidationsResult()
        {
            ...
            catch (Exception e)
            {
                ...
                log4net.LogManager.GetLogger(this.GetType()).Error("Form: ResetPassword, Action: " + System.Web.HttpContext.Current.Items["_currentControllerAction"], e);
                //throw;
                return null;
            }
        }
