...
using DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.NotFoundPage;
...
namespace DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.NotFoundPage
{
    ...
    public class NotFoundPageController : ControllerBase<NotFoundPageViewModel, NotFoundPageViewModelDTO>
    {
        ...
        public ActionResult ExecuteRender()
        {
            ...
            @model.Title = BaseViewPage<string>.GetResourceValue("NotFoundPage", "RES_PAGETITLE_Render").ToString();
            return _result;
        }
        #endregion
