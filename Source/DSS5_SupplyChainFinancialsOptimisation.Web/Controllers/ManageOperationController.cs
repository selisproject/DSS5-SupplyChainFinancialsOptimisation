...
using DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.ManageOperation;
...
namespace DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.ManageOperation
{
    ...
    public class ManageOperationController : ControllerBase<ManageOperationViewModel, ManageOperationViewModelDTO>
    {
        ...
        [CustomControllerActionFilter(LogEnabled=true, ActionName="SaveOperation", ClaimType = ClaimTypes.ControllerAction)]
        [HttpPost]
        [Route("SaveOperation")]
        ...
        public ActionResult Button2Changed(System.Collections.Generic.List<zAppDev.DotNet.Framework.Identity.Model.ApplicationPermission> DataItems, bool byUser = false)
        ...
        public ActionResult ExecuteEditOperation(int? Id)
        {
            ...
            @model.ApplicationOperation =  new DSS5_SupplyChainFinancialsOptimisation.DAL.Repository().GetById<zAppDev.DotNet.Framework.Identity.Model.ApplicationOperation>(Id);
        ...
        {
            ActionResult _result = null;
            new DSS5_SupplyChainFinancialsOptimisation.DAL.Repository().Save<zAppDev.DotNet.Framework.Identity.Model.ApplicationOperation>(@model.ApplicationOperation);
            _result = CloseForm();
            return _result;
        }
        /*<ControllerActionImplementation:Button2Changed:1/>*/
        public ActionResult ExecuteButton2Changed(System.Collections.Generic.List<zAppDev.DotNet.Framework.Identity.Model.ApplicationPermission> DataItems, bool byUser)
        {
            ActionResult _result = null;
            return _result;
        }
