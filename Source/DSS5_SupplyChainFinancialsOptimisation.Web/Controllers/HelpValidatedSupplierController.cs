...
using DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.HelpValidatedSupplier;
...
namespace DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.HelpValidatedSupplier
{

    [RoutePrefix("HelpValidatedSupplier")]
    public class HelpValidatedSupplierController : ControllerBase<HelpValidatedSupplierViewModel, HelpValidatedSupplierViewModelDTO>
    {

        /*<Form:HelpValidatedSupplier:0/>*/
        public HelpValidatedSupplierController()
        {
            _logger = log4net.LogManager.GetLogger(typeof(HelpValidatedSupplierController));
        ...
        public void SetModel(HelpValidatedSupplierViewModel m)
        {
            @model = m;
        }
        ...
        {
            return PrepareUpdateInstanceResult(typeof(HelpValidatedSupplierViewModel));
        }
        ...
        {
            @model = new HelpValidatedSupplierViewModel();
            System.Web.HttpContext.Current.Session["LastEntryPoint_HelpValidatedSupplier"] = "Render";
            return null;
        }
        ...
        public override ActionResult PostActionFilterHook(bool hasDefaultResultView, bool fillDropDownInitialValues = false)
        {
            ...
            {
                var _modelDTO = new HelpValidatedSupplierViewModelDTO(@model);
            ...
            return View("HelpValidatedSupplier");
        }
        ...
        private ActionResult GetFailedDataValidationsResult()
        {
            ...
            catch (Exception e)
            {
                ...
                log4net.LogManager.GetLogger(this.GetType()).Error("Form: HelpValidatedSupplier, Action: " + System.Web.HttpContext.Current.Items["_currentControllerAction"], e);
                //throw;
                return null;
            }
        }
