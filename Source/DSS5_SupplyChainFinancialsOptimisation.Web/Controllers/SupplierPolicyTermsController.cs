...
using DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.SupplierPolicyTerms;
...
namespace DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.SupplierPolicyTerms
{

    [RoutePrefix("SupplierPolicyTerms")]
    public class SupplierPolicyTermsController : ControllerBase<SupplierPolicyTermsViewModel, SupplierPolicyTermsViewModelDTO>
    {

        /*<Form:SupplierPolicyTerms:0/>*/
        public SupplierPolicyTermsController()
        {
            _logger = log4net.LogManager.GetLogger(typeof(SupplierPolicyTermsController));
        ...
        public void SetModel(SupplierPolicyTermsViewModel m)
        {
            @model = m;
        }
        ...
        {
            return PrepareUpdateInstanceResult(typeof(SupplierPolicyTermsViewModel));
        }
        ...
        {
            @model = new SupplierPolicyTermsViewModel();
            System.Web.HttpContext.Current.Session["LastEntryPoint_SupplierPolicyTerms"] = "Render";
            return null;
        }
        ...
        public override ActionResult PostActionFilterHook(bool hasDefaultResultView, bool fillDropDownInitialValues = false)
        {
            ...
            {
                var _modelDTO = new SupplierPolicyTermsViewModelDTO(@model);
            ...
            return View("SupplierPolicyTerms");
        }
        ...
        private ActionResult GetFailedDataValidationsResult()
        {
            ...
            catch (Exception e)
            {
                ...
                log4net.LogManager.GetLogger(this.GetType()).Error("Form: SupplierPolicyTerms, Action: " + System.Web.HttpContext.Current.Items["_currentControllerAction"], e);
                //throw;
                return null;
            }
        }
