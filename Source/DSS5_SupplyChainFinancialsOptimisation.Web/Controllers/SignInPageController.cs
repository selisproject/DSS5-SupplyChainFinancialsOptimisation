...
using DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.SignInPage;
...
namespace DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.SignInPage
{
    ...
    public class SignInPageController : ControllerBase<SignInPageViewModel, SignInPageViewModelDTO>
    {
        ...
        [CustomControllerActionFilter(CausesValidation=true, ActionName="SendConfirmationMail", ClaimType = ClaimTypes.ControllerAction)]
        [HttpPost]
...

        {
            ...
            var redirectInfo = ExecuteSendConfirmationMail();
            return redirectInfo;
        }
