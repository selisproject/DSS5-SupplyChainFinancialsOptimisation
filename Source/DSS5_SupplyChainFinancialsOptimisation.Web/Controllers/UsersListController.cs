...
using DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.UsersList;
...
namespace DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.UsersList
{
    ...
    public class UsersListController : ControllerBase<UsersListViewModel, UsersListViewModelDTO>
    {
        ...
        public IQueryable<zAppDev.DotNet.Framework.Identity.Model.ApplicationUser> Get_Table_DatasourceQueryable(DatasourceRequest __request = null, bool shouldEvict = true)
        {
        ...
        public IQueryable<zAppDev.DotNet.Framework.Identity.Model.ApplicationUser> Get_Table_DatasourceQueryableImplementation(DatasourceRequest __request = null, bool shouldEvict = true)
        {
            __request = __request ?? new DatasourceRequest(0, int.MaxValue);
        ...
        public JsonResult Table_GetFullRecordset()
        {
            ...
            var data = CreateDtoInstancesFromKeys(typeof(UsersListViewModel), dataType, items.Select(i => i.UserName.ToString()).ToList(), "Table");
