...
using DSS5_SupplyChainFinancialsOptimisation.UI.ViewModels.RolesList;
...
namespace DSS5_SupplyChainFinancialsOptimisation.UI.Controllers.RolesList
{
    ...
    public class RolesListController : ControllerBase<RolesListViewModel, RolesListViewModelDTO>
    {
        ...
        public IQueryable<zAppDev.DotNet.Framework.Identity.Model.ApplicationRole> Get_Table_DatasourceQueryable(DatasourceRequest __request = null, bool shouldEvict = true)
        {
        ...
        public IQueryable<zAppDev.DotNet.Framework.Identity.Model.ApplicationRole> Get_Table_DatasourceQueryableImplementation(DatasourceRequest __request = null, bool shouldEvict = true)
        {
            __request = __request ?? new DatasourceRequest(0, int.MaxValue);
        ...
        public JsonResult Table_GetFullRecordset()
        {
            ...
            var data = CreateDtoInstancesFromKeys(typeof(RolesListViewModel), dataType, items.Select(i => i.Id.ToString()).ToList(), "Table");
